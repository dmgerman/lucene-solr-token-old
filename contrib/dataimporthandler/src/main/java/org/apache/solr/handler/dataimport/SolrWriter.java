...
return|;
block|}
DECL|method|persistStartTime
specifier|private
name|void
name|persistStartTime
parameter_list|(
name|Date
name|date
parameter_list|)
...
expr_stmt|;
block|}
DECL|method|getSolrDocInstance
specifier|public
specifier|abstract
name|SolrDoc
...
parameter_list|)
function_decl|;
comment|/**    * The purpose of this interface to provide pluggable implementations for Solr    * 1.2& 1.3 The implementation can choose to wrap appropriate Objects based    * on the version    */
DECL|interface|SolrDoc
specifier|public
specifier|static
interface|interface
name|SolrDoc
