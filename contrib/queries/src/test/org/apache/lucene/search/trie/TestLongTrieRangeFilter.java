...
end_import
begin_class
DECL|class|TestLongTrieRangeFilter
specifier|public
class|class
name|TestLongTrieRangeFilter
extends|extends
name|LuceneTestCase
block|{
...
argument_list|)
decl_stmt|;
comment|// Add a series of noDocs docs with increasing long values
for|for
control|(
name|int
name|l
...
name|assertEquals
argument_list|(
literal|"Returned count for LongTrieRangeFilter and RangeQuery must be equal"
argument_list|,
name|cTopDocs
operator|.
name|totalHits
