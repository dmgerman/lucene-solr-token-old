...
expr_stmt|;
block|}
comment|/**    * @param query    *          Query to use for highlighting    * @param field    *          Field to highlight - pass null to ignore fields    * @param tokenStream    *          of source text to be highlighted    * @param expandMultiTermQuery    *          rewrite multi-term queries against a single doc memory index to    *          create boolean queries    * @throws IOException    */
DECL|method|SpanScorer
specifier|public
name|SpanScorer
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * @param query    *            Query to use for highlighting    * @param field    *            Field to highlight - pass null to ignore fields    * @param tokenStream    *            of source text to be highlighted    * @param reader    * @param expandMultiTermQuery    *          rewrite multi-term queries against a single doc memory index to    *          create boolean queries    * @throws IOException    */
DECL|method|SpanScorer
specifier|public
name|SpanScorer
parameter_list|(
...
block|}
block|}
comment|/**    * @return whether ConstantScoreRangeQuerys are set to be highlighted    * @deprecated {@link ConstantScoreRangeQuery} is deprecated. Use the    *             constructor option to expand MultiTerm queries.    */
