...
comment|// force a new stemmer to be created
block|}
comment|/**    * Creates {@link TokenStreamComponents} used to tokenize all the text in the provided    * {@link Reader}.    *    * @return {@link TokenStreamComponents} built from a {@link StandardTokenizer}     *         filtered with {@link StandardFilter}, {@link ElisionFilter},     *         {@link LowerCaseFilter}, {@link StopFilter},    *         {@link KeywordMarkerTokenFilter} if a stem exclusion set is provided,     *         and {@link SnowballFilter}    */
annotation|@
name|Override
