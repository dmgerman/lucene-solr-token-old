...
name|ServiceException
argument_list|(
literal|"Could not delete entry - version confilict"
argument_list|,
name|e
argument_list|)
decl_stmt|;
...
name|ServiceException
argument_list|(
literal|"Could not update entry - version confilict"
argument_list|,
name|e
argument_list|)
decl_stmt|;
...
name|retVal
return|;
comment|/*              * resouce not found will be detected in Gdata request.              * the request queries the storage for the feed to get the serivce for the feed              */
block|}
catch|catch
parameter_list|(
name|StorageException
