...
argument_list|()
expr_stmt|;
comment|/*              * If storage not written write entry to recoverfile              * and make the entry available via the buffer              */
if|if
condition|(
name|this
operator|.
...
parameter_list|)
block|{
comment|/*                      * remove from all resources                      */
name|this
operator|.
name|documentMap
operator|.
...
block|}
block|}
comment|/**      * Persists all changes imediately      * @throws IOException -- if an IO Exception  occures      */
