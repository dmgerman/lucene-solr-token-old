...
expr_stmt|;
block|}
comment|/**      *  Constructs an<code>HtmlDocument</code> from a      *  {@link java.io.File}.      *  @param  file the<code>File</code> containing the      *   HTML to parse      *  @param  tidyConfigFile   the<code>String</code>      *   containing the full path to the Tidy config file      *  @exception  IOException  if an I/O exception occurs */
DECL|method|HtmlDocument
specifier|public
name|HtmlDocument
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      *  Creates a Lucene<code>Document</code> from a      *  {@link java.io.File}.      *  @param  file       *  @param  tidyConfigFile the full path to the Tidy      *   config file      *  @exception  IOException */
specifier|public
specifier|static
name|org
operator|.
