...
return|;
block|}
comment|/**    * Returns an analyzer wrapper that caches all tokens generated by the underlying child analyzer's    * token stream, and delivers those cached tokens on subsequent matching calls to     *<code>tokenStream(String fieldName, Reader reader)</code>.    *<p>    * This can help improve performance in the presence of expensive Analyzer / TokenFilter chains.    *<p>    * Caveats:     * 1) Caching only works if the methods equals() and hashCode() are properly     * implemented on the Reader passed to<code>tokenStream(String fieldName, Reader reader)</code>.    * 2) Caching the tokens of large Lucene documents can lead to out of memory exceptions.     * 3) The Token instances delivered by the underlying child analyzer must be immutable.    *     * @param child    *            the underlying child analyzer    * @return a new analyzer    */
...
comment|///////////////////////////////////////////////////////////////////////////////
comment|/**    * A convenience class holding two elements, namely<code>first</code> and<code>second</code>,    * either or both of which may be<code>null</code>.    */
DECL|class|Pair
specifier|private
specifier|static
specifier|final
...
parameter_list|()
block|{}
comment|/** Constructs a pair with the given two elements, either or both of which may be<code>null</code>.      *       * @param first the first element of the pair.      * @param second the second element of the pair.      */
DECL|method|Pair
specifier|public
name|Pair
parameter_list|(
...
expr_stmt|;
block|}
comment|/** Returns the first element of the pair.      *       *  @return The first element of the pair.      */
DECL|method|first
specifier|public
name|Object
name|first
...
return|;
block|}
comment|/** Returns the second element of the pair.      *       *  @return The second element of the pair.      */
DECL|method|second
specifier|public
name|Object
name|second
...
return|;
block|}
comment|/** Compares two 'pairs'<code>x</code> and<code>y</code> for equality.      *       * In other words determines<code>xA.equals(yA)</code> and<code>xB.equals(yB)</code>,       * taking care of<code>null</code> values.      * This is a static method that avoids the inefficiency of temporary {@link Pair} objects.      *       * @return<code>true</code> if the pair<code>x</code> and the pair<code>y</code> are equal;<code>false</code> otherwise.      */
DECL|method|equals
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/** Returns the hashcode of the two elements of a 'pair'.      *       * This is a static method that avoids the inefficiency of temporary {@link Pair} objects.      *       * @return the hash code.      */
DECL|method|hashCode
specifier|public
specifier|static
name|int
