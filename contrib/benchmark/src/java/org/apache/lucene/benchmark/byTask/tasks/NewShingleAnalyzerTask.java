...
decl_stmt|;
DECL|field|shingleAnalyzerClassName
specifier|private
specifier|static
specifier|final
name|String
name|shingleAnalyzerClassName
init|=
literal|"org.apache.lucene.analysis.shingle.ShingleAnalyzerWrapper"
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// first try to use a ctor with version parameter (needed for many new
comment|// Analyzers that have no default one anymore)
name|Constructor
argument_list|<
name|?
extends|extends
