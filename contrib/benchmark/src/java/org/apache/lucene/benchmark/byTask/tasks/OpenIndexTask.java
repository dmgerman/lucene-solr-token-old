...
end_import
begin_comment
comment|/**  * Open an index writer.  *<br>Other side effects: index writer object in perfRunData is set.  *<br>Relevant properties:<code>merge.factor, max.buffered,  * max.field.length</code>.</code>.  */
end_comment
begin_class
