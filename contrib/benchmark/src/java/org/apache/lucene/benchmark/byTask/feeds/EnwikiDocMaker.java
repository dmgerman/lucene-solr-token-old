...
end_import
begin_comment
comment|/**  * A LineDocMaker which reads the uncompressed english wikipedia dump.  *  * Config properties:  * keep.image.only.docs=false|true  *<br/>  * Plus those available in LineDocMaker  *  *  * @see org.apache.lucene.benchmark.byTask.feeds.LineDocMaker  */
end_comment
begin_class
...
condition|)
block|{
comment|//the body must be null and we either are keeping image docs or the title does not start with Image:
if|if
condition|(
name|body
operator|!=
