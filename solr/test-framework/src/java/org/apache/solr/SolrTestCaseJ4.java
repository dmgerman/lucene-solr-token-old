...
name|debug
operator|+
literal|" w/ MAC_OS_X supressed clientAuth"
operator|)
argument_list|)
expr_stmt|;
block|}
...
name|info
argument_list|(
literal|"Randomized ssl ({}) and clientAuth ({}) via: {}"
argument_list|,
name|result
operator|.
name|isSSLMode
...
return|;
block|}
DECL|method|getConcurrentUpdateSolrClient
specifier|public
specifier|static
name|ConcurrentUpdateSolrClient
...
return|;
block|}
DECL|method|getLBHttpSolrClient
specifier|public
specifier|static
name|LBHttpSolrClient
