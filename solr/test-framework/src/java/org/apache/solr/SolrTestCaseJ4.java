...
argument_list|)
expr_stmt|;
comment|// Turn off two-way SSL since it isn't configured below...
name|sslConfig
operator|.
name|clientAuth
operator|=
...
try|try
block|{
comment|// Don't complain that we are using self-signed certs during the test
name|registry
operator|.
name|register
argument_list|(
...
literal|false
decl_stmt|;
comment|// TODO: random().nextBoolean();
name|log
operator|.
name|info
argument_list|(
