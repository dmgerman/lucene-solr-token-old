...
expr_stmt|;
block|}
comment|/* Returns a non-null string if replicas within the same shard are not consistent.    * If expectFailure==false, the exact differences found will be logged since this would be an unexpected failure.    * verbose causes extra debugging into to be displayed, even if everything is consistent.    */
DECL|method|checkShardConsistency
specifier|protected
name|String
name|checkShardConsistency
