...
argument_list|()
decl_stmt|;
comment|// TODO : fix broken logic confusing solr.xml with solrconfig.xml
name|File
name|fconf
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// zkController.createCollectionZkNode(collection);
name|zkConfigName
operator|=
name|zkController
operator|.
...
argument_list|)
expr_stmt|;
comment|// only write out the collection name if it's not the default (the core name)
name|opt
operator|=
name|cd
operator|.
