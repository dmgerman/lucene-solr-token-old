...
expr_stmt|;
block|}
comment|// before looping over each core, let's check the names and fail
comment|// fast if the same one is reused multiple times.
block|{
comment|// local scope, won't need these vars again
name|NodeList
name|nodes
init|=
operator|(
...
name|SERVER_ERROR
argument_list|,
literal|"Multiple cores found with same name: "
operator|+
name|name
argument_list|)
throw|;
