...
literal|"score"
decl_stmt|;
comment|// some special syntax for these guys?
comment|// Should these have factories... via plugin utils...
DECL|field|DOCID
specifier|public
specifier|static
specifier|final
...
condition|)
block|{
comment|// TODO? pass params to transformers?
name|augmenters
operator|.
name|addTransformer
argument_list|(
