...
argument_list|()
expr_stmt|;
comment|// Maybe this would configurable?
block|}
annotation|@
name|Override
DECL|method|prepare
...
argument_list|()
decl_stmt|;
comment|// reuse the same key that was used for the main facet
name|String
name|termsKey
init|=
name|key
...
comment|//
comment|// The implementation below uses the first encountered shard's
comment|// facet_ranges as the basis for subsequent shards' data to be merged.
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
...
condition|)
block|{
comment|// go through each facet_range
for|for
control|(
name|Map
operator|.
...
name|key
decl_stmt|;
comment|// label in the response for the result... "foo" for {!key=foo}myfield
...
name|_toRefine
decl_stmt|;
comment|// a List<String> of refinements needed, one for each shard.
