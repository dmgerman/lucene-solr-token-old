...
name|info
argument_list|(
literal|"Force open index writer to make sure older index files get deleted"
argument_list|)
expr_stmt|;
name|DirectUpdateHandler2
name|handler
...
name|warn
argument_list|(
literal|"The update handler is not an instance or sub-class of DirectUpdateHandler2. "
operator|+
literal|"ReplicationHandler may not be able to cleanup un-used index files."
argument_list|)
expr_stmt|;
block|}
block|}
