...
index|]
decl_stmt|;
comment|// Test specific sort
comment|/***          groupComparator = createComparator("_docid_", false, false, false);          stringSort = "_docid_ desc";          ***/
...
expr_stmt|;
block|}
comment|// now sort the groups by the first doc in that group
name|Comparator
argument_list|<
name|Doc
argument_list|>
