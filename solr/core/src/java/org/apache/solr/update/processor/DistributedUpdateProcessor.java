...
block|{
DECL|field|PARAM_WHITELIST_CTX_KEY
specifier|final
specifier|static
name|String
...
name|class
operator|+
literal|"PARAM_WHITELIST_CTX_KEY"
decl_stmt|;
...
name|req
expr_stmt|;
comment|// this should always be used - see filterParams
...
expr_stmt|;
block|}
comment|// Since it is not a forward request, for each fail, try to tell them to
...
comment|// and we do not need to send a recovery message
name|Throwable
name|rootCause
init|=
name|SolrException
...
block|}
block|}
comment|/** @see DistributedUpdateProcessorFactory#addParamToDistributedRequestWhitelist */
...
name|whitelist
operator|:
literal|"whitelist can't be null, constructor adds to it"
assert|;
for|for
control|(
name|String
...
return|;
block|}
DECL|class|DistributedUpdatesAsyncException
specifier|public
specifier|static
specifier|final
class|class
...
name|errors
decl_stmt|;
DECL|method|DistributedUpdatesAsyncException
specifier|public
name|DistributedUpdatesAsyncException
parameter_list|(
name|List
...
block|}
block|}
comment|/** Helper method for constructor */
DECL|method|buildCode
specifier|private
specifier|static
specifier|final
name|int
...
condition|)
block|{
comment|// all codes are consistent, use that...
return|return
name|minCode
return|;
block|}
...
condition|)
block|{
comment|// all codes are 4xx, use 400
return|return
name|ErrorCode
operator|.
name|BAD_REQUEST
...
return|;
block|}
comment|// ...otherwise use sensible default
return|return
name|ErrorCode
operator|.
name|SERVER_ERROR
...
block|{
return|return
literal|"Async exception during distributed update: "
operator|+
name|errors
operator|.
name|get
...
argument_list|()
operator|+
literal|" Async exceptions during distributed update: "
argument_list|)
decl_stmt|;
for|for
control|(
