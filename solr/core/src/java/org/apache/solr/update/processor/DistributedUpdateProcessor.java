...
decl_stmt|;
DECL|field|DELQUERY_END_POINT
specifier|public
specifier|static
specifier|final
name|String
name|DELQUERY_END_POINT
init|=
literal|"delquery_end_point"
decl_stmt|;
DECL|field|req
specifier|private
specifier|final
...
comment|// TODO: handle versioned and distributed deleteByQuery
comment|// even in non zk mode, tests simulate updates from a leader
if|if
condition|(
operator|!
...
block|}
block|}
DECL|method|processDeleteByQuery
specifier|private
name|void
name|processDeleteByQuery
parameter_list|(
...
expr_stmt|;
block|}
comment|// TODO: we should consider this? Send delete query to everyone in the current collection
if|if
condition|(
name|zkEnabled
condition|)
