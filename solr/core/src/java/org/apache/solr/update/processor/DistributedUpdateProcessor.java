...
return|;
block|}
comment|// trying to incrementally get things to pass
DECL|method|setupRequest2
specifier|private
name|List
argument_list|<
name|Node
...
parameter_list|)
block|{
comment|//     return setupRequest2(DocRouter.DEFAULT.shardHash(id, null, null), id, doc);
return|return
name|setupRequest
argument_list|(
name|DocRouter
