...
expr_stmt|;
block|}
comment|/**    * Synchronous (blocking) add to specified node. Any error returned from node is propagated.    */
DECL|method|syncAdd
specifier|public
name|void
name|syncAdd
...
argument_list|)
expr_stmt|;
comment|// flush all pending deletes
name|flushDeletes
argument_list|(
literal|1
argument_list|)
expr_stmt|;
comment|// flush all pending adds
name|flushAdds
argument_list|(
literal|1
argument_list|)
expr_stmt|;
comment|// finish with the pending requests
name|checkResponses
argument_list|(
literal|false
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// finish pending requests
name|checkResponses
argument_list|(
literal|false
argument_list|)
