...
condition|)
block|{
comment|// raise the permits to match maxPoolSize
name|semaphore
operator|.
name|setMaxPermits
argument_list|(
...
condition|)
block|{
comment|// we don't shutdown the previous because all it's threads will die
name|commExecutor
operator|=
operator|new
name|BoundedExecutor
...
block|{
comment|//      try {
comment|//        System.out.println("semaphore aq:" + semaphore.availablePermits());
comment|//        semaphore.acquire();
comment|//        System.out.println("aquired");
...
block|{
comment|//        semaphore.release();
comment|//        System.out.println("semaphore re:" + semaphore.availablePermits());
block|}
block|}
block|}
block|}
