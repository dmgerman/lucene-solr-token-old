...
end_import
begin_comment
comment|/**  * Basic Solr Grouping infrastructure.  * Warning NOT thread safe!  *  * @lucene.experimental  */
end_comment
begin_class
DECL|class|Grouping
specifier|public
...
block|}
block|}
comment|/** Differs from {@link Math#max(float, float)} in that if only one side is NaN, we return the other. */
DECL|method|maxAvoidNaN
specifier|private
name|float
name|maxAvoidNaN
parameter_list|(
