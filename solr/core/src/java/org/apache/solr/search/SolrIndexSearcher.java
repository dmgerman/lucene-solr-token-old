...
condition|)
block|{
comment|// recurse on the delegate
return|return
name|getIndexDir
argument_list|(
operator|(
...
name|warn
argument_list|(
literal|"WARNING: Directory impl does not support setting indexDir: "
operator|+
name|dir
operator|.
name|getClass
...
argument_list|)
expr_stmt|;
comment|//create the Collector with InOrderPagingCollector
block|}
else|else
block|{
name|topCollector
