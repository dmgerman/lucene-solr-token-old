...
condition|)
block|{
comment|// TODO: optimize case when missingSlot can be contiguous with other slots
name|missingAcc
operator|=
operator|new
name|SpecialSlotAcc
...
argument_list|)
expr_stmt|;
comment|// collect anything the first time (even -1 for missing)
if|if
condition|(
name|segOrd
operator|<
...
expr_stmt|;
block|}
comment|// since this can be called for missing, we need to ensure it's currently not.
if|if
condition|(
name|allBucketsAcc
operator|!=
