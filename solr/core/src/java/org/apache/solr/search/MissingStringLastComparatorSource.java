...
return|;
block|}
comment|// this stuff caches the ordinal of the last 'value' from compareDocToValue
...
literal|1
decl_stmt|;
DECL|field|lastSameReader
name|boolean
name|lastSameReader
init|=
literal|false
decl_stmt|;
comment|// nocommit, broken: nuke all of this
annotation|@
name|Override
DECL|method|compareTop
specifier|public
