...
condition|)
block|{
comment|// multivalued selector option
name|String
name|s
init|=
name|fp
...
name|BAD_REQUEST
argument_list|,
literal|"Multi-Valued field selector '"
operator|+
name|s
operator|+
...
return|;
block|}
comment|// simple field ValueSource
return|return
name|f
operator|.
name|getType
...
argument_list|)
expr_stmt|;
comment|/***      addParser("agg_stdev", new ValueSourceParser() {     @Override     public ValueSource parse(FunctionQParser fp) throws SyntaxError {     return null;     }     });       addParser("agg_multistat", new ValueSourceParser() {     @Override     public ValueSource parse(FunctionQParser fp) throws SyntaxError {     return null;     }     });      ***/
name|addParser
argument_list|(
literal|"agg_min"
argument_list|,
...
literal|null
return|;
comment|// check character index 1 to be a digit.  Index 0 might be a +/-.
if|if
condition|(
name|arg
operator|.
