...
name|BAD_REQUEST
argument_list|,
literal|"SolrCloud join: Collection '"
operator|+
name|fromIndex
operator|+
literal|"' not found!"
...
block|}
return|return
name|findLocalReplicaForFromIndex
argument_list|(
name|zkController
argument_list|,
name|resolved
...
name|BAD_REQUEST
argument_list|,
literal|"SolrCloud join: Collection alias '"
operator|+
name|fromIndex
operator|+
literal|"' maps to multiple collections ("
operator|+
name|resolved
operator|+
literal|"), which is not currently supported for joins."
argument_list|)
throw|;
block|}
return|return
...
return|;
block|}
DECL|method|findLocalReplicaForFromIndex
specifier|private
specifier|static
name|String
name|findLocalReplicaForFromIndex
...
name|BAD_REQUEST
argument_list|,
literal|"SolrCloud join: multiple shards not yet supported "
operator|+
name|fromIndex
argument_list|)
throw|;
...
argument_list|)
expr_stmt|;
comment|// found local replica, but is it Active?
if|if
condition|(
name|replica
operator|.
...
name|BAD_REQUEST
argument_list|,
literal|"SolrCloud join: "
operator|+
name|fromIndex
operator|+
literal|" has a local replica ("
operator|+
name|fromReplica
operator|+
literal|") on "
...
name|BAD_REQUEST
argument_list|,
literal|"SolrCloud join: No active replicas for "
operator|+
name|fromIndex
operator|+
literal|" found in node "
operator|+
name|nodeName
argument_list|)
throw|;
