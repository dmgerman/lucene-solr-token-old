...
block|}
block|}
comment|/**    * This method helps resolve if the deprecated "update.processor" request parameter is used      * and logs a warning if it is. In a future version, this method will be removed and    * Solr will assume "update.chain" and not look for "update.processor"    * @param params an instance of SolrParams from the request    * @param log an instance of a slf4j logger to log a warning in case of deprecated param usage    * @return null if neither is specified, else the value of the param specified    * @deprecated    */
DECL|method|resolveUpdateChainParam
specifier|public
specifier|static
name|String
name|resolveUpdateChainParam
parameter_list|(
name|SolrParams
name|params
parameter_list|,
...
name|warn
argument_list|(
literal|"Use of deprecated update request parameter "
operator|+
name|UpdateParams
operator|.
name|UPDATE_CHAIN_DEPRECATED
operator|+
literal|" detected. Please use the new parameter "
operator|+
name|UpdateParams
operator|.
name|UPDATE_CHAIN
operator|+
literal|" instead, as support"
operator|+
literal|" for "
operator|+
name|UpdateParams
...
name|UPDATE_CHAIN_DEPRECATED
operator|+
literal|" will be removed in a later version."
argument_list|)
expr_stmt|;
block|}
return|return
