...
decl_stmt|;
name|int
name|maxDisjunctsSize
init|=
literal|0
decl_stmt|;
name|int
name|optionalDismaxClauses
init|=
literal|0
decl_stmt|;
for|for
...
return|;
block|}
comment|/** Copies the given {@code namedList} assumed to have doc uniqueKey keyed data into {@code destArr}    * at the position of the document in the response.  destArr is assumed to be the same size as    * {@code resultIds} is.  {@code resultIds} comes from {@link ResponseBuilder#resultIds}.  If the doc key    * isn't in {@code resultIds} then it is ignored.    * Note: most likely you will call {@link #removeNulls(Map.Entry[], NamedList)} sometime after calling this. */
DECL|method|copyNamedListIntoArrayByDocPosInResponse
specifier|public
specifier|static
name|void
...
condition|)
block|{
comment|// maybe null when rb.onePassDistributedQuery
name|int
name|idx
init|=
name|sdoc
