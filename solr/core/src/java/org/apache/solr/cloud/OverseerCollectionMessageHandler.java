...
block|}
comment|//
comment|// TODO DWS: this class has gone out of control (too big); refactor to break it up
comment|//
...
expr_stmt|;
block|}
DECL|method|processBackupAction
specifier|private
name|void
name|processBackupAction
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// note: we assume a shared files system to backup a collection, since a collection is distributed
name|Path
name|backupPath
init|=
name|Paths
...
name|BAD_REQUEST
argument_list|,
literal|"Backup directory already exists: "
operator|+
name|backupPath
argument_list|)
throw|;
...
name|os
argument_list|,
literal|"Snapshot properties file"
argument_list|)
expr_stmt|;
block|}
name|log
...
expr_stmt|;
block|}
DECL|method|processRestoreAction
specifier|private
name|void
name|processRestoreAction
parameter_list|(
...
return|;
block|}
comment|/* @Override   public void markExclusiveTask(String collectionName, ZkNodeProps message) {     if (collectionName != null) {       synchronized (collectionWip) {         collectionWip.add(collectionName);       }     }   }    @Override   public void unmarkExclusiveTask(String collectionName, String operation, ZkNodeProps message) {     if(collectionName != null) {       synchronized (collectionWip) {         collectionWip.remove(collectionName);       }     }   }*/
comment|/*   @Override   public ExclusiveMarking checkExclusiveMarking(String collectionName, ZkNodeProps message) {     synchronized (collectionWip) {       if(collectionWip.contains(collectionName))         return ExclusiveMarking.NONEXCLUSIVE;     }      return ExclusiveMarking.NOTDETERMINED;   }*/
