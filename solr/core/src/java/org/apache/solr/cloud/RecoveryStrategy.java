...
name|info
argument_list|(
literal|"PeerSync stage of recovery was successful."
argument_list|)
expr_stmt|;
comment|// solrcloud_debug
if|if
...
name|info
argument_list|(
literal|"Replaying updates buffered during PeerSync."
argument_list|)
expr_stmt|;
name|replay
argument_list|(
...
name|info
argument_list|(
literal|"Replication Recovery was successful."
argument_list|)
expr_stmt|;
name|successfulRecovery
operator|=
...
name|info
argument_list|(
literal|"Registering as Active after recovery."
argument_list|)
expr_stmt|;
try|try
block|{
...
name|error
argument_list|(
literal|"Could not publish as ACTIVE after succesful recovery"
argument_list|,
name|e
argument_list|)
expr_stmt|;
