...
block|{
comment|//Path does not exists. We only retry for session expired exceptions.
break|break;
block|}
block|}
catch|catch
...
name|debug
argument_list|(
literal|"Sleeping for 1s before retrying fetching resource="
operator|+
name|resource
argument_list|)
expr_stmt|;
...
name|IOException
argument_list|(
literal|"We re-tried 10 times but was still unable to fetch resource="
operator|+
name|resource
operator|+
literal|" from ZK"
