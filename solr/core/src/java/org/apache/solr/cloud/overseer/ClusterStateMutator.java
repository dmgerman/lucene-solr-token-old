...
condition|)
block|{
comment|// we are being explicitly told the slice data (e.g. coll restore)
name|slices
operator|=
name|Slice
operator|.
...
expr_stmt|;
block|}
comment|//TODO default to 2; but need to debug why BasicDistributedZk2Test fails early on
name|String
name|znode
init|=
name|message
