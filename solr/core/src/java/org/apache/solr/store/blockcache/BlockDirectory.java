...
expr_stmt|;
block|}
comment|// segments.gen won't be removed above
name|cache
operator|.
name|delete
argument_list|(
...
comment|// public void sync(String name) throws IOException {
comment|// _directory.sync(name);
comment|// }
...
block|}
comment|// @SuppressWarnings("deprecation")
comment|// public long fileModified(String name) throws IOException {
comment|// return _directory.fileModified(name);
comment|// }
DECL|method|listAll
specifier|public
name|String
...
block|}
comment|// @SuppressWarnings("deprecation")
comment|// public void touchFile(String name) throws IOException {
comment|// _directory.touchFile(name);
comment|// }
