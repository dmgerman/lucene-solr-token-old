...
name|info
argument_list|(
literal|"BlockDirectory closing on shutdown"
argument_list|)
expr_stmt|;
comment|// we are shutting down, no need to clean up cache
name|super
operator|.
name|close
argument_list|()
...
condition|)
block|{
comment|// depending on params, we don't cache on merges or when only reading once
case|case
name|MERGE
case|:
block|{
