...
end_import
begin_comment
comment|/**  * Default CodecFactory implementation, extends Lucene's   * and returns postings format implementations according to the   * schema configuration.  * @lucene.experimental  */
end_comment
begin_class
DECL|class|DefaultCodecFactory
specifier|public
class|class
