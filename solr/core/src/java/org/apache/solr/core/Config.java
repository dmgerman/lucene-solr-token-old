...
expr_stmt|;
block|}
comment|/**    * For the transition from using solr.xml to solr.properties, see SOLR-4196. Remove    * for 5.0, thus it's already deprecated    * @param loader - Solr resource loader    * @param cfg    - SolrConfig, for backwards compatability with solr.xml layer.    * @throws TransformerException if the XML file is mal-formed    */
annotation|@
name|Deprecated
DECL|method|Config
specifier|public
