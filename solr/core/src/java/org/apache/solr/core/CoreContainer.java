...
throw|;
block|}
comment|// Since the cores  var is now initialized to null, let's set it up right now.
name|cfg
operator|.
...
condition|)
block|{
comment|// Just like current case.
name|core
operator|=
name|create
argument_list|(
...
block|{
comment|// Store it away for later use. includes non-swappable but not loaded at startup cores.
name|dynamicDescriptors
operator|.
name|put
argument_list|(
