...
comment|// 1. look for zkhost from sys prop 2. TODO: look for zkhost in {solr.home}/solr.properties
...
argument_list|)
decl_stmt|;
comment|// old style defines cores in solr.xml, new style disovers them by
...
condition|)
block|{
comment|// ConfigSolr handles keep orig values around for non solrcore level items,
comment|// but this is still how original core lvl attributes are kept around
name|this
operator|.
name|origCfg
operator|=
