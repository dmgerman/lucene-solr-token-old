...
argument_list|)
decl_stmt|;
comment|// solr.xml node constants
...
name|get
argument_list|(
literal|"solr/logging/watcher/@class"
argument_list|,
literal|null
argument_list|)
decl_stmt|;
...
name|SAXException
block|{
comment|// :TODO: would be really nice if this method wrapped any underlying errors and only threw SolrException
specifier|final
name|String
name|name
init|=
...
try|try
block|{
comment|// :nocommit: refactor doCreate completley into this method - only did it this way so patch would be straight forward w/o huge amounts of indenting changes
name|SolrCore
name|core
init|=
name|doCreate
...
init|)
block|{
comment|// remove first so insertion order is updated and newest is last
name|coreInitFailures
operator|.
name|remove
argument_list|(
...
try|try
block|{
comment|// :nocommit: refactor doReload completley into this method - only did it this way so patch would be straight forward w/o huge amounts of indenting changes
name|doReload
argument_list|(
name|name
argument_list|)
