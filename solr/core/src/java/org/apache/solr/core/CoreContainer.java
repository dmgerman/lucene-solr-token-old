...
expr_stmt|;
block|}
DECL|method|intializeAuthorizationPlugin
specifier|private
name|void
name|intializeAuthorizationPlugin
parameter_list|()
block|{
...
condition|)
block|{
comment|// Setup HttpClient to use the plugin's configurer for internode communication
name|HttpClientConfigurer
name|configurer
init|=
operator|(
...
name|info
argument_list|(
literal|"Reconfiguring the shard handler factory and update shard handler."
argument_list|)
expr_stmt|;
if|if
condition|(
