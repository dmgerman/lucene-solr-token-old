...
name|warn
argument_list|(
literal|"Couldn't add files from {} filtered by {} to classpath: {}"
argument_list|,
name|dir
argument_list|,
name|regex
...
name|warn
argument_list|(
literal|"Couldn't add file {} to classpath: {}"
argument_list|,
name|dir
argument_list|,
name|e
...
return|;
block|}
DECL|method|refreshRequestParams
specifier|public
name|RequestParams
name|refreshRequestParams
parameter_list|()
