...
end_import
begin_interface
DECL|interface|SolrFragListBuilder
specifier|public
interface|interface
...
parameter_list|)
function_decl|;
comment|/**    * Return a FragListBuilder.    *     * @param params The params controlling Highlighting    * @return An appropriate FragListBuilder.    */
