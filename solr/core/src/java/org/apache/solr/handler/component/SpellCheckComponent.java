...
argument_list|)
decl_stmt|;
comment|//If specified, this can be a discrete # of results, or a percentage of fq results.
name|Integer
...
condition|)
block|{
name|addOriginalTermsToResponse
argument_list|(
name|response
argument_list|,
name|tokens
...
block|}
block|}
DECL|method|maxResultsForSuggest
specifier|private
name|Integer
name|maxResultsForSuggest
parameter_list|(
...
decl_stmt|;
name|float
name|maxResultsForSuggestParamValue
init|=
name|params
operator|.
name|getFloat
...
condition|)
block|{
comment|// If a whole number was passed in, this is a discrete number of documents
name|maxResultsForSuggest
operator|=
operator|(
name|int
...
block|{
comment|// If a fractional value was passed in, this is the % of documents returned by the specified filter
comment|// If no specified filter, we use the most restrictive filter of the fq parameters
name|String
...
condition|)
block|{
comment|// Get the default Lucene query parser
name|QParser
name|parser
init|=
name|QParser
...
argument_list|()
decl_stmt|;
comment|// Get the maximum possible hits within these filters (size of most restrictive filter).
if|if
condition|(
name|filters
operator|!=
...
return|;
block|}
comment|// Recalculate maxResultsForSuggest if filters were specified
if|if
condition|(
name|maxResultsByFilters
operator|!=
...
expr_stmt|;
block|}
DECL|method|addOriginalTermsToResponse
specifier|private
name|void
name|addOriginalTermsToResponse
parameter_list|(
