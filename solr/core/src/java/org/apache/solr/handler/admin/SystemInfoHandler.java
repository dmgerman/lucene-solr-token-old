...
argument_list|)
expr_stmt|;
comment|// This is a public Oracle/OpenJDK extension, but may not be in other JDKs:
...
name|warn
argument_list|(
literal|"Unable to execute command line tools."
argument_list|,
name|ex
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/**    * Try to run a getter function on a {@link PlatformManagedObject}.    *<p>    * If you are running a OpenJDK/Oracle JVM, there are nice functions in:    * {@code com.sun.management.UnixOperatingSystemMXBean} and    * {@code com.sun.management.OperatingSystemMXBean}    *<p>    * If the given bean does not have the property, it is handled like {@code null}    * and not added to the given named list.    */
DECL|method|addMXBeanProperty
specifier|static
name|void
name|addMXBeanProperty
parameter_list|(
...
name|warn
argument_list|(
literal|"Cannot get property '{}' of MXBean interface: {}"
argument_list|,
name|property
argument_list|,
name|intf
