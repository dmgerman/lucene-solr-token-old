...
condition|)
block|{
comment|// the user has not requested the unique key but
comment|// we still need to add it otherwise mergeIds can't work
if|if
condition|(
name|fl
operator|.
...
block|{
comment|// in this first phase, request only the unique key field and any fields needed for merging.
if|if
condition|(
name|shardQueryIncludeScore
condition|)
