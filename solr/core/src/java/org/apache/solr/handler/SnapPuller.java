...
name|warn
argument_list|(
literal|"SnapPuller unable to cleanup unused lucene index files so we must do a full copy instead"
argument_list|)
expr_stmt|;
name|isFullCopyNeeded
operator|=
...
argument_list|()
decl_stmt|;
comment|// All files that belong to this segment
name|currentFiles
operator|.
name|addAll
argument_list|(
