...
name|SERVER_ERROR
argument_list|,
literal|"Faceting context not set, cannot calculate pivot values"
argument_list|)
throw|;
block|}
block|}
...
block|}
block|}
comment|/**    * Add facet.queries and facet.ranges to the pivot response if needed    *     * @param pivot    *          Pivot in which to inject additional data    * @param params    *          Query parameters.    * @param docs    *          DocSet of the current pivot to use for computing sub-counts    * @param facetQueries    *          Tagged facet queries should have to be included, must not be null    * @param facetRanges    *          Taged facet ranges should have to be included, must not be null    * @throws IOException    *           If searcher has issues finding numDocs.    */
DECL|method|addPivotQueriesAndRanges
specifier|protected
name|void
name|addPivotQueriesAndRanges
parameter_list|(
