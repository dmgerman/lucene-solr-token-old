...
literal|0
expr_stmt|;
comment|// Abort any statistics gathering.
block|}
name|rsp
operator|.
name|add
...
block|{
continue|continue;
comment|// we're not interested in this term
block|}
name|SimpleOrderedMap
argument_list|<
name|Object
...
condition|)
block|{
comment|// Read the actual field from the index and report that too.
name|Document
name|doc
init|=
literal|null
...
argument_list|)
expr_stmt|;
comment|// Allocating slots for the top N terms to collect freqs.
name|topTerms
operator|.
name|put
argument_list|(
