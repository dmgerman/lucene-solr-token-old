...
block|}
block|}
DECL|method|handlePrepRecoveryAction
specifier|protected
name|void
name|handlePrepRecoveryAction
parameter_list|(
...
name|BAD_REQUEST
argument_list|,
literal|"I was asked to prep for recovery for "
operator|+
name|nodeName
operator|+
literal|" but she is not live or not in a recovery state - state: "
operator|+
name|state
operator|+
literal|" live:"
