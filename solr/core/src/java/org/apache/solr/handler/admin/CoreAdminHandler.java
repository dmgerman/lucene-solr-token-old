...
expr_stmt|;
block|}
comment|/**    * Handle the core admin SPLIT action.    * @return true if a modification has resulted that requires persistence     *         of the CoreContainer configuration.    */
...
argument_list|)
expr_stmt|;
comment|// Need this junk for silly persistence
if|if
condition|(
name|parameterName
operator|.
