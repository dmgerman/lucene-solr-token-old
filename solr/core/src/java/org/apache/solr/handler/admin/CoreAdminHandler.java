...
comment|// dirFactory = core.getDirectoryFactory();
if|if
condition|(
name|pathsArr
operator|!=
...
argument_list|()
decl_stmt|;
comment|// should this be static?
comment|// TODO: use real range if we know it.  If we don't know it, we should prob
comment|// split on every other doc rather than on a hash?
name|ranges
operator|=
name|hp
operator|.
