...
literal|null
decl_stmt|;
comment|//TODO update to NIO Path API
...
block|}
block|}
comment|/** Gets the parent directory of the snapshots.  This is the {@code location} given in the constructor after    * being resolved against the core instance dir. */
...
condition|)
block|{
comment|// note: TODO reconsider mkdirs vs mkdir
throw|throw
operator|new
name|SolrException
argument_list|(
