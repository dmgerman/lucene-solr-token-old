...
name|parser
decl_stmt|;
DECL|field|preAnalyzer
specifier|private
name|PreAnalyzedAnalyzer
name|preAnalyzer
decl_stmt|;
annotation|@
name|Override
...
expr_stmt|;
block|}
comment|/**    * Overridden to return an analyzer consisting of a {@link PreAnalyzedTokenizer}.    * NOTE: If an index analyzer is specified in the schema, it will be ignored.    */
annotation|@
name|Override
...
return|;
block|}
comment|/**    * Returns the query analyzer defined via the schema, unless there is none,    * in which case the index-time pre-analyzer is returned.    *    * Note that if the schema specifies an index-time analyzer via either    * {@code<analyzer>} or {@code<analyzer type="index">}, but no query-time    * analyzer, the query analyzer returned here will be the index-time    * analyzer specified in the schema rather than the pre-analyzer.    */
annotation|@
name|Override
...
name|parser
decl_stmt|;
DECL|field|readerConsumptionException
specifier|private
name|IOException
name|readerConsumptionException
decl_stmt|;
...
return|;
block|}
comment|/**      * Throws a delayed exception if one was thrown from decodeInput()      * while reading from the input reader.      */
annotation|@
name|Override
DECL|method|reset
specifier|public
...
expr_stmt|;
block|}
DECL|method|setReaderConsumptionException
specifier|private
name|void
name|setReaderConsumptionException
parameter_list|(
name|IOException
name|e
parameter_list|)
...
expr_stmt|;
block|}
comment|/**      * Parses the input reader and adds attributes specified there.      */
DECL|method|decodeInput
specifier|private
name|void
name|decodeInput
parameter_list|(
...
argument_list|()
expr_stmt|;
comment|// reset attributes to the empty set
name|cachedStates
operator|.
name|clear
argument_list|()
...
block|}
block|}
DECL|class|PreAnalyzedAnalyzer
specifier|private
specifier|static
class|class
name|PreAnalyzedAnalyzer
...
name|parser
decl_stmt|;
DECL|method|PreAnalyzedAnalyzer
name|PreAnalyzedAnalyzer
parameter_list|(
name|PreAnalyzedParser
name|parser
...
parameter_list|)
block|{
comment|// save this exception for reporting when reset() is called
name|tokenizer
operator|.
name|setReaderConsumptionException
argument_list|(
