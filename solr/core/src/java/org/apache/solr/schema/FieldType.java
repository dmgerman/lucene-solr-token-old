...
return|;
block|}
comment|/**     * Returns a description of the given analyzer, by either reporting the Analyzer name    * if it's not a TokenizerChain, or if it is, querying each analysis factory for its    * name and args.    */
...
return|;
block|}
DECL|field|SHORTENABLE_PACKAGE_PATTERN
specifier|private
specifier|static
specifier|final
name|Pattern
name|SHORTENABLE_PACKAGE_PATTERN
init|=
name|Pattern
operator|.
name|compile
argument_list|(
literal|"org\\.apache\\.(?:lucene\\.analysis(?=.).*|solr\\.(?:analysis|schema))\\.([^.]+)$"
argument_list|)
decl_stmt|;
