...
block|{
comment|// if the sim facotry isn't schema aware, then we are responsible for
comment|// erroring if a field type is trying to specify a sim.
for|for
control|(
name|FieldType
name|ft
...
name|uniqueKeyFieldName
operator|+
literal|") can not be the dest of a copyField (src="
operator|+
name|source
operator|+
literal|")"
