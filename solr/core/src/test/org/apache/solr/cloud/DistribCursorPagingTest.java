...
literal|"sort"
argument_list|,
literal|"float asc, int desc, id desc"
argument_list|)
expr_stmt|;
name|rsp
operator|=
...
name|info
argument_list|(
literal|"SOLR-5652: Begining Loop over smallish num of docs"
argument_list|)
expr_stmt|;
specifier|final
name|boolean
...
name|info
argument_list|(
literal|"SOLR-5652: Ending Loop over smallish num of docs"
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/**    * Asks the LukeRequestHandler on the control client for a list of the fields in the     * schema (excluding _version_) and then returns the field names in a deterministically     * random order.    */
...
return|;
block|}
comment|/** :TODO: refactor method into two arg version once SOLR-5652 is resolved */
DECL|method|assertFullWalkNoDups
specifier|private
name|SentinelIntSet
name|assertFullWalkNoDups
...
block|{
comment|// SOLR-5652
comment|// SolrDocument is a bit more verbose then we need
name|StringBuilder
name|s
init|=
operator|new
...
name|info
argument_list|(
literal|"SOLR-5652: ({}) gave us these docs: {}"
argument_list|,
name|p
argument_list|,
name|s
