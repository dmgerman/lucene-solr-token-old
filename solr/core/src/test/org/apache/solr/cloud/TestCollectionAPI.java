...
argument_list|()
expr_stmt|;
name|clusterStatusBadCollectionTest
argument_list|()
expr_stmt|;
...
argument_list|()
expr_stmt|;
name|testCollectionCreationCollectionNameValidation
argument_list|()
expr_stmt|;
name|testCollectionCreationShardNameValidation
argument_list|()
expr_stmt|;
name|testAliasCreationNameValidation
argument_list|()
expr_stmt|;
name|testShardCreationNameValidation
argument_list|()
expr_stmt|;
block|}
...
block|}
block|}
DECL|method|clusterStatusBadCollectionTest
specifier|private
name|void
name|clusterStatusBadCollectionTest
parameter_list|()
...
name|fail
argument_list|(
literal|"Collection does not exist. An exception should be thrown"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|contains
argument_list|(
literal|"Collection: bad_collection_name not found"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
block|}
block|}
DECL|method|testCollectionCreationCollectionNameValidation
specifier|private
name|void
name|testCollectionCreationCollectionNameValidation
parameter_list|()
...
literal|"name"
argument_list|,
literal|"invalid@name#with$weird%characters"
argument_list|)
expr_stmt|;
name|SolrRequest
name|request
...
block|}
block|}
DECL|method|testCollectionCreationShardNameValidation
specifier|private
name|void
name|testCollectionCreationShardNameValidation
parameter_list|()
...
block|}
block|}
DECL|method|testAliasCreationNameValidation
specifier|private
name|void
name|testAliasCreationNameValidation
parameter_list|()
...
block|}
block|}
DECL|method|testShardCreationNameValidation
specifier|private
name|void
name|testShardCreationNameValidation
parameter_list|()
...
argument_list|()
expr_stmt|;
comment|// Create a collection w/ implicit router
name|ModifiableSolrParams
name|params
init|=
operator|new
