...
argument_list|()
expr_stmt|;
name|testFailedCoreCreateCleansUp
argument_list|()
expr_stmt|;
...
block|}
block|}
DECL|method|testFailedCoreCreateCleansUp
specifier|private
name|void
name|testFailedCoreCreateCleansUp
parameter_list|()
...
name|setSchemaName
argument_list|(
literal|"nonexistent_schema.xml"
argument_list|)
expr_stmt|;
name|String
name|url
...
name|fail
argument_list|(
literal|"Expected SolrCore create to fail"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|exists
argument_list|(
literal|"/collections/the_core_collection"
argument_list|,
literal|true
argument_list|)
condition|)
...
argument_list|()
operator|+
literal|" Collection zk node still exists"
argument_list|)
expr_stmt|;
block|}
name|Thread
...
expr_stmt|;
block|}
comment|/**    * Given a URL as a string, removes the leading protocol from that string    */
DECL|method|removeProtocol
specifier|private
specifier|static
name|String
name|removeProtocol
