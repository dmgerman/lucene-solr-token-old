...
argument_list|)
expr_stmt|;
comment|// we need to fix no core tests still
...
argument_list|)
expr_stmt|;
comment|// there are remnants of the collection in zk, should work
name|makeRequest
argument_list|(
name|baseUrl
argument_list|,
...
expr_stmt|;
block|}
DECL|method|deleteCollectionWithUnloadedCore
specifier|private
name|void
name|deleteCollectionWithUnloadedCore
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"AddReplica call should not have been successful"
argument_list|)
expr_stmt|;
block|}
catch|catch
