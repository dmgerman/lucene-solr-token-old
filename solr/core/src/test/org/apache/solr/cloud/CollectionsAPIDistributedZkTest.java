...
argument_list|()
decl_stmt|;
DECL|field|oldStyleSolrXml
specifier|private
name|boolean
name|oldStyleSolrXml
init|=
literal|false
decl_stmt|;
annotation|@
...
name|println
argument_list|(
literal|"Using old style solr.xml"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|println
argument_list|(
literal|"Using new style solr.xml"
argument_list|)
expr_stmt|;
block|}
if|if
...
parameter_list|()
block|{
comment|// test old style and new style solr.xml
return|return
name|oldStyleSolrXml
condition|?
literal|"solr-no-core-old-style.xml"
else|:
...
argument_list|()
expr_stmt|;
name|testPropertyParamsForCreate
argument_list|()
expr_stmt|;
...
block|}
block|}
DECL|method|testPropertyParamsForCreate
specifier|private
name|void
name|testPropertyParamsForCreate
parameter_list|()
...
name|get
argument_list|(
literal|"solrj_collection_shard"
operator|+
operator|(
name|i
operator|/
...
expr_stmt|;
block|}
comment|// TODO: This test tries to validates defaulting to implicit router.
name|createCollectionRequest
operator|=
operator|new
name|CollectionAdminRequest
...
name|get
argument_list|(
literal|"solrj_implicit_shardC_replica1"
argument_list|)
operator|.
name|get
argument_list|(
...
argument_list|(
literal|"conf1,solrj_collection"
argument_list|)
expr_stmt|;
name|response
operator|=
