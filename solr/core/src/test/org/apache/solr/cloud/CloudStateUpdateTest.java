...
end_import
begin_comment
comment|/**  * TODO: look at hostPort used below  */
end_comment
begin_class
...
name|URL4
init|=
literal|"http://localhost:3123/solr/core4"
decl_stmt|;
DECL|field|SHARD4
specifier|private
specifier|static
...
name|SHARD4
init|=
literal|"localhost:3123_solr_core4"
decl_stmt|;
DECL|field|SHARD3
specifier|private
specifier|static
...
annotation|@
name|Test
DECL|method|testIncrementalUpdate
specifier|public
name|void
name|testIncrementalUpdate
parameter_list|()
throws|throws
name|Exception
block|{
...
name|shardsPath2
init|=
literal|"/collections/collection1/shards/shardid2"
decl_stmt|;
name|zkClient
operator|.
name|makePath
...
argument_list|)
decl_stmt|;
comment|// because of incremental update, we don't expect to find the new 'fake'
comment|// url - instead we should still
comment|// be using the original url - the correct way to update this would be to
comment|// remove the whole node and readd it
name|assertEquals
argument_list|(
name|URL1
argument_list|,
...
name|makePath
argument_list|(
literal|"/collections/testcore/shards"
argument_list|,
name|CreateMode
operator|.
name|PERSISTENT
