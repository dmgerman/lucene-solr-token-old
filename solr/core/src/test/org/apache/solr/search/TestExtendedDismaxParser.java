...
literal|"å¤§äºæ¹¾ OR bogus"
argument_list|,
comment|// +(((((standardtok:å¤§ standardtok:äº standardtok:æ¹¾)~3)) (standardtok:bogus))~2)
literal|"qf"
argument_list|,
literal|"standardtok"
argument_list|,
...
expr_stmt|;
block|}
comment|/**    * Test that the default operator and MM are interacting appropriately when both provided    */
DECL|method|testDefaultOperatorWithMm
specifier|public
name|void
name|testDefaultOperatorWithMm
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Text we are searching
comment|// "line up and fly directly at the enemy death cannons, clogging them with wreckage!"
name|assertQ
argument_list|(
literal|"test default operator with mm (AND + 0% => 0 hits)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"(line notfound) OR notfound"
argument_list|,
literal|"qf"
argument_list|,
literal|"text"
...
name|assertQ
argument_list|(
literal|"test default operator with mm (OR + 0% => 1 hit)"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"test default operator with mm (OR + 100% => 0 hits)"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"test default operator with mm (OR + 35% => 1 hit)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"line notfound notfound2 OR notfound"
argument_list|,
literal|"qf"
argument_list|,
literal|"text"
...
name|assertQ
argument_list|(
literal|"test default operator with mm (OR + 75% => 0 hits)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"line notfound notfound2 OR notfound3"
argument_list|,
literal|"qf"
argument_list|,
literal|"text"
...
name|assertQ
argument_list|(
literal|"test default operator with mm (AND + 0% => 1 hit)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"(line enemy) OR notfound"
argument_list|,
literal|"qf"
argument_list|,
literal|"text"
...
name|assertQ
argument_list|(
literal|"test default operator with mm (AND + 50% => 1 hit)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"(line enemy) OR (line notfound) OR (death cannons) OR (death notfound)"
argument_list|,
literal|"qf"
argument_list|,
literal|"text"
...
name|assertQ
argument_list|(
literal|"test default operator with mm (AND + 75% => 0 hits)"
argument_list|,
name|req
argument_list|(
literal|"q"
...
expr_stmt|;
block|}
comment|/**    * Test that minShouldMatch applies to Optional terms only    */
DECL|method|testMinShouldMatchOptional
specifier|public
name|void
name|testMinShouldMatchOptional
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertQ
argument_list|(
literal|"test minShouldMatch (top level optional and negative terms mm=50%)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"stocks oil gold -stockade"
argument_list|,
comment|// +(((text_sw:stock) (text_sw:oil) (text_sw:gold) -(text_sw:stockad))~1)
literal|"qf"
argument_list|,
literal|"text_sw"
argument_list|,
...
name|assertQ
argument_list|(
literal|"test minShouldMatch (top level optional and negative terms mm=100%)"
argument_list|,
name|req
argument_list|(
literal|"q"
...
literal|"stocks gold -stockade"
argument_list|,
comment|// +(((text_sw:stock) (text_sw:oil) (text_sw:gold) -(text_sw:stockad))~2)
literal|"qf"
argument_list|,
literal|"text_sw"
argument_list|,
...
name|assertQ
argument_list|(
literal|"test minShouldMatch (top level required terms only)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"stocks AND oil"
argument_list|,
comment|// +(+(text_sw:stock) +(text_sw:oil))
literal|"qf"
argument_list|,
literal|"text_sw"
argument_list|,
...
name|assertQ
argument_list|(
literal|"test minShouldMatch (top level optional and required terms)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"oil gold +stocks"
argument_list|,
comment|// +(((text_sw:oil) (text_sw:gold) +(text_sw:stock))~1)
literal|"qf"
argument_list|,
literal|"text_sw"
argument_list|,
...
name|assertQ
argument_list|(
literal|"test minShouldMatch (top level optional with explicit OR and parens)"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"(snake OR stocks) oil"
argument_list|,
literal|"qf"
argument_list|,
literal|"text_sw"
...
argument_list|)
expr_stmt|;
comment|// The results for these two appear odd, but are correct as per BooleanQuery processing.
comment|// See: http://searchhub.org/2011/12/28/why-not-and-or-and-not/
comment|// Non-parenthesis OR/AND precedence is not true to abstract boolean logic in solr when q.op = AND
comment|//   and when q.op = OR all three clauses are top-level and optional so mm takes over
name|assertQ
argument_list|(
literal|"test minShouldMatch (top level optional with explicit OR without parens)"
argument_list|,
name|req
argument_list|(
literal|"q"
