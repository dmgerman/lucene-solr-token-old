...
literal|"fl"
argument_list|,
literal|"id, a_f,a_fd,a_fdS   a_fs,a_fds,a_fdsS,  a_d,a_dd,a_ddS,  a_ds,a_dds,a_ddsS,  a_i,a_id,a_idS   a_is,a_ids,a_idsS,   a_l,a_ld,a_ldS   a_ls,a_lds,a_ldsS"
argument_list|)
argument_list|,
literal|"=={'doc':{'id':'1'"
operator|+
literal|", a_f:-1.5, a_fd:-1.5, a_fdS:-1.5,  a_fs:[1.0,2.5],      a_fds:[1.0,2.5],a_fdsS:[1.0,2.5]"
operator|+
literal|", a_d:-1.2E99, a_dd:-1.2E99, a_ddS:-1.2E99,              a_ds:[1.0,2.5],a_dds:[1.0,2.5],a_ddsS:[1.0,2.5]"
operator|+
literal|", a_i:-1, a_id:-1, a_idS:-1,                             a_is:[1,2],a_ids:[1,2],a_idsS:[1,2]"
operator|+
literal|", a_l:-9999999999, a_ld:-9999999999, a_ldS:-9999999999,  a_ls:[1,9999999999],a_lds:[1,9999999999],a_ldsS:[1,9999999999]"
operator|+
literal|"       }}"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// a cut-n-paste of the first big query, but this time it will be retrieved from the index rather than the transaction log
name|assertJQ
argument_list|(
name|req
argument_list|(
