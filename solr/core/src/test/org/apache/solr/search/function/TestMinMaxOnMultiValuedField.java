...
argument_list|)
expr_stmt|;
comment|// sanity check no sort error when there are missing values
for|for
control|(
name|String
name|dir
...
block|}
block|}
comment|/**     * Tests sort order of min/max realtive to other docs w/o any values.    * @param fieldname The field to test    * @param negative a "negative" value for this field (ie: in a function context, is less then the "0")    * @param positive a "positive" value for this field (ie: in a function context, is more then the "0")    */
DECL|method|testSimpleSort
specifier|protected
name|void
name|testSimpleSort
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// need to wrap with "def" until SOLR-8005 is resolved
name|assertDocWithValsIsFirst
argument_list|(
name|numDocsExpected
argument_list|,
literal|"def(field("
...
argument_list|)
expr_stmt|;
comment|// def wrapper shouldn't be needed since it's already part of another function
name|assertDocWithValsIsFirst
argument_list|(
name|numDocsExpected
argument_list|,
...
expr_stmt|;
block|}
comment|/** helper for testSimpleSort */
DECL|method|assertDocWithValsIsFirst
specifier|private
specifier|static
name|void
name|assertDocWithValsIsFirst
...
block|}
comment|/** helper for testSimpleSort */
DECL|method|assertDocWithValsIsLast
specifier|private
specifier|static
name|void
name|assertDocWithValsIsLast
