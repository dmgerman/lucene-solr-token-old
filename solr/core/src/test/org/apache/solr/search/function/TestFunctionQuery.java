...
comment|// OK
block|}
comment|// test that sorting by function query weights correctly.  superman should sort higher than batman due to idf of the whole index
name|assertQ
argument_list|(
name|req
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testTFIDFFunctions
specifier|public
name|void
name|testTFIDFFunctions
parameter_list|()
block|{
name|clearIndex
argument_list|()
...
name|assertNotNull
argument_list|(
literal|"Test needs *_tfidf to use a TFIDFSimilarity ... who broke the config?"
argument_list|,
name|sim
argument_list|)
expr_stmt|;
...
literal|"q"
argument_list|,
literal|"{!func}idf(nofield_tfidf,cow)"
argument_list|,
literal|"fq"
argument_list|,
literal|"id:6"
...
literal|"q"
argument_list|,
literal|"{!func}tf(nofield_tfidf,cow)"
argument_list|,
literal|"fq"
argument_list|,
literal|"id:6"
...
argument_list|)
expr_stmt|;
comment|// fields with real values
name|assertQ
argument_list|(
name|req
argument_list|(
