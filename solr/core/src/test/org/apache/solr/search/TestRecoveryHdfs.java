...
block|}
argument_list|)
comment|// TODO: longer term this should be combined with TestRecovery somehow ??
DECL|class|TestRecoveryHdfs
specifier|public
class|class
name|TestRecoveryHdfs
extends|extends
name|SolrTestCaseJ4
block|{
...
name|assertTrue
argument_list|(
literal|"Expected to find tlogs with a replication factor of 2"
argument_list|,
name|foundRep2
argument_list|)
expr_stmt|;
...
name|Ignore
argument_list|(
literal|"HDFS-3107: no truncate support yet"
argument_list|)
...
control|)
block|{
comment|//new File(logDir, file).delete();
name|fs
operator|.
name|delete
argument_list|(
