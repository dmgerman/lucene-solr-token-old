...
expr_stmt|;
block|}
DECL|method|testSetNoCFSMergePolicyConfig
specifier|public
name|void
name|testSetNoCFSMergePolicyConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
name|setProperty
argument_list|(
literal|"testSetNoCFSMergePolicyConfig.useCompoundFile"
argument_list|,
name|String
operator|.
name|valueOf
...
argument_list|()
condition|?
literal|"solrconfig-mergepolicy-nocfs.xml"
else|:
literal|"solrconfig-mergepolicyfactory-nocfs.xml"
argument_list|,
...
argument_list|)
expr_stmt|;
name|implTestLogMergePolicyConfig
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testLogMergePolicyFactoryConfig
specifier|public
name|void
name|testLogMergePolicyFactoryConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
name|setProperty
argument_list|(
literal|"solr.test.log.merge.policy.factory"
argument_list|,
name|mpfClass
operator|.
name|getName
...
name|implTestLogMergePolicyConfig
argument_list|(
literal|"solrconfig-logmergepolicyfactory.xml"
argument_list|,
name|mpClass
argument_list|)
expr_stmt|;
block|}
DECL|method|implTestLogMergePolicyConfig
specifier|private
name|void
name|implTestLogMergePolicyConfig
parameter_list|(
