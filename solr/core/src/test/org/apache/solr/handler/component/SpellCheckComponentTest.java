...
annotation|@
name|Test
DECL|method|testMaximumResultsForSuggest
specifier|public
name|void
name|testMaximumResultsForSuggest
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"q"
argument_list|,
literal|"lowerfilt:(this OR brwn)"
argument_list|,
name|SpellingParams
operator|.
...
literal|"id:[0 TO 9]"
argument_list|,
comment|/*returns 10, less selective */
literal|"fq"
argument_list|,
literal|"lowerfilt:th*"
argument_list|,
comment|/* returns 8, most selective */
name|SpellingParams
operator|.
name|SPELLCHECK_COUNT
argument_list|,
...
annotation|@
name|Test
DECL|method|testNumericQuery
specifier|public
name|void
name|testNumericQuery
parameter_list|()
throws|throws
name|Exception
block|{
