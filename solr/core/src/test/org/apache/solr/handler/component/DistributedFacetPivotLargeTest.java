...
comment|// facet.missing=true + facet.sort=index + facet.pivot.mincount> 0 (SOLR-7829)
specifier|final
name|int
name|expectedNumDocsMissingBool
init|=
literal|111
decl_stmt|;
for|for
...
literal|"-real_b:true"
argument_list|,
comment|// simplify asserts by ruling out true counts
literal|"rows"
argument_list|,
literal|"0"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// false, missing - in that order, regardless of sort
name|assertPivot
argument_list|(
literal|"real_b"
argument_list|,
