...
argument_list|()
decl_stmt|;
comment|// Sneaking in a test for using a bad core name
try|try
block|{
name|admin
operator|.
...
name|assertNull
argument_list|(
literal|"Should NOT have added this core!"
argument_list|,
name|cd
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//Try renaming the core, we should fail
comment|// First assert that the props core exists
name|cd
operator|=
name|cores
operator|.
...
name|assertNotNull
argument_list|(
literal|"Core disappeared!"
argument_list|,
name|cd
argument_list|)
expr_stmt|;
comment|// now rename it something else just for kicks since we don't actually test this that I could find.
name|admin
operator|.
name|handleRequestBody
argument_list|(
...
name|assertNotNull
argument_list|(
literal|"Core should have been renamed!"
argument_list|,
name|cd
argument_list|)
expr_stmt|;
comment|// Rename it something bogus and see if you get an exception, the old core is still there and the bogus one isn't
try|try
block|{
name|admin
operator|.
