...
annotation|@
name|Test
DECL|method|testAlternateSummaryWithHighlighting
specifier|public
name|void
name|testAlternateSummaryWithHighlighting
parameter_list|()
block|{
comment|//long document
name|assertU
...
literal|"tv_text"
argument_list|,
literal|"keyword is only here, tv_text alternate field"
argument_list|,
literal|"t_text"
argument_list|,
literal|"a piece of text to be substituted"
...
argument_list|)
expr_stmt|;
comment|// Prove that hl.highlightAlternate is default true and respects maxAlternateFieldLength
name|HashMap
argument_list|<
name|String
argument_list|,
...
name|assertQ
argument_list|(
literal|"Alternate summarization with highlighting"
argument_list|,
name|sumLRF
operator|.
name|makeRequest
...
literal|"//lst[@name='highlighting']/lst[@name='1' and count(*)=1]"
argument_list|,
literal|"//lst[@name='highlighting']/lst[@name='1']/arr[@name='t_text']/str[.='<simplepre>keyword</simplepost> is only here, tv_text']"
argument_list|)
expr_stmt|;
comment|// Query on other field than hl or alternate. Still we get the hightlighted snippet from alternate
name|assertQ
argument_list|(
literal|"Alternate summarization with highlighting, query other field"
argument_list|,
name|sumLRF
operator|.
name|makeRequest
argument_list|(
literal|"other_t:keyword"
argument_list|)
argument_list|,
literal|"//lst[@name='highlighting']/lst[@name='1' and count(*)=1]"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// With hl.requireFieldMatch, will not highlight but fall back to plain-text alternate
name|args
operator|.
name|put
argument_list|(
...
name|assertQ
argument_list|(
literal|"Alternate summarization with highlighting, requireFieldMatch"
argument_list|,
name|sumLRF
operator|.
name|makeRequest
...
literal|"//lst[@name='highlighting']/lst[@name='1' and count(*)=1]"
argument_list|,
literal|"//lst[@name='highlighting']/lst[@name='1']/arr[@name='t_text']/str[.='keyword is only here, tv_text alternate']"
argument_list|)
expr_stmt|;
name|args
operator|.
...
argument_list|)
expr_stmt|;
comment|// Works with field specific params, overriding maxAlternateFieldLength to return everything
name|args
operator|.
name|remove
argument_list|(
...
name|put
argument_list|(
literal|"f.t_text.hl.alternateField"
argument_list|,
literal|"tv_text"
argument_list|)
expr_stmt|;
...
name|put
argument_list|(
literal|"f.t_text.hl.maxAlternateFieldLength"
argument_list|,
literal|"0"
argument_list|)
expr_stmt|;
...
literal|"//lst[@name='highlighting']/lst[@name='1' and count(*)=1]"
argument_list|,
literal|"//lst[@name='highlighting']/lst[@name='1']/arr[@name='t_text']/str[.='<simplepre>keyword</simplepost> is only here, tv_text alternate field']"
argument_list|)
expr_stmt|;
comment|// Prove fallback highlighting works also with FVH
name|args
operator|.
name|put
argument_list|(
...
name|assertQ
argument_list|(
literal|"Alternate summarization with highlighting using FVH"
argument_list|,
name|sumLRF
operator|.
name|makeRequest
...
literal|"//lst[@name='highlighting']/lst[@name='1' and count(*)=1]"
argument_list|,
literal|"//lst[@name='highlighting']/lst[@name='1']/arr[@name='t_text']/str[.='<fvhpre>keyword</fvhpost> is only here']"
argument_list|)
expr_stmt|;
comment|// Prove it is possible to turn off highlighting of alternate field
name|args
operator|.
name|put
argument_list|(
literal|"hl.highlightAlternate"
argument_list|,
literal|"false"
argument_list|)
expr_stmt|;
...
name|assertQ
argument_list|(
literal|"Alternate summarization without highlighting"
argument_list|,
name|sumLRF
operator|.
name|makeRequest
...
literal|"//lst[@name='highlighting']/lst[@name='1' and count(*)=1]"
argument_list|,
literal|"//lst[@name='highlighting']/lst[@name='1']/arr[@name='t_text']/str[.='keyword is only he']"
argument_list|)
expr_stmt|;
block|}
annotation|@
