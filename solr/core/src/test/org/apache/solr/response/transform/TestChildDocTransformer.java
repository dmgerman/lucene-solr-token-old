...
argument_list|()
expr_stmt|;
name|testSubQueryParentFilterJSON
argument_list|()
expr_stmt|;
name|testSubQueryParentFilterXML
argument_list|()
expr_stmt|;
block|}
annotation|@
...
argument_list|()
expr_stmt|;
name|testSubQueryXML
argument_list|()
expr_stmt|;
name|testSubQueryJSON
argument_list|()
expr_stmt|;
block|}
...
name|subqueryPath
init|=
literal|"/result[@name='children'][@numFound='6']"
decl_stmt|;
name|test1
operator|=
operator|new
...
literal|"//*[@numFound='1']"
block|,
literal|"/response/result/doc[1]"
operator|+
name|subqueryPath
operator|+
literal|"/doc[1]/int[@name='id']='2'"
block|,
literal|"/response/result/doc[1]"
operator|+
name|subqueryPath
operator|+
literal|"/doc[2]/int[@name='id']='3'"
block|,
literal|"/response/result/doc[1]"
operator|+
name|subqueryPath
operator|+
literal|"/doc[3]/int[@name='id']='4'"
block|,
literal|"/response/result/doc[1]"
operator|+
name|subqueryPath
operator|+
literal|"/doc[4]/int[@name='id']='5'"
block|,
literal|"/response/result/doc[1]"
operator|+
name|subqueryPath
operator|+
literal|"/doc[5]/int[@name='id']='6'"
block|,
literal|"/response/result/doc[1]"
operator|+
name|subqueryPath
operator|+
literal|"/doc[6]/int[@name='id']='7'"
block|}
expr_stmt|;
block|}
name|assertQ
...
literal|"fl"
argument_list|,
literal|"*,children:[subquery]"
argument_list|,
literal|"children.q"
argument_list|,
literal|"{!child of=subject:parentDocument}{!terms f=id v=$row.id}"
argument_list|,
literal|"children.rows"
argument_list|,
literal|"10"
argument_list|)
argument_list|,
...
literal|"//*[@numFound='1']"
block|,
literal|"/response/result/doc[1]/result[@name='children'][@numFound='3']/doc[1]/int[@name='id']='2'"
block|,
literal|"/response/result/doc[1]/result[@name='children'][@numFound='3']/doc[2]/int[@name='id']='4'"
block|,
literal|"/response/result/doc[1]/result[@name='children'][@numFound='3']/doc[3]/int[@name='id']='6'"
block|}
decl_stmt|;
name|assertQ
argument_list|(
...
literal|"//*[@numFound='1']"
block|,
literal|"/response/result/doc[1]/result[@name='children'][@numFound='3']/doc[1]/int[@name='id']='3'"
block|,
literal|"/response/result/doc[1]/result[@name='children'][@numFound='3']/doc[2]/int[@name='id']='5'"
block|}
decl_stmt|;
name|assertQ
argument_list|(
...
index|[]
block|{
literal|"/response/docs/[0]/children/docs/[0]/id==2"
block|,
literal|"/response/docs/[0]/children/docs/[1]/id==3"
block|,
literal|"/response/docs/[0]/children/docs/[2]/id==4"
block|,
literal|"/response/docs/[0]/children/docs/[3]/id==5"
block|,
literal|"/response/docs/[0]/children/docs/[4]/id==6"
block|,
literal|"/response/docs/[0]/children/docs/[5]/id==7"
block|}
decl_stmt|;
name|String
index|[]
...
literal|"/response/docs/[0]/children/docs/[0]/id==2"
block|,
literal|"/response/docs/[0]/children/docs/[1]/id==4"
block|,
literal|"/response/docs/[0]/children/docs/[2]/id==6"
block|}
decl_stmt|;
name|String
index|[]
...
index|[]
block|{
literal|"/response/docs/[0]/children/docs/[0]/id==3"
block|,
literal|"/response/docs/[0]/children/docs/[1]/id==5"
block|}
decl_stmt|;
name|assertJQ
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testSubQueryParentFilterJSON
specifier|private
name|void
name|testSubQueryParentFilterJSON
parameter_list|()
...
literal|"/response/docs/[0]/children/docs/[0]/id==2"
block|,
literal|"/response/docs/[0]/children/docs/[0]/cat/[0]/=='childDocument'"
block|,
literal|"/response/docs/[0]/children/docs/[0]/title/[0]/=='"
operator|+
name|titleVals
index|[
literal|0
...
literal|"/response/docs/[1]/id==4"
block|,
literal|"/response/docs/[1]/children/docs/[0]/id==5"
block|,
literal|"/response/docs/[1]/children/docs/[0]/cat/[0]/=='childDocument'"
block|,
literal|"/response/docs/[1]/children/docs/[0]/title/[0]/=='"
operator|+
name|titleVals
index|[
literal|1
...
expr_stmt|;
block|}
DECL|method|testSubQueryParentFilterXML
specifier|private
name|void
name|testSubQueryParentFilterXML
parameter_list|()
...
literal|"/response/result/doc[1]/int[@name='id']='1'"
block|,
literal|"/response/result/doc[1]/result[@name='children'][@numFound=1]/doc[1]/int[@name='id']='2'"
block|,
literal|"/response/result/doc[1]/result[@name='children'][@numFound=1]/doc[1]/arr[@name='cat']/str[1]='childDocument'"
block|,
literal|"/response/result/doc[1]/result[@name='children'][@numFound=1]/doc[1]/arr[@name='title']/str[1]='"
operator|+
name|titleVals
index|[
literal|0
...
literal|"/response/result/doc[2]/int[@name='id']='4'"
block|,
literal|"/response/result/doc[2]/result[@name='children'][@numFound=1]/doc[1]/int[@name='id']='5'"
block|,
literal|"/response/result/doc[2]/result[@name='children'][@numFound=1]/doc[1]/arr[@name='cat']/str[1]='childDocument'"
block|,
literal|"/response/result/doc[2]/result[@name='children'][@numFound=1]/doc[1]/arr[@name='title']/str[1]='"
operator|+
name|titleVals
index|[
literal|1
