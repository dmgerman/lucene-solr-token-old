...
annotation|@
name|Test
DECL|method|testSQLExceptionThrownWhenQueryAndConnUseDiffCollections
specifier|public
name|void
name|testSQLExceptionThrownWhenQueryAndConnUseDiffCollections
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
comment|//Bad connection string: wrong collection name
try|try
init|(
name|Connection
name|connection
...
name|fail
argument_list|(
literal|"Expected query against wrong collection to throw a SQLException."
argument_list|)
expr_stmt|;
block|}
block|}
...
parameter_list|)
block|{
comment|// Expected exception due to miss matched collection
block|}
block|}
annotation|@
name|Test
