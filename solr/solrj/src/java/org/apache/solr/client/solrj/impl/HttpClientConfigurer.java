...
expr_stmt|;
block|}
comment|// Intercept every request made through httpclient and validate it has a SolrHttpContext object.
name|httpClient
operator|.
...
parameter_list|)
block|{
comment|// Verify that a context object was passed in
specifier|final
name|Object
name|solrContext
init|=
...
name|BAD_REQUEST
argument_list|,
literal|"A SolrHttpContext object must be passed in as context. Context: "
operator|+
name|context
argument_list|)
throw|;
