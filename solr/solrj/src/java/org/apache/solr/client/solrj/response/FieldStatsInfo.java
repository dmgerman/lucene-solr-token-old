...
parameter_list|()
block|{
comment|// :TODO: as client convinience, should we return cardinality if this is null?
return|return
name|countDistinct
return|;
block|}
...
return|;
block|}
comment|/**    * The cardinality of of the set of values if requested, otherwise null.    */
...
parameter_list|()
block|{
comment|// :TODO: as client convinience, should we return countDistinct if this is null?
return|return
name|cardinality
return|;
block|}
