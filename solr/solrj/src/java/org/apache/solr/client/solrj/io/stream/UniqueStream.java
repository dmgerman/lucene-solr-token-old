...
throw|;
block|}
comment|// Uniqueness is always done over equality, so always use an EqualTo comparator
name|this
operator|.
name|comp
operator|=
...
name|IOException
argument_list|(
literal|"This UniqueStream contains a non-expressible comparator - it cannot be converted to an expression"
argument_list|)
throw|;
block|}
return|return
