...
return|;
block|}
comment|/**    * Adds a collection of documents    *    * @param docs  the collection of documents    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    */
DECL|method|add
specifier|public
name|UpdateResponse
name|add
...
return|;
block|}
comment|/**    * Adds a single document    *    * @param collection the Solr collection to add the document to    * @param doc  the input document    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    */
DECL|method|add
specifier|public
name|UpdateResponse
name|add
...
return|;
block|}
comment|/**    * Adds a single document    *    * @param doc  the input document    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    */
DECL|method|add
specifier|public
name|UpdateResponse
name|add
...
return|;
block|}
comment|/**    * Adds a single document specifying max time before it becomes committed    *    * @param collection the Solr collection to add the document to    * @param doc  the input document    * @param commitWithinMs  max time (in ms) before a commit will happen    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    *    * @since solr 5.1    */
DECL|method|add
specifier|public
name|UpdateResponse
name|add
...
return|;
block|}
comment|/**    * Adds a single document specifying max time before it becomes committed    *    * @param doc  the input document    * @param commitWithinMs  max time (in ms) before a commit will happen    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    *    * @since solr 3.5    */
DECL|method|add
specifier|public
name|UpdateResponse
name|add
...
return|;
block|}
comment|/**    * Adds the documents supplied by the given iterator.    *    * @param collection the Solr collection to add the documents to    * @param docIterator    *          the iterator which returns SolrInputDocument instances    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    */
DECL|method|add
specifier|public
name|UpdateResponse
name|add
...
return|;
block|}
comment|/**    * Adds the documents supplied by the given iterator.    *    * @param docIterator    *          the iterator which returns SolrInputDocument instances    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    */
DECL|method|add
specifier|public
name|UpdateResponse
name|add
...
return|;
block|}
comment|/**    * Adds a single bean specifying max time before it becomes committed    *    * The bean is converted to a {@link SolrInputDocument} by the client's    * {@link org.apache.solr.client.solrj.beans.DocumentObjectBinder}    *    * @param collection to Solr collection to add documents to    * @param obj  the input bean    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    */
DECL|method|addBean
specifier|public
name|UpdateResponse
name|addBean
...
return|;
block|}
comment|/**    * Adds a collection of beans specifying max time before they become committed    *    * The beans are converted to {@link SolrInputDocument}s by the client's    * {@link org.apache.solr.client.solrj.beans.DocumentObjectBinder}    *    * @param collection the Solr collection to add documents to    * @param beans  the collection of beans    * @param commitWithinMs  max time (in ms) before a commit will happen    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    *    * @see SolrClient#getBinder()    *    * @since solr 5.1    */
DECL|method|addBeans
specifier|public
name|UpdateResponse
name|addBeans
...
return|;
block|}
comment|/**    * Adds a collection of beans specifying max time before they become committed    *    * The beans are converted to {@link SolrInputDocument}s by the client's    * {@link org.apache.solr.client.solrj.beans.DocumentObjectBinder}    *    * @param beans  the collection of beans    * @param commitWithinMs  max time (in ms) before a commit will happen    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    *    * @see SolrClient#getBinder()    *    * @since solr 3.5    */
DECL|method|addBeans
specifier|public
name|UpdateResponse
name|addBeans
...
return|;
block|}
comment|/**    * Adds the beans supplied by the given iterator.    *    * @param collection the Solr collection to add the documents to    * @param beanIterator    *          the iterator which returns Beans    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    */
DECL|method|addBeans
specifier|public
name|UpdateResponse
name|addBeans
...
return|;
block|}
comment|/**    * Adds the beans supplied by the given iterator.    *    * @param beanIterator    *          the iterator which returns Beans    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} from the server    *    * @throws IOException         if there is a communication error with the server    * @throws SolrServerException if there is an error on the server    */
DECL|method|addBeans
specifier|public
name|UpdateResponse
name|addBeans
...
return|;
block|}
comment|/**    * Performs an explicit optimize, causing a merge of all segments to one.    *    * waitFlush=true and waitSearcher=true to be inline with the defaults for plain HTTP access    *    * Note: In most cases it is not required to do explicit optimize    *    * @param collection the Solr collection to send the optimize to    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
...
return|;
block|}
comment|/**    * Performs an explicit optimize, causing a merge of all segments to one.    *    * waitFlush=true and waitSearcher=true to be inline with the defaults for plain HTTP access    *    * Note: In most cases it is not required to do explicit optimize    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|optimize
specifier|public
name|UpdateResponse
name|optimize
...
return|;
block|}
comment|/**    * Performs an explicit optimize, causing a merge of all segments to one.    *<p>    * Note: In most cases it is not required to do explicit optimize    *    * @param collection the Solr collection to send the optimize to    * @param waitFlush  block until index changes are flushed to disk    * @param waitSearcher  block until a new searcher is opened and registered as    *                      the main query searcher, making the changes visible    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|optimize
specifier|public
name|UpdateResponse
name|optimize
...
return|;
block|}
comment|/**    * Performs an explicit optimize, causing a merge of all segments to one.    *    * Note: In most cases it is not required to do explicit optimize    *    * @param waitFlush  block until index changes are flushed to disk    * @param waitSearcher  block until a new searcher is opened and registered as    *                      the main query searcher, making the changes visible    * @param maxSegments  optimizes down to at most this number of segments    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|optimize
specifier|public
name|UpdateResponse
name|optimize
...
return|;
block|}
comment|/**    * Deletes a single document by unique ID    *    * @param id  the ID of the document to delete    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|deleteById
specifier|public
name|UpdateResponse
name|deleteById
...
return|;
block|}
comment|/**    * Deletes a single document by unique ID, specifying max time before commit    *    * @param collection the Solr collection to delete the document from    * @param id  the ID of the document to delete    * @param commitWithinMs  max time (in ms) before a commit will happen    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    *    * @since 5.1    */
DECL|method|deleteById
specifier|public
name|UpdateResponse
name|deleteById
...
return|;
block|}
comment|/**    * Deletes a single document by unique ID, specifying max time before commit    *    * @param id  the ID of the document to delete    * @param commitWithinMs  max time (in ms) before a commit will happen    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    *    * @since 3.6    */
DECL|method|deleteById
specifier|public
name|UpdateResponse
name|deleteById
...
return|;
block|}
comment|/**    * Deletes a list of documents by unique ID    *    * @param collection the Solr collection to delete the documents from    * @param ids  the list of document IDs to delete    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|deleteById
specifier|public
name|UpdateResponse
name|deleteById
...
return|;
block|}
comment|/**    * Deletes documents from the index based on a query    *    * @param collection the Solr collection to delete the documents from    * @param query  the query expressing what documents to delete    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
...
return|;
block|}
comment|/**    * Deletes documents from the index based on a query    *    * @param query  the query expressing what documents to delete    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|deleteByQuery
specifier|public
name|UpdateResponse
name|deleteByQuery
...
return|;
block|}
comment|/**    * Deletes documents from the index based on a query, specifying max time before commit    *    * @param collection the Solr collection to delete the documents from    * @param query  the query expressing what documents to delete    * @param commitWithinMs  max time (in ms) before a commit will happen    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    *    * @since 5.1    */
DECL|method|deleteByQuery
specifier|public
name|UpdateResponse
name|deleteByQuery
...
return|;
block|}
comment|/**    * Deletes documents from the index based on a query, specifying max time before commit    *    * @param query  the query expressing what documents to delete    * @param commitWithinMs  max time (in ms) before a commit will happen    *    * @return an {@link org.apache.solr.client.solrj.response.UpdateResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    *    * @since 3.6    */
DECL|method|deleteByQuery
specifier|public
name|UpdateResponse
name|deleteByQuery
...
return|;
block|}
comment|/**    * Issues a ping request to check if the server is alive    *    * @return a {@link org.apache.solr.client.solrj.response.SolrPingResponse} containing the response    *         from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|ping
specifier|public
name|SolrPingResponse
name|ping
...
return|;
block|}
comment|/**    * Retrieves the SolrDocument associated with the given identifier.    *    * @param collection the Solr collection to query    * @param id the id    *    * @return retrieved SolrDocument, or null if no document is found.    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|getById
specifier|public
name|SolrDocument
name|getById
...
return|;
block|}
comment|/**    * Retrieves the SolrDocument associated with the given identifier.    *    * @param id the id    *    * @return retrieved SolrDocument, or null if no document is found.    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|getById
specifier|public
name|SolrDocument
name|getById
...
return|;
block|}
comment|/**    * Retrieves the SolrDocuments associated with the given identifiers.    *    * If a document was not found, it will not be added to the SolrDocumentList.    *    * @param collection the Solr collection to query    * @param ids the ids    *    * @return a SolrDocumentList, or null if no documents were found    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|getById
specifier|public
name|SolrDocumentList
name|getById
...
return|;
block|}
comment|/**    * Retrieves the SolrDocuments associated with the given identifiers.    *    * If a document was not found, it will not be added to the SolrDocumentList.    *    * @param ids the ids    *    * @return a SolrDocumentList, or null if no documents were found    *    *  @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|getById
specifier|public
name|SolrDocumentList
name|getById
...
name|IOException
function_decl|;
comment|/**    * Execute a request against a Solr server    *    * @param request the request to execute    *    * @return a {@link NamedList} containing the response from the server    *    * @throws IOException If there is a low-level I/O error.    * @throws SolrServerException if there is an error on the server    */
DECL|method|request
specifier|public
specifier|final
name|NamedList
...
return|;
block|}
comment|/**    * Get the {@link org.apache.solr.client.solrj.beans.DocumentObjectBinder} for this client.    *    * @return a DocumentObjectBinder    *    * @see SolrClient#addBean    * @see SolrClient#addBeans    */
