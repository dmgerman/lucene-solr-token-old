...
expr_stmt|;
block|}
comment|/**    * Get properties of a shard/slice leader for specific collection.    */
...
return|;
block|}
comment|/**    * Get replica properties (if the slice is unknown) or null if replica is not found.    * If the slice is known, do not use this method.    * coreNodeName is the same as replicaName    */
...
block|}
block|}
comment|/**    * Get the Slice for collection.    */
...
return|;
block|}
comment|/**    * Get the slice/shardId for a core.    * @param coreNodeName in the form of nodeName_coreName (the name of the replica)    */
...
condition|)
continue|continue;
comment|// skip special properties entry
name|Object
name|val
init|=
name|entry
...
return|;
block|}
comment|// TODO: how to instantiate custom routers?
throw|throw
operator|new
name|SolrException
argument_list|(
