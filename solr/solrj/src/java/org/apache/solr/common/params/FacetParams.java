...
literal|".include"
decl_stmt|;
comment|/**    * String indicating the method to use to resolve range facets.    *<p>    * Can be overriden on a per field basis.    * @see FacetRangeMethod    */
DECL|field|FACET_RANGE_METHOD
specifier|public
specifier|static
specifier|final
name|String
...
literal|".set"
decl_stmt|;
comment|/** A spatial RPT field to generate a 2D "heatmap" (grid of facet counts) on. Just like the other faceting types,    * this may include a 'key' or local-params to facet multiple times.  All parameters with this suffix can be    * overridden on a per-field basis. */
DECL|field|FACET_HEATMAP
specifier|public
specifier|static
specifier|final
name|String
name|FACET_HEATMAP
init|=
literal|"facet.heatmap"
decl_stmt|;
comment|/** The format of the heatmap: either png or ints2D (default). */
DECL|field|FACET_HEATMAP_FORMAT
specifier|public
specifier|static
specifier|final
name|String
...
literal|".geom"
decl_stmt|;
comment|/** Specify the heatmap grid level explicitly, instead of deriving it via distErr or distErrPct. */
DECL|field|FACET_HEATMAP_LEVEL
specifier|public
specifier|static
specifier|final
name|String
...
literal|".gridLevel"
decl_stmt|;
comment|/** Used to determine the heatmap grid level to compute, defaulting to 0.15.  It has the same interpretation of    * distErrPct when searching on RPT, but relative to the shape in 'bbox'.  It's a fraction (not a %) of the radius of    * the shape that grid squares must fit into without exceeding.&gt; 0 and&lt;= 0.5.    * Mutually exclusive with distErr&amp; gridLevel. */
DECL|field|FACET_HEATMAP_DIST_ERR_PCT
specifier|public
specifier|static
specifier|final
name|String
...
literal|".distErr"
decl_stmt|;
comment|/** The maximum number of cells (grid squares) the client is willing to handle. If this limit would be exceeded, we    * throw an error instead.  Defaults to 100k. */
DECL|field|FACET_HEATMAP_MAX_CELLS
specifier|public
specifier|static
specifier|final
name|String
...
block|}
block|}
comment|/**    * An enumeration of the legal values for {@link #FACET_RANGE_METHOD}    *<ul>    *<li>filter =</li>    *<li>dv =</li>    *</ul>    * @see #FACET_RANGE_METHOD    */
DECL|enum|FacetRangeMethod
specifier|public
enum|enum
...
name|label
operator|+
literal|" is not a valid method for range faceting"
argument_list|,
name|e
argument_list|)
throw|;
