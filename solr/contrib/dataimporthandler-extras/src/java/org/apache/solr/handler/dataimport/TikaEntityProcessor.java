...
end_import
begin_comment
comment|/**  *<p>An implementation of {@link EntityProcessor} which reads data from rich docs  * using<a href="http://tika.apache.org/">Apache Tika</a>  *  *<p>To index latitude/longitude data that might  * be extracted from a file's metadata, identify  * the geo field for this information with this attribute:  *<code>spatialMetadataField</code>  *  * @since solr 3.1  */
end_comment
begin_class
...
name|htmlMapper
decl_stmt|;
DECL|field|spatialMetadataField
specifier|private
name|String
name|spatialMetadataField
decl_stmt|;
annotation|@
name|Override
DECL|method|init
