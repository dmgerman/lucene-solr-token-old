...
name|info
argument_list|(
literal|"Optional clustering engine not available: "
operator|+
name|name
argument_list|)
expr_stmt|;
...
name|SERVER_ERROR
argument_list|,
literal|"A required clustering engine failed to initialize, check the logs: "
operator|+
name|name
argument_list|)
throw|;
...
name|SERVER_ERROR
argument_list|,
literal|"Clustering engine declared, but not available, check the logs: "
operator|+
name|name
argument_list|)
throw|;
...
argument_list|)
decl_stmt|;
comment|// if fl=* then we don't need to check.
if|if
condition|(
name|fl
operator|.
