...
name|req
argument_list|(
literal|"+id:simple2 +t_content:serif"
argument_list|)
argument_list|,
literal|"//*[@numFound='0']"
argument_list|)
expr_stmt|;
comment|// make sure<style> content is excluded
name|assertQ
argument_list|(
name|req
argument_list|(
literal|"+id:simple2 +t_content:blur"
argument_list|)
argument_list|,
literal|"//*[@numFound='0']"
argument_list|)
...
name|req
argument_list|(
literal|"+id:capture1 +t_content:Solr"
argument_list|)
argument_list|,
literal|"//*[@numFound='1']"
argument_list|)
...
name|req
argument_list|(
literal|"+id:capture1 +foo_t:\"here is some text in a div\""
argument_list|)
argument_list|,
literal|"//*[@numFound='1']"
argument_list|)
...
name|req
argument_list|(
literal|"+id:capture2 +div_t:\"here is some text in a div\""
argument_list|)
argument_list|,
literal|"//*[@numFound='1']"
argument_list|)
...
name|req
argument_list|(
literal|"+id:capture2 +anchor_t:http\\://www.apache.org"
argument_list|)
argument_list|,
literal|"//*[@numFound='1']"
argument_list|)
...
name|req
argument_list|(
literal|"+id:capture2 +anchor_t:link"
argument_list|)
argument_list|,
literal|"//*[@numFound='1']"
argument_list|)
...
argument_list|)
expr_stmt|;
comment|//there is only one matching<a> tag
name|loadLocal
argument_list|(
literal|"extraction/example.html"
argument_list|,
...
literal|"xpath"
argument_list|,
literal|"/xhtml:html/xhtml:body/xhtml:div//node()"
argument_list|,
literal|"commit"
argument_list|,
literal|"true"
...
name|req
argument_list|(
literal|"+id:example1 +foo_t:\"here is some text in a div\""
argument_list|)
argument_list|,
literal|"//*[@numFound='1']"
argument_list|)
...
annotation|@
name|Test
DECL|method|testPdfWithImages
specifier|public
name|void
name|testPdfWithImages
parameter_list|()
throws|throws
name|Exception
block|{
comment|//Tests possibility to configure ParseContext (by example to extract embedded images from pdf)
name|loadLocal
argument_list|(
literal|"extraction/pdf-with-image.pdf"
argument_list|,
literal|"fmap.created"
argument_list|,
literal|"extractedDate"
...
literal|"literal.id"
argument_list|,
literal|"pdfWithImage"
argument_list|,
literal|"resource.name"
argument_list|,
literal|"pdf-with-image.pdf"
argument_list|,
...
name|req
argument_list|(
literal|"wdf_nocase:\"embedded:image0.jpg\""
argument_list|)
argument_list|,
literal|"//*[@numFound='0']"
argument_list|)
