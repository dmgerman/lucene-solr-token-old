...
return|;
block|}
comment|/**    * analyze the range with the analyzer, instead of the collator.    * because icu collators are not thread safe, this keeps things     * simple (we already have a threadlocal clone in the reused TS)    */
...
name|RuntimeException
argument_list|(
literal|"Unable analyze range part: "
operator|+
name|part
argument_list|,
name|e
