...
argument_list|)
expr_stmt|;
comment|// Find any BlockJoinScorers out there:
name|scorer
operator|.
name|visitScorers
argument_list|(
...
parameter_list|)
block|{
comment|//System.out.println("visitOpt");
if|if
condition|(
name|child
operator|instanceof
...
parameter_list|)
block|{
comment|//System.out.println("visitReq parent=" + parent + " child=" + child + " scorer=" + scorer);
if|if
condition|(
name|child
operator|instanceof
...
parameter_list|)
block|{
comment|//System.out.println("visitProh");
if|if
condition|(
name|child
operator|instanceof
