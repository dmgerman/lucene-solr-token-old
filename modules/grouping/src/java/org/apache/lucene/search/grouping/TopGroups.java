...
expr_stmt|;
block|}
comment|/** Merges an array of TopGroups, for example obtained    *  from the second-pass collector across multiple    *  shards.  Each TopGroups must have been sorted by the    *  same groupSort and docSort, and the top groups passed    *  to all second-pass collectors must be the same.    *    *<b>NOTE</b>: this cannot merge totalGroupCount; ie the    * returned TopGroups will have null totalGroupCount.    *    *<b>NOTE</b>: the topDocs in each GroupDocs is actually    * an instance of TopDocsAndShards    */
DECL|method|merge
specifier|public
specifier|static
parameter_list|<
