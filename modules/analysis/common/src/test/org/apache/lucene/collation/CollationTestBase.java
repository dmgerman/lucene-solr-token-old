...
literal|"\u0638"
decl_stmt|;
comment|/**    * Convenience method to perform the same function as CollationKeyFilter.    *      * @param keyBits the result from     *  collator.getCollationKey(original).toByteArray()    * @return The encoded collation key for the original String    * @deprecated only for testing deprecated filters    */
annotation|@
name|Deprecated
...
parameter_list|()
block|{
comment|// ideally we could do this!
comment|// return _TestUtil.randomUnicodeString(random);
comment|//
comment|// http://bugs.icu-project.org/trac/ticket/8060
comment|// http://bugs.icu-project.org/trac/ticket/7732
comment|// ...
comment|//
comment|// as a workaround, just test the BMP for now (and avoid 0xFFFF etc)
name|int
name|length
init|=
name|_TestUtil
