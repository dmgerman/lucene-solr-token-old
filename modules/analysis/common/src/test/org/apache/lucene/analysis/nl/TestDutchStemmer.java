...
expr_stmt|;
block|}
comment|/**    * prior to 3.6, this confusingly did not happen if     * you specified your own stoplist!!!!    * @deprecated (3.6) Remove this test in Lucene 5.0    */
annotation|@
name|Deprecated
DECL|method|testBuggyStemOverrides
specifier|public
name|void
name|testBuggyStemOverrides
parameter_list|()
throws|throws
name|IOException
block|{
