...
return|;
block|}
comment|// convenience constructors... deprecated because they cause confusion
comment|// because they use parent directory instead of the actual directory.
DECL|field|ourDirectory
specifier|private
name|Directory
name|ourDirectory
init|=
...
argument_list|()
expr_stmt|;
comment|// remember to close the directory we opened
block|}
...
argument_list|()
expr_stmt|;
comment|// rememebr to close the directory we opened
block|}
