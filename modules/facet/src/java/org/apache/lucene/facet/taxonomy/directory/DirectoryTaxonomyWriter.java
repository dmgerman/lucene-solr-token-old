...
name|TaxonomyWriter
block|{
comment|/**    * Property name of user commit data that contains the creation time of a taxonomy index.    *<p>    * Applications making use of {@link TaxonomyWriter#commit(Map)} should not use this    * particular property name.     */
...
name|cacheMisses
decl_stmt|;
comment|/**    * When a taxonomy is created, we mark that its create time should be committed in the     * next commit.    */
DECL|field|taxoIndexCreateTime
specifier|private
name|String
name|taxoIndexCreateTime
init|=
literal|null
decl_stmt|;
