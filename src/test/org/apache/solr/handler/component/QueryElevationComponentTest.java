...
argument_list|,
literal|"//result/doc[3]/int[@name='id'][.='c']"
argument_list|)
expr_stmt|;
...
literal|"//*[@numFound='6']"
argument_list|,
literal|"//result/doc[1]/int[@name='id'][.='x']"
argument_list|,
literal|"//result/doc[2]/int[@name='id'][.='y']"
argument_list|,
literal|"//result/doc[3]/int[@name='id'][.='z']"
argument_list|,
literal|"//result/doc[4]/int[@name='id'][.='a']"
argument_list|,
literal|"//result/doc[5]/int[@name='id'][.='b']"
argument_list|,
literal|"//result/doc[6]/int[@name='id'][.='c']"
argument_list|)
expr_stmt|;
name|booster
operator|.
...
literal|"//result/doc[1]/int[@name='id'][.='a']"
argument_list|,
literal|"//result/doc[2]/int[@name='id'][.='x']"
argument_list|,
literal|"//result/doc[3]/int[@name='id'][.='b']"
argument_list|,
literal|"//result/doc[4]/int[@name='id'][.='c']"
argument_list|)
expr_stmt|;
...
literal|"//result/doc[4]/int[@name='id'][.='a']"
argument_list|,
literal|"//result/doc[3]/int[@name='id'][.='x']"
argument_list|,
literal|"//result/doc[2]/int[@name='id'][.='b']"
argument_list|,
literal|"//result/doc[1]/int[@name='id'][.='c']"
argument_list|)
expr_stmt|;
...
literal|"//result/doc[3]/int[@name='id'][.='c']"
argument_list|,
literal|"//result/doc[4]/int[@name='id'][.='x']"
argument_list|)
expr_stmt|;
name|booster
operator|.
