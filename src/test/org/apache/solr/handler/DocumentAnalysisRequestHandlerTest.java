...
name|assertEquals
argument_list|(
literal|"Only the default analyzer should be applied"
argument_list|,
literal|1
argument_list|,
name|queryResult
...
name|matches
argument_list|(
literal|"org.apache.solr.schema.FieldType\\$DefaultAnalyzer.*"
argument_list|)
argument_list|)
expr_stmt|;
name|List
...
name|assertEquals
argument_list|(
literal|"The id field has only a single value"
argument_list|,
literal|1
argument_list|,
name|indexResult
...
name|assertEquals
argument_list|(
literal|"The 'id' field value has only one token"
argument_list|,
literal|1
argument_list|,
name|tokenList
