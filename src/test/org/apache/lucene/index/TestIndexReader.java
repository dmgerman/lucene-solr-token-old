...
expr_stmt|;
block|}
DECL|method|testFalseDirectoryAlreadyClosed
specifier|public
name|void
name|testFalseDirectoryAlreadyClosed
parameter_list|()
throws|throws
name|Throwable
block|{
...
argument_list|(
literal|"java.io.tmpdir undefined"
argument_list|)
throw|;
name|File
name|indexDir
...
name|tempDir
argument_list|,
literal|"lucenetestdiralreadyclosed"
argument_list|)
decl_stmt|;
try|try
block|{
...
name|fail
argument_list|(
literal|"should not have hit AlreadyClosedException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
comment|// expected
block|}
comment|// Make sure we really did close the dir inside IndexReader.open
name|dir
operator|.
name|close
argument_list|()
...
block|}
comment|// LUCENE-1483
DECL|method|testDocsInOrderSearch
specifier|public
name|void
name|testDocsInOrderSearch
parameter_list|()
throws|throws
name|Throwable
block|{
