...
expr_stmt|;
block|}
comment|/***   public void testConjunctionPerf() throws Exception {     createDummySearcher();     validate=false;     sets=randBitSets(32,1000000);     long start = System.currentTimeMillis();     doConjunctions(500,6);     long end = System.currentTimeMillis();     s.close();     System.out.println("milliseconds="+(end-start));   }    public void testNestedConjunctionPerf() throws Exception {     createDummySearcher();     validate=false;     sets=randBitSets(32,1000000);     long start = System.currentTimeMillis();     doNestedConjunctions(500,3,3);     long end = System.currentTimeMillis();     s.close();     System.out.println("milliseconds="+(end-start));   }    public void testConjunctionTerms() throws Exception {     RAMDirectory dir = new RAMDirectory();     System.out.println("Creating index");     createRandomTerms(100000,25, dir);     s = new IndexSearcher(dir);     System.out.println("Starting performance test");     long start = System.currentTimeMillis();     doTermConjunctions(s,25,5,10000);     long end = System.currentTimeMillis();     s.close();     System.out.println("milliseconds="+(end-start));   }    public void testNestedConjunctionTerms() throws Exception {     RAMDirectory dir = new RAMDirectory();     System.out.println("Creating index");     createRandomTerms(100000,25, dir);     s = new IndexSearcher(dir);     System.out.println("Starting performance test");     long start = System.currentTimeMillis();     doNestedTermConjunctions(s,25,5,5,1000);     long end = System.currentTimeMillis();     s.close();     System.out.println("milliseconds="+(end-start));   }   ***/
block|}
end_class
end_unit
