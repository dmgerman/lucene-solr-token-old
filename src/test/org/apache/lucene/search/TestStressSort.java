...
argument_list|)
expr_stmt|;
comment|// doc2 doesn't have stringField, so we get nulls
for|for
control|(
name|int
name|i
...
argument_list|)
expr_stmt|;
comment|//sorts[sortCount++] = sort = new Sort();
comment|//sort.setSort(new SortField[] {new SortField("string", SortField.STRING_ORD, reverse)});
comment|//sorts[sortCount++] = sort = new Sort();
comment|//sort.setSort(new SortField[] {new SortField("string", SortField.STRING_ORD_VAL, reverse)});
comment|//sorts[sortCount++] = sort = new Sort();
comment|//sort.setSort(new SortField[] {new SortField("string", SortField.STRING_ORD_VAL_DEM, reverse)});
comment|//sorts[sortCount++] = sort = new Sort();
comment|//sort.setSort(new SortField[] {new SortField("string", SortField.STRING_ORD_VAL_DEM2, reverse)});
name|sorts
index|[
name|sortCount
operator|++
