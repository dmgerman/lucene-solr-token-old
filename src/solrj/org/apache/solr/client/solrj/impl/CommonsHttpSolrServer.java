...
expr_stmt|;
block|}
comment|/**    * Adds the documents supplied by the given iterator. A commit is called after all the documents are added.    * If an exception is thrown, commit is not called.    *    * @param docIterator  the iterator which returns SolrInputDocument instances    * @param commitParams additional parameters such as optimize, waitFlush, waitSearcher    *    * @return the response from the SolrServer    */
DECL|method|addAndCommit
specifier|public
name|UpdateResponse
name|addAndCommit
parameter_list|(
