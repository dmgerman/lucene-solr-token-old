...
argument_list|)
decl_stmt|;
comment|/**      * Resolves the deserialized instance to the local reference for accurate      * equals() and == comparisons.      *       * @return a reference to Occur as resolved in the local VM      * @throws ObjectStreamException      */
