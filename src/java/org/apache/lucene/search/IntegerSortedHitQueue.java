...
end_comment
begin_class
DECL|class|IntegerSortedHitQueue
class|class
name|IntegerSortedHitQueue
extends|extends
name|FieldSortedHitQueue
block|{
comment|/** 	 * Creates a hit queue sorted over the given field containing integer values. 	 * @param reader Index to use. 	 * @param integer_field Field containing integer sort information 	 * @param size Number of hits to collect. 	 * @throws IOException If an error occurs reading the index. 	 */
DECL|method|IntegerSortedHitQueue
name|IntegerSortedHitQueue
parameter_list|(
name|IndexReader
name|reader
...
expr_stmt|;
block|}
comment|/** 	 * Returns a comparator for sorting hits according to a field containing integers. 	 * Just calls<code>comparator(IndexReader,String)</code>. 	 * @param reader  Index to use. 	 * @param field  Field containg integer values. 	 * @return  Comparator for sorting hits. 	 * @throws IOException If an error occurs reading the index. 	 */
