...
name|hashcode
decl_stmt|;
comment|// unique for this object
...
expr_stmt|;
block|}
comment|/** Two of these are equal iff they reference the same reader, field and type. */
DECL|method|equals
specifier|public
name|boolean
name|equals
...
return|;
block|}
comment|/** Composes a hashcode based on the referenced reader, field and type. */
