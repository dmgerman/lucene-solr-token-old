...
return|;
block|}
comment|/**    * @deprecated Please use {@link #setConstantScoreRewrite} instead.    */
...
expr_stmt|;
block|}
comment|/**    * @deprecated Please use {@link #getConstantScoreRewrite} instead.    */
...
return|;
block|}
comment|/**    * By default QueryParser uses constant-score rewriting    * when creating a PrefixQuery, WildcardQuery or RangeQuery. This implementation is generally preferable because it     * a) Runs faster b) Does not have the scarcity of terms unduly influence score     * c) avoids any "TooManyBooleanClauses" exception.    * However, if your application really needs to use the    * old-fashioned BooleanQuery expansion rewriting and the above    * points are not relevant then set this option to<code>true</code>    * Default is<code>false</code>.    */
...
expr_stmt|;
block|}
comment|/**    * @see #setConstantScoreRewrite(boolean)    */
