...
return|;
block|}
comment|/**    * Set to<code>true</code> to allow<code>*</code> and<code>?</code> as the first character     * of a PrefixQuery and WildcardQuery. Note that this can produce very slow    * queries on big indexes. Default: false.    */
...
expr_stmt|;
block|}
comment|/**    * @see #setAllowLeadingWildcard    */
