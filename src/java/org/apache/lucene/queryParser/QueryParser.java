...
name|locale
decl_stmt|;
comment|/** Parses a query string, returning a {@link org.apache.lucene.search.Query}.    *  Default locale is used for date range parsing.    *  Use {@link #parse(String, String, Analyzer, Locale)} for non-default locale handling.    *  @param query	the query string to be parsed.    *  @param field	the default field for query terms.    *  @param analyzer   used to find terms in the query text.    *  @throws ParseException if the parsing fails    */
DECL|method|parse
specifier|static
specifier|public
name|Query
...
block|}
block|}
comment|/** Parses a query string, returning a {@link org.apache.lucene.search.Query}.    *  @param query	the query string to be parsed.    *  @param field	the default field for query terms.    *  @param analyzer   used to find terms in the query text.    *  @param locale locale to use for date range parsing    *  @throws ParseException if the parsing fails    */
DECL|method|parse
specifier|static
specifier|public
name|Query
...
expr_stmt|;
block|}
comment|/** Constructs a query parser.    *  @param f	the default field for query terms.    *  @param a   used to find terms in the query text.    *  @param locale    */
DECL|method|QueryParser
specifier|public
name|QueryParser
parameter_list|(
