...
expr_stmt|;
block|}
comment|/**    * Sets the date resolution used by RangeQueries for a specific field.    *      * @param field field for which the date resolution is to be set     * @param dateResolution date resolution to set    */
DECL|method|setDateResolution
specifier|public
name|void
name|setDateResolution
