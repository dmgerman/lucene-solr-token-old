...
end_import
begin_comment
comment|/** Simple utility class providing static methods to  *  compress and decompress binary data for stored fields.  *  This class uses java.util.zip.Deflater and Inflater  *  classes to compress and decompress.  *  *  To compress a String:  *<pre>  *    String string = ...  *    byte[] bytes = compress(string.getBytes("UTF-8");  *</pre>  *  and  to decompress:  *<pre>  *    new String(decompress(bytes), "UTF-8");  *</pre>  */
end_comment
begin_class
