...
return|;
block|}
comment|/** Create a field by specifying all parameters except for<code>termVector</code>,    *  which is set to<code>TermVector.NO</code>.    */
DECL|method|Field
specifier|public
name|Field
parameter_list|(
