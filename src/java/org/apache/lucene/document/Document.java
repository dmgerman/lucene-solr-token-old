...
expr_stmt|;
block|}
comment|/**    * Removes field with the given name from the document.    * If multiple fields exist with this name, this method returns the first value added.    * If there is no field with the specified name, the document remains unchanged.    */
...
block|}
block|}
comment|/**    * Removes all fields with the given name from the document.    * If there is no field with the specified name, the document remains unchanged.    */
