...
return|;
block|}
comment|/** A factory method, that generates a {@link SortField} instance for sorting prefix encoded double values. */
DECL|method|getDoubleSortField
specifier|public
specifier|static
name|SortField
name|getDoubleSortField
parameter_list|(
specifier|final
name|String
name|field
...
return|;
block|}
comment|/** A factory method, that generates a {@link SortField} instance for sorting prefix encoded float values. */
DECL|method|getFloatSortField
specifier|public
specifier|static
name|SortField
name|getFloatSortField
parameter_list|(
specifier|final
name|String
name|field
