...
condition|)
block|{
comment|// Currently hardwired to 1, but once we add method to
comment|// IndexWriter to allow "optimizing to<= N segments"
comment|// then we will change this.
specifier|final
name|int
