...
parameter_list|)
block|{
comment|// Share deleter to our SegmentReaders:
name|this
operator|.
name|deleter
operator|=
...
return|;
block|}
comment|/**    * Returns<code>true</code> if all readers are still up-to-date.    *     * @throws IOException    */
...
argument_list|(
literal|"This method is only implemented in "
operator|+
literal|"IndexReader, not in MultiReader"
argument_list|)
throw|;
block|}
block|}
