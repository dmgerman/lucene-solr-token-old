...
comment|// didn't).  But, the segments_N file now includes
comment|// checksum at the end, which should catch this case.
comment|// So when a reader tries to read it, it will throw a
