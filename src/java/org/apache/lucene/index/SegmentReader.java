...
condition|)
block|{
comment|// OK: directly clone myself
name|newReader
operator|=
name|reopenSegment
argument_list|(
...
argument_list|(
literal|"cannot reopen a standalone SegmentReader"
argument_list|)
throw|;
block|}
block|}
...
comment|// so we increment the other reader's refCount.
name|clone
operator|.
name|referencedSegmentReader
operator|=
...
block|{
comment|// We are the original SegmentReader
name|clone
operator|.
name|referencedSegmentReader
operator|=
