...
name|termVectorsReaderOrig
expr_stmt|;
comment|// we have to open a new FieldsReader, because it is not thread-safe
comment|// and can thus not be shared among multiple SegmentReaders
comment|// TODO: Change this in case FieldsReader becomes thread-safe in the future
specifier|final
name|String
name|fieldsSegment
decl_stmt|;
...
expr_stmt|;
block|}
comment|// re-opened SegmentReaders have their own instance of FieldsReader
if|if
condition|(
name|fieldsReader
operator|!=
