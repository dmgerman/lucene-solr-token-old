...
return|;
block|}
comment|/**    * @see IndexReader#getFieldNames()    * @deprecated  Replaced by {@link #getFieldNames (IndexReader.FieldOption fldOption)}    */
...
return|;
block|}
comment|/**    * @see IndexReader#getFieldNames(boolean)    * @deprecated  Replaced by {@link #getFieldNames (IndexReader.FieldOption fldOption)}    */
DECL|method|getFieldNames
specifier|public
name|Collection
name|getFieldNames
...
return|;
block|}
comment|/**    * @see IndexReader#getIndexedFieldNames(Field.TermVector tvSpec)    * @deprecated  Replaced by {@link #getFieldNames (IndexReader.FieldOption fldOption)}    */
