...
block|}
block|}
comment|/**    * Writer calls this when it has hit an error and had to    * roll back, to tell us that there may now be    * unreferenced files in the filesystem.  So we re-list    * the filesystem and delete such files:    */
DECL|method|refresh
specifier|public
name|void
name|refresh
...
block|}
block|}
comment|/**    * Blindly delete the files used by the specific segments,    * with no reference counting and no retry.  This is only    * currently used by writer to delete its RAM segments    * from a RAMDirectory.    */
DECL|method|deleteDirect
specifier|public
name|void
name|deleteDirect
parameter_list|(
