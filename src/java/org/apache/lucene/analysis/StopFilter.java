...
expr_stmt|;
block|}
comment|/**    * Constructs a filter which removes words from the input    * TokenStream that are named in the Hashtable.    * If ignoreCase is true, all keys in the stopTable should already    * be lowercased.    * @deprecated Use {@link #StopFilter(TokenStream, Set)} instead    */
DECL|method|StopFilter
specifier|public
name|StopFilter
parameter_list|(
...
return|;
block|}
comment|/**     * Builds a Hashtable from an array of stop words,     * appropriate for passing into the StopFilter constructor.     * This permits this table construction to be cached once when     * an Analyzer is constructed.   * @deprecated Use {@link #makeStopSet(java.lang.String[], boolean)}  instead.  */
DECL|method|makeStopTable
specifier|public
specifier|static
specifier|final
