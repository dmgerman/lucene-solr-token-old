...
return|;
block|}
comment|/**    *    * @param stopWords A List of Strings representing the stopwords    * @param ignoreCase if true, all words are lower cased first    * @return A Set containing the words    */
DECL|method|makeStopSet
specifier|public
specifier|static
specifier|final
