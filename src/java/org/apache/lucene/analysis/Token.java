...
block|{
comment|// no term Text, the first allocation
name|termBuffer
operator|=
operator|new
name|char
...
comment|// to use this method anymore, only for late init of the buffer
...
expr_stmt|;
block|}
comment|// remove the following optimization in 3.0 when old TokenStream API removed:
block|}
elseif|else
if|if
condition|(
