...
return|;
block|}
comment|/**    * Increments this stream to the next token out of the list of cached tokens    * @throws IOException    */
...
expr_stmt|;
block|}
comment|/**    * Returns the next token out of the list of cached tokens    * @return The next {@link org.apache.lucene.analysis.Token} in the Sink.    * @throws IOException    * @deprecated    */
DECL|method|next
specifier|public
name|Token
name|next
