...
block|}
empty_stmt|;
comment|/** given a field name, get a random hash seed -- using dynamic fields, you can force the random order to change */
DECL|method|getSeed
specifier|private
specifier|static
name|int
