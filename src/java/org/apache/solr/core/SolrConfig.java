...
return|;
block|}
comment|/**    * Get a list of NamedList, one for each node matched by the given XPath     *    * @param xpath the XPath to match    * @return a list of NamedList instances corresponding to each node matched by the given XPath    */
DECL|method|getAllNodesAsNamedList
specifier|public
name|List
argument_list|<
name|NamedList
argument_list|>
name|getAllNodesAsNamedList
parameter_list|(
name|String
name|xpath
parameter_list|)
...
return|;
block|}
comment|/**    * Get the NamedList corresponding to the first node matched by the given XPath    *    * @param xpath the XPath to match    * @return the NamedList corresponding to the first node matched by the given XPath    */
DECL|method|getNodeAsNamedList
specifier|public
name|NamedList
name|getNodeAsNamedList
parameter_list|(
name|String
name|xpath
parameter_list|)
