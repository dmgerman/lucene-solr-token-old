...
argument_list|()
decl_stmt|;
comment|/**    * Creates a configation information from the specified file.    * Add any exception that might occur to the severeErrors singleton.    * @param file file name to load    * @see Config#openResource    */
