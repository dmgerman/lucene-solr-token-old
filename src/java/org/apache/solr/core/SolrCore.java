...
argument_list|)
expr_stmt|;
comment|// execute firstSearcher event
comment|//TODO: It may not always be the case that this is the only time the first searcher event needs to fire.
name|doFirstSearcherEvent
argument_list|(
name|getSearcher
argument_list|()
operator|.
...
block|}
block|}
DECL|method|doFirstSearcherEvent
specifier|private
name|void
name|doFirstSearcherEvent
parameter_list|(
