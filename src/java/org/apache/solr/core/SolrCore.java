...
argument_list|)
throw|;
comment|//most of the classes do not have constructors whiuch take in SolrCore. It is recommended to obtain SolrCore by implementing SolrCoreAare.
...
argument_list|)
decl_stmt|;
comment|// this is the default one
for|for
control|(
name|Map
operator|.
