...
end_import
begin_comment
comment|/**  *<p>  * Responsible for finding (or creating) a MBeanServer from given configuration  * and registering all SolrInfoMBean objects with JMX.  *</p>  *<p/>  *<p>  * Please see http://wiki.apache.org/solr/SolrJmx for instructions on usage and configuration  *</p>  *  * @version $Id$  * @see org.apache.solr.core.SolrConfig.JmxConfiguration  * @since solr 1.3  */
end_comment
begin_class
...
name|SERVER_ERROR
argument_list|,
literal|"Incorrect JMX Configuration in solrconfig.xml, both agentId and serviceUrl cannot be specified at the same time"
argument_list|)
throw|;
block|}
if|if
...
name|key
operator|+
literal|" because it was not registered"
argument_list|)
expr_stmt|;
block|}
block|}
