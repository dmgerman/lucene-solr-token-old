...
argument_list|()
decl_stmt|;
comment|// this doesn't take into account deleted docs!
name|float
name|minVal
init|=
literal|0.0f
...
expr_stmt|;
block|}
comment|// Traverse the complete set of values to get the min and the max.
comment|// Future alternatives include being able to ask a DocValues for min/max
comment|// Another memory-intensive option is to cache the values in
comment|// a float[] on this first pass.
for|for
control|(
name|int
name|i
