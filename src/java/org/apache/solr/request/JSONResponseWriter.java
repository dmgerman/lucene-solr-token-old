...
argument_list|)
expr_stmt|;
comment|// give the main response a name it it doesn't have one
if|if
condition|(
name|nl
operator|.
...
expr_stmt|;
block|}
comment|// Represents a NamedList directly as a JSON Object (essentially a Map)
comment|// more natural but potentially problematic since order is not maintained and keys
comment|// can't be repeated.
DECL|method|writeNamedListAsMap
specifier|protected
name|void
name|writeNamedListAsMap
parameter_list|(
name|String
name|name
parameter_list|,
...
expr_stmt|;
break|break;
comment|/*** the following are not required to be escaped              case '\r':              case '\n':              case '\t':              case '\b':              case '\f':              case '/':              ***/
default|default:
name|writer
operator|.
name|write
