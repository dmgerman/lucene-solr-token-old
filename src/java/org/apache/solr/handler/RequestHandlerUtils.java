...
expr_stmt|;
block|}
comment|/**    * Check the request parameters and decide if it should commit or optimize.    * If it does, it will check parameters for "waitFlush" and "waitSearcher"    *     * Use the update processor version    *     * @since solr 1.2    */
annotation|@
name|Deprecated
