...
name|topFacets
decl_stmt|;
comment|// field facets that order by constraint count (sort=true)
DECL|field|listFacets
name|LinkedHashMap
argument_list|<
name|String
argument_list|,
...
name|listFacets
decl_stmt|;
comment|// field facets that list values in term order
block|}
end_class
begin_class
