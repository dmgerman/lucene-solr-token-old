...
name|SERVER_ERROR
argument_list|,
literal|"must call startDoc() before adding fields!"
argument_list|)
throw|;
block|}
...
return|;
block|}
comment|/**     * Build a lucene document from a SolrInputDocument    *     * @since solr 1.3    */
DECL|method|build
specifier|public
name|Document
name|build
...
condition|)
block|{
comment|// Make sure to format dates
name|SchemaField
name|sfield
init|=
name|schema
