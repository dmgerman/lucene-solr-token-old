...
expr_stmt|;
block|}
comment|/** clears a bit, allowing access beyond the current set size */
DECL|method|clear
specifier|public
name|void
name|clear
...
argument_list|)
decl_stmt|;
comment|/*** Grrr, java shifting wraps around so -1L>>64 == -1     long startmask = -1L<< (startIndex& 0x3f);     // example: 11111...111000     long endmask = -1L>>> (64-(endIndex& 0x3f));   // example: 00111...111111     ***/
name|long
name|startmask
init|=
operator|-
