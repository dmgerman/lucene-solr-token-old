...
argument_list|()
decl_stmt|;
comment|/* Ignore SolrParams.DF - could have init param FQs assuming the      * schema default with query param DF intented to only affect Q.      * If user doesn't want schema default, they should be explicit in the FQ.      */
name|SolrQueryParser
name|qp
init|=
operator|new
