...
end_import
begin_comment
comment|/**  *<p>Utilities that may be of use to RequestHandlers.</p>  *  *<p>  * Many of these functions have code that was stolen/mutated from  * StandardRequestHandler.  *</p>  *  *<p>:TODO: refactor StandardRequestHandler to use these utilities</p>  */
end_comment
begin_class
...
expr_stmt|;
block|}
comment|/**    * Given a space seperated list of field names, sets the field list on the    * SolrQueryResponse.    */
DECL|method|setReturnFields
specifier|public
specifier|static
name|void
...
DECL|method|flatenBooleanQuery
specifier|public
specifier|static
name|void
name|flatenBooleanQuery
parameter_list|(
name|BooleanQuery
name|to
parameter_list|,
