...
return|;
block|}
comment|/**    * Retrieve a default Highlighter instance for a given query.    *    * @param query Query instance    */
DECL|method|getDefaultHighlighter
specifier|public
specifier|static
name|Highlighter
name|getDefaultHighlighter
parameter_list|(
name|Query
name|query
parameter_list|)
...
argument_list|()
decl_stmt|;
comment|// use the Searcher's doc cache
name|Document
name|doc
init|=
name|searcher
...
comment|// TODO: we can include score and position information in output as
comment|// snippet attributes
if|if
condition|(
name|frag
operator|.
...
return|;
block|}
comment|/**    * Perform highlighting of selected fields.    *    * @param docs query results    * @param query the (possibly re-written query)    * @param req associated SolrQueryRequest    * @param defaultFields default search field list    *    * @return NamedList containing summary data, or null if highlighting is     * disabled.    *    */
DECL|method|doStandardHighlighting
specifier|public
specifier|static
name|NamedList
...
return|;
block|}
comment|/** TODO: API IN PROGRESS... SUBJECT TO CHANGE    * Perform highlighting of selected fields.    *    * @param docs query results    * @param query the (possibly re-written query)    * @param req associated SolrQueryRequest    * @param defaultFields default search field list    *    * @return NamedList containing summary data, or null if highlighting is    * disabled.    *    */
DECL|method|doStandardHighlighting
specifier|public
specifier|static
name|NamedList
