...
condition|)
block|{
comment|// only look at the first node.
name|NamedNodeMap
name|attrs
init|=
name|nodes
...
name|getNamedItem
argument_list|(
literal|"multipartUploadLimitInKB"
argument_list|)
expr_stmt|;
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|// I don't see a need to have this publically configured just yet
