...
return|;
block|}
comment|/** True if only indexed points shall be supported. There are no "leafs" in such a case, except those    * at maximum precision. */
...
return|;
block|}
comment|/**    * Turns {@link SpatialPrefixTree#getTreeCellIterator(Shape, int)} into a    * {@link org.apache.lucene.analysis.TokenStream}.    */
DECL|method|createIndexableFields
specifier|public
name|Field
index|[]
...
parameter_list|)
block|{
comment|//TODO re-use TokenStream LUCENE-5776: Subclass Field, put cell iterator there, override tokenStream()
name|Iterator
argument_list|<
name|Cell
argument_list|>
...
parameter_list|()
block|{
comment|//subclasses could return one that never emits leaves, or does both, or who knows.
return|return
operator|new
name|CellToBytesRefIterator
argument_list|()
...
argument_list|)
return|;
comment|//TODO should take a re-use iterator
block|}
