...
return|;
block|}
comment|/** Evaluate a vector (dot product) and check for "zero".      *@param v is the vector to evaluate.      *@return true if the evaluation yielded zero.      */
...
return|;
block|}
comment|/** Evaluate a vector (do a dot product) snd check for "zero".      *@param x is the x value of the vector to evaluate.      *@param y is the x value of the vector to evaluate.      *@param z is the x value of the vector to evaluate.      *@return true if the evaluation yielded zero.      */
DECL|method|evaluateIsZero
specifier|public
name|boolean
name|evaluateIsZero
...
return|;
block|}
comment|/** Evaluate a vector (do a dot product).      *@param v is the vector to evaluate.      *@return the result.      */
...
return|;
block|}
comment|/** Evaluate a vector (do a dot product).      *@param x is the x value of the vector to evaluate.      *@param y is the x value of the vector to evaluate.      *@param z is the x value of the vector to evaluate.      *@return the result.      */
DECL|method|evaluate
specifier|public
name|double
name|evaluate
