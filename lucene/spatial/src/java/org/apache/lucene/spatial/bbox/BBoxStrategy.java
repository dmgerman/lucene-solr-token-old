...
return|;
block|}
comment|/** Used to customize the indexing options of the 4 number fields, and to a lesser degree the XDL field too. Search    * requires indexed=true, and relevancy requires docValues. If these features aren't needed then disable them.    * {@link FieldType#freeze()} is called on the argument. */
...
return|;
block|}
comment|/** Field subclass circumventing Field limitations. This one instance can have any combination of indexed, stored,    * and docValues.    */
...
argument_list|)
expr_stmt|;
comment|//this expert constructor allows us to have a field that has docValues& indexed/stored
name|super
operator|.
name|fieldsData
operator|=
