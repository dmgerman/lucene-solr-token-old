...
end_import
begin_comment
comment|// HACK: this is a wimpier version of GeoTestUtil used for now until we can
end_comment
begin_comment
comment|// get all tests passing with new random number generator!
end_comment
begin_class
DECL|class|GeoPointTestUtil
specifier|final
class|class
