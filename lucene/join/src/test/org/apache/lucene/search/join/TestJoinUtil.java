...
expr_stmt|;
block|}
DECL|method|testOrdinalsJoinExplainNoMatches
specifier|public
name|void
name|testOrdinalsJoinExplainNoMatches
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
argument_list|,
literal|"Not a match, join value 1"
argument_list|)
expr_stmt|;
name|explanation
operator|=
...
argument_list|)
expr_stmt|;
comment|// no exception due to missing rewrites
name|reader
operator|.
name|close
argument_list|()
...
decl_stmt|;
block|{
comment|// single val can be handled by multiple-vals
specifier|final
name|boolean
name|muliValsQuery
init|=
...
name|String
argument_list|>
name|randomUniqueValuesReplica
init|=
operator|new
name|ArrayList
argument_list|<>
