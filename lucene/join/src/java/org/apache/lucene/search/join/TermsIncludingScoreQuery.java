...
argument_list|(
literal|"nextDoc() isn't supported because doc ids are emitted out of order"
argument_list|)
throw|;
block|}
annotation|@
...
name|UnsupportedOperationException
argument_list|(
literal|"advance() isn't supported because doc ids are emitted out of order"
argument_list|)
throw|;
block|}
DECL|method|advanceForExplainOnly
specifier|private
name|int
name|advanceForExplainOnly
parameter_list|(
