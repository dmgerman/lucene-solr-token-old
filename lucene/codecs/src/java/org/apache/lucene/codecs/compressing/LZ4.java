...
block|}
block|}
comment|/**    * Compress<code>bytes[off:off+len]</code> into<code>out</code> using    * 2<sup>hashLog</sup> bytes of memory. Higher values of<code>hashLog</code>    * improve the compression ratio.    */
