...
end_import
begin_comment
comment|/**  * FST-based terms dictionary reader.  *  * The FST directly maps each term and its metadata,   * it is memory resident.  *  * @lucene.experimental  */
end_comment
begin_class
DECL|class|FSTTermsReader
specifier|public
class|class
name|FSTTermsReader
extends|extends
...
name|bytesReader
decl_stmt|;
comment|/** Decodes metadata into customized term state */
...
argument_list|()
expr_stmt|;
comment|// NOTE: metadata will only be initialized in child class
block|}
annotation|@
name|Override
...
name|level
decl_stmt|;
comment|/* to which level the metadata is accumulated         * so that we can accumulate metadata lazily */
DECL|field|metaUpto
name|int
name|metaUpto
decl_stmt|;
...
block|}
block|}
comment|/** Lazily accumulate meta data, when we got a accepted term */
