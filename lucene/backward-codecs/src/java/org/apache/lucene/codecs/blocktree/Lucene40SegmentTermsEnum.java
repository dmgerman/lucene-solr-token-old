...
end_import
begin_comment
comment|/**  * Iterates through terms in this field  * @deprecated Only for 4.x backcompat  */
end_comment
begin_class
annotation|@
name|Deprecated
DECL|class|Lucene40SegmentTermsEnum
specifier|final
class|class
name|Lucene40SegmentTermsEnum
extends|extends
name|TermsEnum
block|{
comment|// Lazy init:
...
DECL|field|stack
specifier|private
name|Lucene40SegmentTermsEnumFrame
index|[]
name|stack
decl_stmt|;
...
index|]
decl_stmt|;
DECL|method|Lucene40SegmentTermsEnum
specifier|public
name|Lucene40SegmentTermsEnum
parameter_list|(
name|Lucene40FieldReader
