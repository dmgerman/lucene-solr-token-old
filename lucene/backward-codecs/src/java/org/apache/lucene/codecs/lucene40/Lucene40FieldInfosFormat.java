...
end_import
begin_comment
comment|/**  * Lucene 4.0 Field Infos format.  * @deprecated Only for reading old 4.0 and 4.1 segments  */
end_comment
begin_class
annotation|@
name|Deprecated
...
condition|)
block|{
comment|// Undead norms!  Lucene40NormsReader will check this and bring norms back from the dead:
name|UndeadNormsProducer
operator|.
name|setUndead
argument_list|(
