...
end_import
begin_comment
comment|/**  * Lucene 4.x compound file format  * @deprecated only for reading 4.x segments  */
end_comment
begin_class
annotation|@
name|Deprecated
DECL|class|Lucene40CompoundReader
specifier|final
class|class
...
name|BaseDirectory
block|{
comment|// TODO: would be great to move this read-write stuff out of here into test.
...
DECL|method|Lucene40CompoundReader
specifier|public
name|Lucene40CompoundReader
parameter_list|(
name|Directory
