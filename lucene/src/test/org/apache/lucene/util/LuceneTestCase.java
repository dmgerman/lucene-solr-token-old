...
name|VERBOSE
decl_stmt|;
comment|/** Use this constant when creating Analyzers and any other version-dependent stuff. */
...
name|fail
argument_list|(
literal|"directory of testcase "
operator|+
name|getName
argument_list|()
operator|+
literal|" was not closed, opened from: "
operator|+
name|element
argument_list|)
expr_stmt|;
