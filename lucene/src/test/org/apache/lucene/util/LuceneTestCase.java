...
block|}
block|}
comment|// These deprecated methods should be removed soon, when all tests using no Epsilon are fixed:
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**    * Returns a new Dictionary instance, with contents copied from the    * provided directory. See {@link #newDirectory()} for more    * information.    */
DECL|method|newDirectory
specifier|public
name|MockDirectoryWrapper
name|newDirectory
...
argument_list|)
decl_stmt|;
comment|// try not to enable this hack unless we must.
if|if
condition|(
name|d
operator|instanceof
...
name|println
argument_list|(
literal|"NOTE: random locale of testcase '"
operator|+
name|getName
argument_list|()
operator|+
...
name|println
argument_list|(
literal|"NOTE: random timezone of testcase '"
operator|+
name|getName
argument_list|()
operator|+
...
block|}
block|}
comment|/**    * Test runner for Lucene test classes that test Locale-sensitive behavior.    *<p>    * This class will run tests under the default Locale, but then will also run    * tests under all available JVM locales. This is helpful to ensure tests will    * not fail under a different environment.    *</p>    */
DECL|class|LocalizedTestCaseRunner
specifier|public
specifier|static
class|class
...
block|}
decl_stmt|;
DECL|method|LocalizedTestCaseRunner
specifier|public
name|LocalizedTestCaseRunner
parameter_list|(
name|Class
...
name|LuceneTestCaseRunner
block|{
comment|/**      * Before changing the default Codec, save the default Codec here so      * that it can be restored.      */
...
argument_list|()
decl_stmt|;
comment|/**      * The Codec being used as the system default      */
DECL|field|codec
specifier|private
name|String
name|codec
...
block|}
decl_stmt|;
DECL|method|MultiCodecTestCaseRunner
specifier|public
name|MultiCodecTestCaseRunner
parameter_list|(
name|Class
