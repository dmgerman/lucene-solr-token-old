...
literal|0x8000000000000000L
expr_stmt|;
comment|//System.out.println("Long.valueOf(0x"+Long.toHexString(min>>>shift)+"L),Long.valueOf(0x"+Long.toHexString(max>>>shift)+"L)/*shift="+shift+"*/,");
name|assertEquals
argument_list|(
literal|"shift"
argument_list|,
...
literal|0x80000000
expr_stmt|;
comment|//System.out.println("Integer.valueOf(0x"+Integer.toHexString(min>>>shift)+"),Integer.valueOf(0x"+Integer.toHexString(max>>>shift)+")/*shift="+shift+"*/,");
name|assertEquals
argument_list|(
literal|"shift"
argument_list|,
