...
name|IOException
block|{
comment|// we will generate some illegal syntax regular expressions...
try|try
block|{
operator|new
name|RegExp
...
return|;
block|}
comment|// a random string biased towards populating a ton of operators
DECL|method|randomRegex
specifier|public
name|String
name|randomRegex
parameter_list|()
