...
expr_stmt|;
block|}
comment|//public static enum DataType { INT, LONG, FLOAT, DOUBLE }
DECL|field|dataType
specifier|private
name|DataType
name|dataType
...
expr_stmt|;
block|}
comment|/**    * Creates a field for numeric values using the default    *<code>precisionStep</code> {@link NumericUtils#PRECISION_STEP_DEFAULT} (4).    * The instance is not yet initialized with a numeric value, before indexing a    * document containing this field, set a value using the various set    *<em>???</em>Value() methods.    *     * @param name    *          the field name    * @param type    *          if the defualt field should be altered, e.g. stored,     *          {@link Document#getField} then returns {@code NumericField}     *          instances on search results, or indexed using     *          {@link NumericTokenStream}    */
DECL|method|NumericField
specifier|public
name|NumericField
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Creates a field for numeric values with the specified    *<code>precisionStep</code>. The instance is not yet initialized with a    * numeric value, before indexing a document containing this field, set a    * value using the various set<em>???</em>Value() methods.    *     * @param name    *          the field name    * @param precisionStep    *          the used<a    *          href="../search/NumericRangeQuery.html#precisionStepDesc"    *>precision step</a>    * @param type    *          if the defualt field should be altered, e.g. stored,     *          {@link Document#getField} then returns {@code NumericField}     *          instances on search results, or indexed using     *          {@link NumericTokenStream}    */
DECL|method|NumericField
specifier|public
name|NumericField
parameter_list|(
...
return|;
block|}
comment|/**    * Returns the numeric value as a string. It is recommended to    * use {@link Document#getField} instead that returns {@code NumericField}    * instances. You can then use {@link #numericValue} to return the stored    * value.    */
annotation|@
name|Override
