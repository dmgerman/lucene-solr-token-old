...
argument_list|)
decl_stmt|;
DECL|field|reusableTokenStreamMethod
specifier|private
specifier|static
specifier|final
name|VirtualMethod
...
name|Analyzer
argument_list|>
name|reusableTokenStreamMethod
init|=
operator|new
name|VirtualMethod
argument_list|<
...
literal|0
decl_stmt|;
comment|/** @deprecated This is a no-op since Lucene 3.1. */
annotation|@
name|Deprecated
