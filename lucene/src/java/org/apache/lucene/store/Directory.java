...
return|;
block|}
comment|/**    *<p>Copy all files of this directory to destination directory. All conflicting files at destination are overwritten</p>    *<p><b>NOTE:</b> this method only copies files that look like index files (ie, have extensions matching the known    * extensions of index files).    *<p><b>NOTE:</b> the source directory should not change while this method is running.  Otherwise the results are    * undefined and you could easily hit a FileNotFoundException.</p>    *    * @param to        destination directory    */
DECL|method|copyTo
specifier|public
specifier|final
name|void
...
expr_stmt|;
block|}
comment|/**    *<p>Copy given files of this directory to destination directory. All conflicting files at destination are overwritten</p>    *<p><b>NOTE:</b> the source directory should not change while this method is running.  Otherwise the results are    * undefined and you could easily hit a FileNotFoundException.</p>    *<p><b>NOTE:</b> implementations can check if destination directory is of the same type as 'this' and perform optimized copy</p>    *    * @param to        destination directory    * @param filenames file names to be copied    */
DECL|method|copyTo
specifier|public
name|void
name|copyTo
