...
expr_stmt|;
block|}
comment|/**     * WARNING: the provided BytesRef is not copied, but used directly.    * Therefore the bytes should not be modified after construction, for    * example, you should clone a copy rather than pass reused bytes from    * a TermsEnum.    *     * @lucene.experimental     */
DECL|method|Term
specifier|public
name|Term
parameter_list|(
