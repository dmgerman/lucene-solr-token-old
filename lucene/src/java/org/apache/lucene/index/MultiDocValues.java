...
return|;
block|}
comment|/**    * Returns a single {@link DocValues} instance for this norms field, merging    * their values on the fly.    *     *<p>    *<b>NOTE</b>: this is a slow way to access DocValues. It's better to get the    * sub-readers (using {@link Gather}) and iterate through them yourself.    */
...
argument_list|()
expr_stmt|;
comment|// set to identity to return null
name|stop
operator|=
literal|true
expr_stmt|;
