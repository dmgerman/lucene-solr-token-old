...
return|;
block|}
comment|/**    * Returns true if the given filename ends with the separate norms file    * pattern: {@code SEPARATE_NORMS_EXTENSION + "[0-9]+"}.    * @deprecated only for asserting    */
annotation|@
name|Deprecated
DECL|method|isSeparateNormsFile
specifier|private
specifier|static
name|boolean
name|isSeparateNormsFile
