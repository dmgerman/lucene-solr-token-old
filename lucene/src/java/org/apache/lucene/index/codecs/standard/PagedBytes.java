...
end_import
begin_comment
comment|/** Represents a logical byte[] as a series of pages.  You  *  can write-once into the logical byte[], using copy, and  *  then retrieve slices (BytesRef) into it using fill. */
end_comment
begin_class
