...
argument_list|(
literal|"cannot merge field "
operator|+
name|fi
operator|.
name|name
operator|+
literal|" indexValues changed from "
operator|+
name|mergedIndexValues
operator|+
literal|" to "
...
argument_list|)
expr_stmt|;
comment|// nocommit -- how should we handle index values here?
block|}
block|}
name|fieldInfos
operator|.
...
name|indexValues
decl_stmt|;
comment|// nocommit we need some kind of compatibility notation for values such
comment|// that two slighly different segments can be merged eg. fixed vs.
...
case|:
comment|// nocommit -- enable setting Comparator
name|writer
operator|=
name|Bytes
operator|.
