...
DECL|method|openIndexValuesReaders
specifier|private
name|void
name|openIndexValuesReaders
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// nocommit - externalize the filenames
if|if
condition|(
name|v
operator|!=
...
expr_stmt|;
block|}
name|closeIndexValuesReaders
argument_list|()
expr_stmt|;
block|}
block|}
DECL|method|closeIndexValuesReaders
specifier|private
name|void
name|closeIndexValuesReaders
parameter_list|()
