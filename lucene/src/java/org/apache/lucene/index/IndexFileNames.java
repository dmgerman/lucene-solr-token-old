...
literal|"s"
decl_stmt|;
comment|/** Extension of global field numbers */
DECL|field|GLOBAL_FIELD_NUM_MAP_EXTENSION
specifier|public
specifier|static
specifier|final
name|String
...
return|;
block|}
comment|/**    * Returns true if the given filename ends with the separate norms file    * pattern: {@code SEPARATE_NORMS_EXTENSION + "[0-9]+"}.    */
