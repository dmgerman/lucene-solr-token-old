...
literal|null
decl_stmt|;
comment|/** @deprecated remove when getFieldQuery is removed */
annotation|@
name|Deprecated
DECL|field|getFieldQueryMethod
specifier|static
specifier|final
name|VirtualMethod
argument_list|<
...
annotation|@
name|Deprecated
DECL|field|getFieldQueryWithQuotedMethod
specifier|static
specifier|final
name|VirtualMethod
argument_list|<
name|QueryParserBase
argument_list|>
name|getFieldQueryWithQuotedMethod
init|=
operator|new
name|VirtualMethod
argument_list|<
...
literal|0
decl_stmt|;
comment|// its ok for both to be overridden
...
argument_list|(
literal|"You must implement the new API: getFieldQuery(String,String,boolean)"
operator|+
literal|" to use setAutoGeneratePhraseQueries(false)"
argument_list|)
throw|;
name|this
operator|.
...
name|ParseException
block|{
comment|// treat the text as if it was quoted, to drive phrase logic with old versions.
return|return
name|getFieldQuery
argument_list|(
name|field
