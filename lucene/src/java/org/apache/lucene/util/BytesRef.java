...
parameter_list|)
block|{
comment|// TODO: new byte[10] is waste of resources; it should
comment|// simply allocate text.length()*4 like UnicodeUtil.
comment|// Ideally, I would remove this here and add a
comment|// null-check in UnicodeUtil. (Uwe)
if|if
condition|(
name|bytes
operator|==
