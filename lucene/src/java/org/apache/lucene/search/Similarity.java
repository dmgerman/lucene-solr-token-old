...
literal|1
decl_stmt|;
comment|/** Set the default Similarity implementation used by indexing and search    * code.    *    * @see IndexSearcher#setSimilarity(Similarity)    * @see org.apache.lucene.index.IndexWriterConfig#setSimilarity(Similarity)    */
...
expr_stmt|;
block|}
comment|/** Return the default Similarity implementation used by indexing and search    * code.    *    *<p>This is initially an instance of {@link DefaultSimilarity}.    *    * @see IndexSearcher#setSimilarity(Similarity)    * @see org.apache.lucene.index.IndexWriterConfig#setSimilarity(Similarity)    */
...
return|;
block|}
comment|/**    * This method forwards to {@link    * #idfExplain(Term,IndexSearcher,int)} by passing    *<code>searcher.docFreq(term)</code> as the docFreq.    */
DECL|method|idfExplain
specifier|public
name|IDFExplanation
name|idfExplain
