...
argument_list|)
decl_stmt|;
comment|/** Gets the codecprovider to run tests with */
DECL|field|TEST_CODECPROVIDER
specifier|public
specifier|static
specifier|final
name|String
name|TEST_CODECPROVIDER
init|=
name|System
operator|.
name|getProperty
argument_list|(
literal|"tests.codecprovider"
argument_list|,
literal|"random"
argument_list|)
decl_stmt|;
...
block|{
comment|// someone specified their own codecprovider by class
try|try
block|{
name|Class
argument_list|<
...
condition|)
block|{
comment|// TODO: somehow do random per-field?!
name|Set
argument_list|<
name|String
argument_list|>
...
name|println
argument_list|(
literal|"Could not instantiate CodecProvider: "
operator|+
name|TEST_CODECPROVIDER
argument_list|)
expr_stmt|;
...
init|=
name|uninstallCodecsAfterClass
argument_list|()
decl_stmt|;
name|Locale
operator|.
...
expr_stmt|;
block|}
comment|/** uninstalls test codecs, returns description of the codec used for debugging */
DECL|method|uninstallCodecsAfterClass
specifier|private
specifier|static
name|String
name|uninstallCodecsAfterClass
