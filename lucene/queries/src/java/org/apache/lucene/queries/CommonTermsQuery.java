...
return|;
block|}
comment|/**    * Gets the list of terms.    */
...
return|;
block|}
comment|/**    * Gets the maximum threshold of a terms document frequency to be considered a    * low frequency term.    */
...
return|;
block|}
comment|/**    * Gets the {@link Occur} used for low frequency terms.    */
DECL|method|getLowFreqOccur
specifier|public
name|Occur
name|getLowFreqOccur
parameter_list|()
block|{
return|return
name|lowFreqOccur
return|;
block|}
comment|/**    * Gets the {@link Occur} used for high frequency terms.    */
DECL|method|getHighFreqOccur
specifier|public
name|Occur
name|getHighFreqOccur
parameter_list|()
block|{
return|return
name|highFreqOccur
return|;
block|}
comment|/**    * Gets the boost used for low frequency terms.    */
DECL|method|getLowFreqBoost
specifier|public
name|float
name|getLowFreqBoost
parameter_list|()
block|{
return|return
name|lowFreqBoost
return|;
block|}
comment|/**    * Gets the boost used for high frequency terms.    */
DECL|method|getHighFreqBoost
specifier|public
name|float
name|getHighFreqBoost
parameter_list|()
block|{
return|return
name|highFreqBoost
