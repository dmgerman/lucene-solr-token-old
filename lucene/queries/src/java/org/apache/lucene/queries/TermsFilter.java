...
decl_stmt|;
comment|// header of the array held by the String
DECL|field|start
specifier|final
name|int
name|start
...
parameter_list|()
block|{
comment|// this is an approximation since we don't actually know how strings store
comment|// their data, which can be JVM-dependent
return|return
name|BASE_RAM_BYTES_USED
operator|+
name|field
