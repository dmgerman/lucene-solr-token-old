...
operator|=
operator|new
name|VerboseSecureDirectoryStream
argument_list|(
operator|(
name|SecureDirectoryStream
argument_list|<
...
return|;
block|}
DECL|class|VerboseSecureDirectoryStream
class|class
name|VerboseSecureDirectoryStream
extends|extends
...
name|dir
decl_stmt|;
DECL|method|VerboseSecureDirectoryStream
name|VerboseSecureDirectoryStream
parameter_list|(
name|SecureDirectoryStream
argument_list|<
...
name|sop
argument_list|(
literal|"deleteDirectory[SECURE]: "
operator|+
name|path
argument_list|(
name|path
