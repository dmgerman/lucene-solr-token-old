...
return|;
block|}
comment|/**    * Creates a random {@link CompressingCodec} with more reasonable parameters for big tests.    */
DECL|method|reasonableInstance
specifier|public
specifier|static
name|CompressingCodec
...
parameter_list|)
block|{
comment|// e.g. defaults use 2^14 for FAST and ~ 2^16 for HIGH
specifier|final
name|int
name|chunkSize
init|=
...
argument_list|)
decl_stmt|;
comment|// e.g. defaults use 128 for FAST and 512 for HIGH
specifier|final
name|int
name|chunkDocs
init|=
...
argument_list|)
decl_stmt|;
comment|// e.g. defaults use 1024 for both cases
specifier|final
name|int
name|blockSize
init|=
