...
name|println
argument_list|(
literal|"RIW: open writer from reader"
argument_list|)
expr_stmt|;
block|}
name|reader
...
expr_stmt|;
block|}
name|maybeFlushOrCommit
argument_list|()
expr_stmt|;
block|}
DECL|method|maybeFlushOrCommit
specifier|private
name|void
name|maybeFlushOrCommit
parameter_list|()
...
name|println
argument_list|(
literal|"RIW.add/updateDocument: now doing a flush at docCount="
operator|+
name|docCount
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|/** Writes all in-memory segments to the {@link Directory}. */
DECL|method|flush
specifier|public
specifier|final
name|void
...
expr_stmt|;
block|}
comment|/**    * Simple interface that is executed for each<tt>TP</tt> {@link InfoStream} component    * message. See also {@link RandomIndexWriter#mockIndexWriter(Random, Directory, IndexWriterConfig, TestPoint)}    */
