...
return|;
block|}
comment|/**    * This provides the default AttributeFactory in reflective-only mode (package private)    * so we can test it.    */
DECL|field|REFLECTIVE_ATTRIBUTE_FACTORY
specifier|private
specifier|final
specifier|static
name|AttributeFactory
name|REFLECTIVE_ATTRIBUTE_FACTORY
decl_stmt|;
static|static
block|{
try|try
...
argument_list|()
operator|+
literal|"$DefaultAttributeFactory"
argument_list|)
operator|.
name|asSubclass
argument_list|(
...
name|Error
argument_list|(
literal|"Cannot initantiate a reflective-only DefaultAttributeFactory"
argument_list|,
name|e
argument_list|)
throw|;
