...
expr_stmt|;
block|}
comment|/**    * Set to false if you want to return the pure {@link LockFactory} and not    * wrap all lock with {@code AssertingLock}.    *<p>    * Be careful if you turn this off: {@code MockDirectoryWrapper} might    * no longer be able to detect if you forget to close an {@link IndexWriter},    * and spit out horribly scary confusing exceptions instead of    * simply telling you that.    */
DECL|method|setAssertLocks
specifier|public
name|void
name|setAssertLocks
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// TODO: fix stupid tests like TestIndexWriter.testNoSegmentFile to not do this!
assert|assert
name|remove
operator|!=
literal|null
