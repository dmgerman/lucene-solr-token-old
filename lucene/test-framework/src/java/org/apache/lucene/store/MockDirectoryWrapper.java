...
argument_list|()
operator|+
literal|": MockDirectoryWrapper: now throw random exception during open"
argument_list|)
expr_stmt|;
operator|new
name|Throwable
...
condition|)
block|{
comment|// once in a while wrap the IO in a Buffered IO with random buffer sizes
name|delegateOutput
operator|=
operator|new
name|BufferedIndexOutputWrapper
argument_list|(
literal|1
operator|+
name|randomState
...
return|;
block|}
DECL|class|BufferedIndexOutputWrapper
specifier|final
class|class
name|BufferedIndexOutputWrapper
extends|extends
...
name|io
decl_stmt|;
DECL|method|BufferedIndexOutputWrapper
specifier|public
name|BufferedIndexOutputWrapper
parameter_list|(
name|int
