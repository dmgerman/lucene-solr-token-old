...
name|AssertionError
argument_list|(
literal|"MockDirectoryWrapper: source file \""
operator|+
name|source
operator|+
...
block|}
block|}
DECL|method|corruptUnknownFiles
specifier|public
specifier|synchronized
name|void
...
name|println
argument_list|(
literal|"MDW: corrupt unknown files"
argument_list|)
expr_stmt|;
name|Set
argument_list|<
...
literal|4
case|:
comment|// Corrupt one bit randomly in the file:
block|{
name|String
name|tempFileName
init|=
...
condition|)
block|{
comment|// Copy first part unchanged:
name|long
name|byteToCorrupt
init|=
call|(
...
expr_stmt|;
block|}
comment|// Randomly flip one bit from this byte:
name|byte
name|b
init|=
name|ii
...
literal|" bytes"
expr_stmt|;
comment|// Copy last part unchanged:
name|long
name|bytesLeft
init|=
name|ii
...
name|name
operator|+
literal|", a virus scanner has it open (exists?="
operator|+
name|LuceneTestCase
operator|.
name|slowFileExists
...
argument_list|)
decl_stmt|;
comment|// Disregard what happens with the pendingDeletions files:
name|files
operator|.
name|removeAll
argument_list|(
