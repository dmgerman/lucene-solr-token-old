...
decl_stmt|;
comment|/**    * Cares about all properties.     */
DECL|method|SystemPropertiesInvariantRule
specifier|public
name|SystemPropertiesInvariantRule
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**    * Don't care about the given set of properties.     */
DECL|method|SystemPropertiesInvariantRule
specifier|public
name|SystemPropertiesInvariantRule
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// Remove ignored if they exist.
name|before
operator|.
name|keySet
argument_list|()
