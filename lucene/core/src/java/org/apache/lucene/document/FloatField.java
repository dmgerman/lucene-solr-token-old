...
name|Field
block|{
comment|/**     * Type for a FloatField that is not stored:    * normalization factors, frequencies, and positions are omitted.    */
...
expr_stmt|;
block|}
comment|/**     * Type for a stored FloatField:    * normalization factors, frequencies, and positions are omitted.    */
...
expr_stmt|;
block|}
comment|/** Expert: allows you to customize the {@link    *  FieldType}.     *  @param name field name    *  @param value 32-bit float value    *  @param type customized field type: must have {@link FieldType#numericType()}    *         of {@link FieldType.NumericType#FLOAT}.    *  @throws IllegalArgumentException if the field name or type is null, or    *          if the field type does not have a FLOAT numericType()    */
DECL|method|FloatField
specifier|public
name|FloatField
parameter_list|(
