...
name|IOException
block|{
comment|/*     final FieldType ft = new FieldType(TextField.TYPE_STORED);     ft.setStoreTermVectors(fieldInfo.hasVectors());     ft.setIndexed(fieldInfo.isIndexed());     ft.setOmitNorms(fieldInfo.omitsNorms());     ft.setIndexOptions(fieldInfo.getIndexOptions());     */
name|doc
operator|.
name|add
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//doc.add(new Field(fieldInfo.name, value, ft));
block|}
annotation|@
name|Override
