...
name|FieldsConsumer
block|{
comment|/** Suggested default value for the {@code    *  minItemsInBlock} parameter to {@link    *  #TempBlockTreeTermsWriter(SegmentWriteState,TempPostingsWriterBase,int,int)}. */
...
literal|25
decl_stmt|;
comment|/** Suggested default value for the {@code    *  maxItemsInBlock} parameter to {@link    *  #TempBlockTreeTermsWriter(SegmentWriteState,TempPostingsWriterBase,int,int)}. */
...
DECL|method|TempBlockTreeTermsWriter
specifier|public
name|TempBlockTreeTermsWriter
parameter_list|(
name|SegmentWriteState
