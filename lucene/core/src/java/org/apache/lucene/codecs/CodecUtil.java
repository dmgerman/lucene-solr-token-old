...
return|;
block|}
comment|/** Retrieves the full index header from the provided {@link IndexInput}.    *  This throws {@link CorruptIndexException} if this file does    * not appear to be an index file. */
...
return|;
block|}
comment|/** Retrieves the full footer from the provided {@link IndexInput}.  This throws    *  {@link CorruptIndexException} if this file does not have a valid footer. */
DECL|method|readFooter
specifier|public
specifier|static
name|byte
index|[]
