...
block|}
block|}
comment|/** reads from legacy 3.x segments_N */
DECL|method|readLegacySegmentInfo
specifier|private
name|SegmentInfoPerCommit
name|readLegacySegmentInfo
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// parse the docstore stuff and shove it into attributes
specifier|final
name|String
...
expr_stmt|;
block|}
comment|// parse the normgen stuff and shove it into attributes
if|if
condition|(
name|normGen
operator|!=
...
return|;
block|}
DECL|method|readUpgradedSegmentInfo
specifier|private
name|SegmentInfo
name|readUpgradedSegmentInfo
parameter_list|(
