...
name|FieldsConsumer
block|{
comment|/** Suggested default value for the {@code    *  minItemsInBlock} parameter to {@link    *  #TempBlockTermsWriter(SegmentWriteState,TempPostingsWriterBase,int,int)}. */
...
literal|25
decl_stmt|;
comment|/** Suggested default value for the {@code    *  maxItemsInBlock} parameter to {@link    *  #TempBlockTermsWriter(SegmentWriteState,TempPostingsWriterBase,int,int)}. */
...
argument_list|()
expr_stmt|;
comment|// Write term metadata block
...
condition|)
block|{
comment|// nocommit: this -1 padding is implicit (maybe we need javadocs, or better
comment|// an API to tell PostingsBase that: every time you meet a 'don't care', just put -1 on it?
name|meta
operator|.
name|longs
index|[
