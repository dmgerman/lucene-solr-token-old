...
name|pending
decl_stmt|;
comment|/* stack to record how current term is constructed, used to accumulate        * metadata or rewind term:        *   stack.size() == term.length + 2,        *                == 1 when term is null */
DECL|field|stack
specifier|final
name|Stack
argument_list|<
...
argument_list|)
expr_stmt|;
comment|//if (DEBUG) System.out.println("  term=" + term + " stack=" + stack.size());
block|}
