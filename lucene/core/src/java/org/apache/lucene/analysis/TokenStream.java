...
name|Closeable
block|{
comment|/** Default {@link AttributeFactory} instance that should be used for TokenStreams. */
DECL|field|DEFAULT_TOKEN_ATTRIBUTE_FACTORY
specifier|public
specifier|static
specifier|final
name|AttributeFactory
...
name|IOException
block|{}
comment|/** Releases resources associated with this stream.    *<p>    * If you override this method, always call {@code super.close()}, otherwise    * some internal state will not be correctly reset (e.g., {@link Tokenizer} will    * throw {@link IllegalStateException} on reuse).    */
annotation|@
name|Override
DECL|method|close
specifier|public
