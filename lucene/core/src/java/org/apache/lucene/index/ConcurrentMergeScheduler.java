...
DECL|field|DEFAULT_CPU_CORE_COUNT_PROPERTY
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"lucene.cms.override_core_count"
decl_stmt|;
comment|/** Used for testing.    *    * @lucene.internal */
DECL|field|DEFAULT_SPINS_PROPERTY
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"lucene.cms.override_spins"
decl_stmt|;
...
argument_list|()
decl_stmt|;
comment|// Let tests override this to help reproducing a failure on a machine that has a different
comment|// core count than the one where the test originally failed:
try|try
block|{
name|String
name|value
