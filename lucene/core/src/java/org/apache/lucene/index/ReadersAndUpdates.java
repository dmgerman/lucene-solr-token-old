...
literal|null
assert|;
comment|//          System.out.println("[" + Thread.currentThread().getName() + "] RAU.writeFieldUpdates: applying binary updates; seg=" + info + " f=" + dvFieldUpdates + ", updates=" + dvFieldUpdates);
name|fieldInfo
operator|.
name|setDocValuesGen
argument_list|(
