...
expr_stmt|;
block|}
comment|/** Calls {@link    *  IndexWriter#updateDocument(Term,IndexDocument,Analyzer)}    *  and returns the generation that reflects this change. */
...
return|;
block|}
comment|/** Calls {@link    *  IndexWriter#updateDocuments(Term,Iterable,Analyzer)}    *  and returns the generation that reflects this change. */
...
return|;
block|}
comment|/** Calls {@link    *  IndexWriter#addDocument(IndexDocument,Analyzer)} and    *  returns the generation that reflects this change. */
...
return|;
block|}
comment|/** Calls {@link    *  IndexWriter#addDocuments(Iterable,Analyzer)} and    *  returns the generation that reflects this change.  */
