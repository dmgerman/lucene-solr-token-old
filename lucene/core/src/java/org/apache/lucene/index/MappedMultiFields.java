...
name|mappingDocsAndPositionsEnum
return|;
comment|/*       MappingMultiDocsEnum mappingDocsEnum;       if (reuse instanceof MappingMultiDocsEnum) {         mappingDocsEnum = (MappingMultiDocsEnum) reuse;       } else {         mappingDocsEnum = new MappingMultiDocsEnum(mergeState);       }              MultiDocsEnum docsEnum = (MultiDocsEnum) in.docs(liveDocs, mappingDocsEnum.multiDocsEnum, flags);       mappingDocsEnum.reset(docsEnum);       return mappingDocsEnum;*/
block|}
block|}
block|}
end_class
