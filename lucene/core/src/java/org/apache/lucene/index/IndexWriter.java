...
block|}
assert|assert
name|assertEventQueueAfterClose
argument_list|()
assert|;
block|}
block|}
DECL|method|assertEventQueueAfterClose
specifier|private
name|boolean
name|assertEventQueueAfterClose
parameter_list|()
...
comment|// deleted document, or right on it, in which case we advance them above
...
condition|)
block|{
comment|// an approximantion of maxDoc, used to compute best bitsPerValue
name|fieldUpdates
operator|=
operator|new
name|NumericFieldUpdates
