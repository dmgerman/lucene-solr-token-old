...
end_package
begin_comment
comment|// nocommit must add sorted indices to back compat tests
end_comment
begin_import
import|import
name|java
...
comment|// nocommit doesn't support index sorting?  or sorts must be the same?
...
comment|// nocommit make sure if you add "sorted by X" to "sorted by Y" index, we catch it
DECL|method|addIndexes
specifier|public
name|void
name|addIndexes
