...
block|}
block|}
comment|/**    * Writes a String map.    *<p>    * First the size is written as an {@link #writeInt(int) Int32},    * followed by each key-value pair written as two consecutive     * {@link #writeString(String) String}s.    *     * @param map Input map. May be null (equivalent to an empty map)    * @deprecated Use {@link #writeMapOfStrings(Map)} instead.    */
annotation|@
name|Deprecated
...
block|}
block|}
comment|/**    * Writes a String map.    *<p>    * First the size is written as an {@link #writeVInt(int) vInt},    * followed by each key-value pair written as two consecutive     * {@link #writeString(String) String}s.    *     * @param map Input map.    * @throws NullPointerException if {@code map} is null.    */
DECL|method|writeMapOfStrings
specifier|public
name|void
...
block|}
block|}
comment|/**    * Writes a String set.    *<p>    * First the size is written as an {@link #writeInt(int) Int32},    * followed by each value written as a    * {@link #writeString(String) String}.    *     * @param set Input set. May be null (equivalent to an empty set)    * @deprecated Use {@link #writeMapOfStrings(Map)} instead.    */
annotation|@
name|Deprecated
...
block|}
block|}
comment|/**    * Writes a String set.    *<p>    * First the size is written as an {@link #writeVInt(int) vInt},    * followed by each value written as a    * {@link #writeString(String) String}.    *     * @param set Input set.    * @throws NullPointerException if {@code set} is null.    */
DECL|method|writeSetOfStrings
specifier|public
name|void
