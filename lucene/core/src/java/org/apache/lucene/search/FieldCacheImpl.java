...
comment|// setting parser = NUMERIC_UTILS_INT_PARSER) so
comment|// cache key includes NUMERIC_UTILS_INT_PARSER:
return|return
name|wrapper
operator|.
name|getInts
...
block|{
comment|// Confusing: must delegate to wrapper (vs simply
comment|// setting parser = NUMERIC_UTILS_FLOAT_PARSER) so
comment|// cache key includes NUMERIC_UTILS_FLOAT_PARSER:
return|return
name|wrapper
operator|.
name|getFloats
...
block|{
comment|// Confusing: must delegate to wrapper (vs simply
comment|// setting parser = NUMERIC_UTILS_LONG_PARSER) so
comment|// cache key includes NUMERIC_UTILS_LONG_PARSER:
return|return
name|wrapper
operator|.
name|getLongs
...
block|{
comment|// Confusing: must delegate to wrapper (vs simply
comment|// setting parser = NUMERIC_UTILS_DOUBLE_PARSER) so
comment|// cache key includes NUMERIC_UTILS_DOUBLE_PARSER:
return|return
name|wrapper
operator|.
name|getDoubles
