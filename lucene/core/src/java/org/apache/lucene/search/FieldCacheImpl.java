...
control|)
block|{
comment|// nocommit somewhat dangerous ... eg if user had
comment|// indexed as DV.BYTE ...
name|values
index|[
name|docID
index|]
...
parameter_list|()
block|{
comment|// nocommit: to the codec api? or can that termsenum just use this thing?
return|return
literal|null
return|;
block|}
