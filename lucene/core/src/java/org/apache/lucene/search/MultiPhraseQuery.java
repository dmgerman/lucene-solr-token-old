...
comment|// have more than one term:
name|docFreq
operator|=
literal|0
expr_stmt|;
...
condition|)
block|{
comment|// None of the terms are in this reader
return|return
literal|null
return|;
block|}
...
condition|)
block|{
comment|// Term doesn't exist in reader
continue|continue;
block|}
name|termsEnum
operator|.
