...
name|Query
block|{
DECL|field|NON_SCORING_SIM_SCORER
specifier|private
specifier|static
specifier|final
name|Similarity
...
block|{
comment|// do not bother computing actual stats, scores are not needed
specifier|final
name|int
name|maxDoc
init|=
...
block|{
comment|// avoids loading other scoring factors such as norms
name|simScorer
operator|=
name|NON_SCORING_SIM_SCORER
expr_stmt|;
