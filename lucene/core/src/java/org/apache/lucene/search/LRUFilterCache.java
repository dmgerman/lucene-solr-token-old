...
condition|)
block|{
comment|// this filter becomes the most-recently used filter
specifier|final
name|boolean
name|added
init|=
...
argument_list|)
decl_stmt|;
comment|// added is necessarily false since the leaf caches contain a subset of mostRecentlyUsedFilters
assert|assert
name|added
operator|==
literal|false
