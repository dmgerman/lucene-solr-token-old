...
name|SpanQuery
block|{
comment|/** By default we enclose the wrapped query within parenthesis, but this is    *  not required for all queries, so we use a whitelist of queries that don't    *  need parenthesis to have a better toString(). */
DECL|field|NO_PARENS_REQUIRED_QUERIES
specifier|private
specifier|static
specifier|final
name|Set
...
argument_list|>
argument_list|>
name|NO_PARENS_REQUIRED_QUERIES
init|=
name|Collections
operator|.
