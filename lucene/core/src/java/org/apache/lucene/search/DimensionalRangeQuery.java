...
end_import
begin_comment
comment|/** Searches for ranges in fields previously indexed using {@link DimensionalField}.  In  *  a 1D field this is a simple range query; in a multi-dimensional field it's a box shape. */
end_comment
begin_class
...
block|}
block|}
comment|/** Sugar constructor: use in the 1D case when you indexed 1D long values using {@link DimensionalField} */
DECL|method|DimensionalRangeQuery
specifier|public
name|DimensionalRangeQuery
parameter_list|(
...
expr_stmt|;
block|}
comment|/** Sugar constructor: use in the 1D case when you indexed binary values using {@link DimensionalField} */
DECL|method|DimensionalRangeQuery
specifier|public
name|DimensionalRangeQuery
parameter_list|(
