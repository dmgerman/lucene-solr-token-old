...
name|reverseMul
decl_stmt|;
DECL|field|mayNeedScoresTwice
specifier|final
name|boolean
name|mayNeedScoresTwice
decl_stmt|;
DECL|field|scorer
name|Scorer
name|scorer
...
DECL|class|SimpleFieldCollector
specifier|private
specifier|static
class|class
...
name|mayNeedScoresTwice
decl_stmt|;
DECL|method|SimpleFieldCollector
specifier|public
name|SimpleFieldCollector
parameter_list|(
name|Sort
...
name|trackMaxScore
expr_stmt|;
comment|// If one of the sort fields needs scores, and if we also track scores, then
comment|// we might call scorer.score() several times per doc so wrapping the scorer
comment|// to cache scores would help
name|this
operator|.
name|mayNeedScoresTwice
operator|=
