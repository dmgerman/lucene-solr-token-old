...
end_import
begin_comment
comment|/**  * An FST {@link Outputs} implementation where each output  * is a sequence of characters.  *  * @lucene.experimental  */
end_comment
begin_class
DECL|class|CharSequenceOutputs
specifier|public
specifier|final
class|class
...
argument_list|()
decl_stmt|;
DECL|method|CharSequenceOutputs
specifier|private
name|CharSequenceOutputs
parameter_list|()
block|{   }
