...
index|[]
decl_stmt|;
DECL|field|assertingCachedRootArcs
specifier|private
name|Arc
argument_list|<
name|T
argument_list|>
name|assertingCachedRootArcs
index|[]
decl_stmt|;
comment|// only set wit assert
...
block|}
argument_list|)
DECL|method|setAssertingRootArcs
specifier|private
name|boolean
name|setAssertingRootArcs
parameter_list|(
...
condition|)
block|{
comment|//System.out.println("  copy len=" + bytesPerArc[arcIdx]);
assert|assert
name|destPos
operator|>
name|srcPos
