...
return|;
block|}
comment|/** table of number of leading zeros in a byte */
DECL|field|nlzTable
specifier|public
specifier|static
specifier|final
...
block|}
decl_stmt|;
comment|/** Returns the number of leading zero bits.    */
DECL|method|nlz
specifier|public
specifier|static
name|int
...
literal|0
decl_stmt|;
comment|// do the first step as a long
name|int
name|y
init|=
call|(
...
index|]
return|;
comment|/* implementation without table:    if ((y& 0xF0000000) == 0) { n+=4; y<<=4; }    if ((y& 0xC0000000) == 0) { n+=2; y<<=2; }    if ((y& 0x80000000) == 0) { n+=1; y<<=1; }    if ((y& 0x80000000) == 0) { n+=1;}    return n;   */
block|}
