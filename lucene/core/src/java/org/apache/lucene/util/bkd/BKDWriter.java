...
decl_stmt|;
comment|/** How much heap OfflineSorter is allowed to use */
DECL|field|offlineSorterBufferMB
specifier|protected
specifier|final
name|OfflineSorter
operator|.
name|BufferSize
name|offlineSorterBufferMB
decl_stmt|;
comment|/** How much heap OfflineSorter is allowed to use */
DECL|field|offlineSorterMaxTempFiles
specifier|protected
specifier|final
name|int
...
condition|)
block|{
comment|// in that case the bytes for the dimension and for the doc id are contiguous,
comment|// so we don't need a branch
name|cmp
operator|=
operator|new
name|BytesRefComparator
