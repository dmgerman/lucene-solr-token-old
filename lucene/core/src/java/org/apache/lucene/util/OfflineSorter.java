...
expr_stmt|;
block|}
comment|/**    * All-details constructor.  If {@code valueLength} is -1 (the default), the length of each value differs; otherwise,    * all values have the specified length.    */
DECL|method|OfflineSorter
specifier|public
name|OfflineSorter
parameter_list|(
...
name|out
decl_stmt|;
comment|// TODO: this should optimize the fixed width case as well
