...
nl|'\n'
nl|'\n'
DECL|variable|SUPPORTED_BITS_PER_VALUE
...
name|'open'
op|'('
string|'"Packed64SingleBlock.java"'
op|','
string|"'w'"
op|')'
newline|'\n'
...
name|'write'
op|'('
string|'"  public static Packed64SingleBlock create(int valueCount, int bitsPerValue) {\\n"'
op|')'
newline|'\n'
name|'f'
op|'.'
...
name|'write'
op|'('
string|'"        return new Packed64SingleBlock%d(valueCount);\\n"'
op|'%'
name|'bpv'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|'"        throw new IllegalArgumentException(\\"Unsupported number of bits per value: \\" + %d);\\n"'
op|'%'
name|'bpv'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|'"  static class Packed64SingleBlock%d extends Packed64SingleBlock {\\n\\n"'
op|'%'
name|'bpv'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|'"    Packed64SingleBlock%d(int valueCount) {\\n"'
op|'%'
name|'bpv'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|'"    public long get(int index) {\\n"'
op|')'
newline|'\n'
name|'if'
name|'log_2'
...
name|'write'
op|'('
string|'"      return (blocks[o] >>> shift) & %dL;\\n"'
op|'%'
op|'('
op|'('
number|'1'
...
name|'write'
op|'('
string|'"    public void set(int index, long value) {\\n"'
op|')'
newline|'\n'
name|'if'
name|'log_2'
...
name|'write'
op|'('
string|'"      blocks[o] = (blocks[o] & ~(%dL << shift)) | (value << shift);\\n"'
op|'%'
op|'('
op|'('
number|'1'
