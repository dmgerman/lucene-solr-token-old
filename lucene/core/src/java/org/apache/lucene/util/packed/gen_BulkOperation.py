...
name|'write'
op|'('
string|'"        final long byte%d = blocks[blocksOffset++] & 0xFF;\\n"'
op|'%'
name|'i'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|'"        final int byte%d = blocks[blocksOffset++] & 0xFF;\\n"'
op|'%'
name|'i'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|"'final class BulkOperationPacked%d extends BulkOperation {\\n'"
op|'%'
name|'bpv'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|"'  private static final BulkOperationPacked%d packed%d = new BulkOperationPacked%d();\\n'"
op|'%'
op|'('
name|'bpv'
op|','
...
name|'open'
op|'('
string|"'BulkOperationPackedSingleBlock%d.java'"
op|'%'
name|'bpv'
op|','
string|"'w'"
...
name|'write'
op|'('
string|"'final class BulkOperationPackedSingleBlock%d extends BulkOperation {\\n'"
op|'%'
name|'bpv'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|"'  private static final BulkOperationPackedSingleBlock%d packedSingleBlock%d = new BulkOperationPackedSingleBlock%d();\\n'"
op|'%'
op|'('
name|'bpv'
op|','
...
name|'write'
op|'('
string|'"        return packedSingleBlock%d;\\n"'
op|'%'
name|'i'
op|')'
newline|'\n'
