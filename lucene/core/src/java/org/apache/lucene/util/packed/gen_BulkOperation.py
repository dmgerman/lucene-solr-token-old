...
name|'write'
op|'('
string|'"    public BulkOperationPackedSingleBlock%d() {\\n"'
op|'%'
name|'bpv'
op|')'
newline|'\n'
...
name|'write'
op|'('
string|"'final class BulkOperationPackedSingleBlock%d extends BulkOperationPackedSingleBlock {\\n'"
op|'%'
name|'bpv'
op|')'
newline|'\n'
