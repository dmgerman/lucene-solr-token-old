...
argument_list|)
decl_stmt|;
comment|// make a fake /dev/nvme0n1p1 for it
name|Path
name|devdir
init|=
name|dir
...
argument_list|)
expr_stmt|;
comment|// make a fake /sys/block/nvme0n1/queue/rotational file for it
name|Path
name|sysdir
init|=
name|dir
...
expr_stmt|;
block|}
comment|// As test for the longest path match, add some other devices (that have no queue/rotational), too:
name|Files
operator|.
name|createFile
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// fake SSD with a symlink mount (Ubuntu-like):
name|Random
name|rnd
init|=
name|random
...
argument_list|)
decl_stmt|;
comment|// make a fake /dev/sda1 for it
name|Path
name|devdir
init|=
name|dir
...
argument_list|)
expr_stmt|;
comment|// create a symlink to the above device file
name|Path
name|symlinkdir
init|=
name|devdir
...
expr_stmt|;
block|}
comment|// make a fake /sys/block/sda/queue/rotational file for it
name|Path
name|sysdir
init|=
name|dir
...
expr_stmt|;
block|}
DECL|method|testFsyncDirectory
specifier|public
name|void
name|testFsyncDirectory
parameter_list|()
throws|throws
name|Exception
block|{
