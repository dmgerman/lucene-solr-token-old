...
name|MONOTONIC
block|}
DECL|method|testPackedLongValuesOnZeros
specifier|public
name|void
name|testPackedLongValuesOnZeros
parameter_list|()
block|{
comment|// Make sure that when all values are the same, they use 0 bits per value
specifier|final
name|int
name|pageSize
init|=
...
expr_stmt|;
block|}
DECL|method|testPackedLongValues
specifier|public
name|void
name|testPackedLongValues
parameter_list|()
block|{
specifier|final
name|long
