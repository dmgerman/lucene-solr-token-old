...
name|Exception
block|{
comment|// nocommit this fails ... pre-existing issue i think!!
comment|// AutomatonTestUtil.assertNoDetachedStates(new LevenshteinAutomata("abc", false).toAutomaton(1));
block|}
...
argument_list|)
expr_stmt|;
comment|// nocommit LEV creates detached states
comment|//AutomatonTestUtil.assertNoDetachedStates(automata[n]);
comment|//AutomatonTestUtil.assertNoDetachedStates(tautomata[n]);
