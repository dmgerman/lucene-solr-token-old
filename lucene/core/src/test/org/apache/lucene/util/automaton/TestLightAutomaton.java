...
argument_list|)
decl_stmt|;
comment|// Some of the ops we do (stripping random byte, reverse) turn valid UTF8 into invalid if we allow non-ascii:
name|boolean
name|isAscii
init|=
name|random
...
block|}
break|break;
comment|// nocommit sometimes concat a suffix accepting more than 1 term, and sometimes non-det
case|case
literal|2
case|:
comment|// determinize
