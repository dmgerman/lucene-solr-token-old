...
argument_list|)
expr_stmt|;
comment|// make room for more bits
name|bits
operator|.
name|fastSet
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// should not change numBits nor grow the array
name|bits
operator|.
name|fastSet
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// test ensureCapacityWords
name|int
name|numWords
init|=
name|random
...
literal|2
decl_stmt|;
comment|// make sure we grow the array (at least 128 bits)
name|bits
operator|.
