...
begin_function
unit|}   }
DECL|method|testFixedLengthHeap
specifier|public
name|void
name|testFixedLengthHeap
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Make sure the RAM accounting is correct, i.e. if we are sorting fixed width
comment|// ints (4 bytes) then the heap used is really only 4 bytes per value:
name|Directory
name|dir
init|=
name|newDirectory
...
argument_list|)
expr_stmt|;
comment|// 1 MB of ints with 4 MH heap allowed should have been sorted in a single heap partition:
name|assertEquals
argument_list|(
literal|0
argument_list|,
...
end_function
begin_function
DECL|method|testFixedLengthLiesLiesLies
specifier|public
name|void
name|testFixedLengthLiesLiesLies
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Make sure OfflineSorter catches me if I lie about the fixed value length:
name|Directory
name|dir
init|=
name|newDirectory
...
name|assertEquals
argument_list|(
literal|"value length is 4 but is supposed to always be 8"
argument_list|,
name|e
operator|.
name|getMessage
...
end_function
begin_function
DECL|method|testInvalidFixedLength
specifier|public
name|void
name|testInvalidFixedLength
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"valueLength must be 1 .. 32767; got: 0"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"valueLength must be 1 .. 32767; got: 2147483647"
argument_list|,
name|e
operator|.
name|getMessage
