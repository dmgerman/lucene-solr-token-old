...
expr_stmt|;
block|}
comment|/** Tests sorting on type byte */
...
expr_stmt|;
block|}
comment|/** Tests sorting on type byte with a missing value */
DECL|method|testByteMissing
specifier|public
name|void
name|testByteMissing
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// null value is treated as a 0
name|assertEquals
argument_list|(
literal|"-1"
argument_list|,
...
expr_stmt|;
block|}
comment|/** Tests sorting on type byte, specifying the missing value should be treated as Byte.MAX_VALUE */
DECL|method|testByteMissingLast
specifier|public
name|void
name|testByteMissingLast
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// null value is treated Byte.MAX_VALUE
name|assertEquals
argument_list|(
literal|"-1"
argument_list|,
...
expr_stmt|;
block|}
comment|/** Tests sorting on type byte in reverse */
DECL|method|testByteReverse
specifier|public
name|void
name|testByteReverse
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/** Tests sorting on type short */
...
expr_stmt|;
block|}
comment|/** Tests sorting on type short with a missing value */
DECL|method|testShortMissing
specifier|public
name|void
name|testShortMissing
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/** Tests sorting on type short, specifying the missing value should be treated as Short.MAX_VALUE */
DECL|method|testShortMissingLast
specifier|public
name|void
name|testShortMissingLast
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// null is treated as Short.MAX_VALUE
name|assertEquals
argument_list|(
literal|"-1"
argument_list|,
...
expr_stmt|;
block|}
comment|/** Tests sorting on type short in reverse */
DECL|method|testShortReverse
specifier|public
name|void
name|testShortReverse
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**     * test sorts for a custom int parser that uses a simple char encoding     */
DECL|method|testCustomIntParser
specifier|public
name|void
name|testCustomIntParser
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// results should be in alphabetical order
name|assertEquals
argument_list|(
literal|10
argument_list|,
...
expr_stmt|;
block|}
comment|/**     * test sorts for a custom byte parser that uses a simple char encoding     */
DECL|method|testCustomByteParser
specifier|public
name|void
name|testCustomByteParser
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**     * test sorts for a custom short parser that uses a simple char encoding     */
DECL|method|testCustomShortParser
specifier|public
name|void
name|testCustomShortParser
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**     * test sorts for a custom long parser that uses a simple char encoding     */
DECL|method|testCustomLongParser
specifier|public
name|void
name|testCustomLongParser
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**     * test sorts for a custom float parser that uses a simple char encoding     */
DECL|method|testCustomFloatParser
specifier|public
name|void
name|testCustomFloatParser
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**     * test sorts for a custom double parser that uses a simple char encoding     */
DECL|method|testCustomDoubleParser
specifier|public
name|void
name|testCustomDoubleParser
parameter_list|()
throws|throws
name|Exception
block|{
