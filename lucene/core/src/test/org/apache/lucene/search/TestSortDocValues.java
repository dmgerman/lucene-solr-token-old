...
end_import
begin_comment
comment|/** Tests basic sorting on docvalues fields.  * These are mostly like TestSort's tests, except each test  * indexes the field up-front as docvalues, and checks no fieldcaches were made */
end_comment
begin_class
DECL|class|TestSortDocValues
specifier|public
class|class
name|TestSortDocValues
extends|extends
name|LuceneTestCase
block|{
annotation|@
