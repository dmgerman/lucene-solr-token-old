...
argument_list|()
decl_stmt|;
comment|// NOTE: copied from CompressingCodec.randomInstance(), but fixed to not
comment|// use any memory index ... maybe we can instead add
comment|// something like CompressingMemory to the
comment|// SuppressCodecs list...?:
specifier|final
name|CompressionMode
name|mode
init|=
