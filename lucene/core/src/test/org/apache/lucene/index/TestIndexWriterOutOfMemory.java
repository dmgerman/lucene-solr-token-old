...
end_import
begin_comment
comment|/**   * Causes a bunch of fake OOM and checks that no other exceptions are delivered instead,  * no index corruption is ever created.  */
end_comment
begin_class
DECL|class|TestIndexWriterOutOfMemory
specifier|public
class|class
name|TestIndexWriterOutOfMemory
extends|extends
name|LuceneTestCase
block|{
...
literal|true
expr_stmt|;
comment|// don't make life difficult though
if|if
condition|(
name|stack
index|[
