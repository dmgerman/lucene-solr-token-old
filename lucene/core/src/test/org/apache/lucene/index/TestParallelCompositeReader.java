...
expr_stmt|;
block|}
DECL|method|testReaderClosedListener
specifier|private
name|void
name|testReaderClosedListener
parameter_list|(
name|boolean
name|closeSubReaders
parameter_list|,
name|int
name|wrapMultiReaderType
parameter_list|)
throws|throws
name|IOException
block|{
...
literal|1
case|:
comment|// default case, does close subreaders:
name|ir2
operator|=
operator|new
name|MultiReader
...
argument_list|)
expr_stmt|;
comment|// We have to close the extra MultiReader, because it will not close its own subreaders:
if|if
condition|(
name|wrapMultiReaderType
operator|==
...
expr_stmt|;
block|}
DECL|method|testReaderClosedListener3
specifier|public
name|void
name|testReaderClosedListener3
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testReaderClosedListener4
specifier|public
name|void
name|testReaderClosedListener4
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testReaderClosedListener5
specifier|public
name|void
name|testReaderClosedListener5
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"toString incorrect (should be flattened): "
operator|+
name|s
argument_list|,
name|s
