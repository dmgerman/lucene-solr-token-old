...
DECL|method|testNoLostDeletesOnIOException
specifier|public
name|void
name|testNoLostDeletesOnIOException
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// TODO: also call w.close() in here, sometimes,
comment|// so we sometimes get a fail via dropAll
block|}
catch|catch
parameter_list|(
name|FakeIOException
