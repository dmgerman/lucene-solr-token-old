...
block|}
argument_list|)
DECL|class|TestBinaryDocValuesUpdates
specifier|public
class|class
...
name|value
expr_stmt|;
comment|//    System.err.println("[" + Thread.currentThread().getName() + "] value=" + orig + ", bytes=" + bytes);
return|return
name|bytes
return|;
block|}
...
argument_list|()
expr_stmt|;
comment|// update all docs' bdv field
name|writer
operator|.
name|updateBinaryDocValue
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testMultipleBinaryDocValues
specifier|public
name|void
name|testMultipleBinaryDocValues
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// update all docs' bdv1 field
name|writer
operator|.
name|updateBinaryDocValue
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// unset the value of 'doc0'
name|writer
operator|.
name|updateBinaryDocValue
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testUnsetAllValues
specifier|public
name|void
name|testUnsetAllValues
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// unset the value of 'doc'
name|writer
operator|.
name|updateBinaryDocValue
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testUpdateNonBinaryDocValuesField
specifier|public
name|void
name|testUpdateNonBinaryDocValuesField
parameter_list|()
throws|throws
name|Exception
block|{
comment|// we don't support adding new fields or updating existing non-binary-dv
comment|// fields through binary updates
name|Directory
name|dir
init|=
name|newDirectory
...
name|fail
argument_list|(
literal|"should not have allowed updating an existing field to binary-dv"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|)
decl_stmt|;
comment|// first segment with BDV
name|Document
name|doc
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// document without 'bdv' field
name|writer
operator|.
name|addDocument
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// second segment with no BDV
name|doc
operator|=
operator|new
name|Document
...
comment|// the document without BDV field
name|writer
operator|.
name|updateBinaryDocValue
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testUpdateBinaryDVFieldWithSameNameAsPostingField
specifier|public
name|void
name|testUpdateBinaryDVFieldWithSameNameAsPostingField
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testUpdateOldSegments
specifier|public
name|void
name|testUpdateOldSegments
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// create first gen of update files
name|writer
operator|.
name|updateBinaryDocValue
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// create second gen of update files, first gen should be deleted
name|writer
operator|.
name|updateBinaryDocValue
argument_list|(
