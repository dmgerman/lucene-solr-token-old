...
expr_stmt|;
block|}
comment|// LUCENE-6835: make sure best-effort to not create an "apparently but not really" corrupt index is working:
DECL|method|testExcInDeleteFile
specifier|public
name|void
name|testExcInDeleteFile
parameter_list|()
throws|throws
name|Throwable
block|{
...
name|println
argument_list|(
literal|"TEST: got expected exception:"
argument_list|)
expr_stmt|;
name|re
operator|.
