...
expr_stmt|;
block|}
DECL|method|testInvalidMaxMergeCountAndThreads
specifier|public
name|void
name|testInvalidMaxMergeCountAndThreads
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
comment|// LUCENE-6094
DECL|method|testHangDuringRollback
specifier|public
name|void
name|testHangDuringRollback
parameter_list|()
throws|throws
name|Throwable
block|{
...
expr_stmt|;
comment|// flush + merge
comment|// Wait for merge to kick off
name|mergeStart
operator|.
name|await
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// W/o the fix for LUCENE-6094 we would hang forever here:
name|w
operator|.
name|addDocument
argument_list|(
...
expr_stmt|;
comment|// flush + merge
comment|// Now allow first merge to finish:
name|mergeFinish
operator|.
name|countDown
argument_list|()
...
expr_stmt|;
block|}
DECL|method|testDynamicDefaults
specifier|public
name|void
name|testDynamicDefaults
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
comment|// flush + merge
comment|// CMS should have now set true values:
name|assertTrue
argument_list|(
name|cms
operator|.
...
expr_stmt|;
block|}
DECL|method|testResetToAutoDefault
specifier|public
name|void
name|testResetToAutoDefault
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSpinningDefaults
specifier|public
name|void
name|testSpinningDefaults
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testAutoIOThrottleGetter
specifier|public
name|void
name|testAutoIOThrottleGetter
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testNonSpinningDefaults
specifier|public
name|void
name|testNonSpinningDefaults
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
comment|// LUCENE-6197
DECL|method|testNoStallMergeThreads
specifier|public
name|void
name|testNoStallMergeThreads
parameter_list|()
throws|throws
name|Exception
block|{
