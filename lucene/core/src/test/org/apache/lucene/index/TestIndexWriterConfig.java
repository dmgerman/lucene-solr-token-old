...
argument_list|()
expr_stmt|;
comment|// Sharing IWC should be fine:
name|riw
operator|=
operator|new
name|RandomIndexWriter
...
argument_list|)
decl_stmt|;
comment|// Cannot clone IW's private IWC clone:
try|try
block|{
name|riw
operator|.
...
expr_stmt|;
block|}
DECL|method|testIWCInvalidReuse
specifier|public
name|void
name|testIWCInvalidReuse
parameter_list|()
throws|throws
name|Exception
block|{
