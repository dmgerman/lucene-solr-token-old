...
argument_list|()
decl_stmt|;
comment|// test that if the same IWC is reused across two IWs, it is cloned by each.
name|IndexWriterConfig
name|conf
init|=
...
argument_list|()
expr_stmt|;
comment|// LiveIndexWriterConfig's "copy" constructor doesn't clone objects.
name|assertNotSame
argument_list|(
literal|"IndexWriterConfig should have been cloned"
argument_list|,
name|liveConf1
operator|.
name|getMergePolicy
...
argument_list|()
decl_stmt|;
comment|// Make sure parameters that can't be reused are cloned
