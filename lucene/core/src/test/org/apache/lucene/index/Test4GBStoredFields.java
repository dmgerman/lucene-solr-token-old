...
argument_list|)
expr_stmt|;
comment|// TODO: we disable "Compressing" since it likes to pick very extreme values which will be too slow for this test.
comment|// maybe we should factor out crazy cases to ExtremeCompressing? then annotations can handle this stuff...
if|if
condition|(
name|random
argument_list|()
