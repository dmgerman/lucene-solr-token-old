...
argument_list|()
expr_stmt|;
comment|// create _0_2.fnm, and _0_1.fnm should be deleted
name|writer
operator|.
name|updateNumericDocValue
argument_list|(
...
name|assertFalse
argument_list|(
literal|"old generation field infos file should not exist in the directory: _0_1.fnm"
argument_list|,
name|dir
operator|.
name|fileExists
