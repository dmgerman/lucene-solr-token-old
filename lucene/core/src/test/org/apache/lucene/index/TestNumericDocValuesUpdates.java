...
return|;
block|}
DECL|method|testMultipleUpdatesSameDoc
specifier|public
name|void
name|testMultipleUpdatesSameDoc
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// small number of docs, so use a tiny maxBufferedDocs
name|IndexWriter
name|writer
init|=
operator|new
...
expr_stmt|;
block|}
DECL|method|testBiasedMixOfRandomUpdates
specifier|public
name|void
name|testBiasedMixOfRandomUpdates
parameter_list|()
throws|throws
name|Exception
block|{
comment|// 3 types of operations: add, updated, updateDV.
comment|// rather then randomizing equally, we'll pick (random) cutoffs so each test run is biased,
comment|// in terms of some ops happen more often then others
specifier|final
name|int
name|ADD_CUTOFF
init|=
...
argument_list|)
decl_stmt|;
comment|// start with at least one doc before any chance of updates
specifier|final
name|int
name|numSeedDocs
init|=
...
decl_stmt|;
name|int
name|numValueUpdates
init|=
literal|0
decl_stmt|;
comment|//System.out.println("TEST: numOperations=" + numOperations + " ADD_CUTOFF=" + ADD_CUTOFF + " UPD_CUTOFF=" + UPD_CUTOFF);
for|for
control|(
name|int
name|i
...
argument_list|()
decl_stmt|;
comment|//System.out.println("TEST i=" + i + ": addDocument id=" + id + " val=" + val);
name|expected
operator|.
name|put
argument_list|(
...
operator|++
expr_stmt|;
comment|//System.out.println("TEST i=" + i + ": updateDocument id=" + id + " val=" + val);
name|writer
operator|.
name|updateDocument
argument_list|(
...
operator|++
expr_stmt|;
comment|//System.out.println("TEST i=" + i + ": updateDV id=" + id + " val=" + val);
name|writer
operator|.
name|updateNumericDocValue
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// TODO: make more efficient if max numOperations is going to be increased much
for|for
control|(
name|Map
operator|.
...
annotation|@
name|Test
DECL|method|testUpdateSegmentWithNoDocValues2
specifier|public
name|void
name|testUpdateSegmentWithNoDocValues2
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// second segment with no NDV, but another dv field "foo"
name|doc
operator|=
operator|new
name|Document
