...
annotation|@
name|Test
DECL|method|testUpdateNonDocValueField
specifier|public
name|void
name|testUpdateNonDocValueField
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
comment|// update key
comment|// add all fields with their current (updated value)
for|for
control|(
name|int
name|f
...
name|fail
argument_list|(
literal|"should not have succeeded updating a segment with no numeric DocValues field"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
argument_list|()
expr_stmt|;
comment|// update documentin the second segment
name|writer
operator|.
name|updateNumericDocValue
argument_list|(
...
condition|)
block|{
comment|// obtain NRT reader (apply updates)
name|DirectoryReader
operator|.
name|open
argument_list|(
