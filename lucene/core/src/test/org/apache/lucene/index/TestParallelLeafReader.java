...
end_function
begin_comment
comment|// not ok to have one leaf w/ index sort and another with a different index sort
end_comment
begin_function
DECL|method|testWithIndexSort1
specifier|public
name|void
name|testWithIndexSort1
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"cannot combine LeafReaders that have different index sorts: saw both sort=<int: \"foo\"> and<int: \"bar\">"
argument_list|,
name|message
argument_list|)
expr_stmt|;
...
end_function
begin_comment
comment|// ok to have one leaf w/ index sort and the other with no sort
end_comment
begin_function
DECL|method|testWithIndexSort2
specifier|public
name|void
name|testWithIndexSort2
parameter_list|()
throws|throws
name|Exception
block|{
