...
name|facetArrays
decl_stmt|;
comment|/** Constructor with the given facet search params. */
...
argument_list|(
literal|"this accumulator only supports CountFacetRequest; got "
operator|+
name|fr
argument_list|)
throw|;
...
name|IllegalArgumentException
argument_list|(
literal|"this accumulator only supports 1-level CategoryPath; got "
operator|+
name|fr
operator|.
name|categoryPath
...
name|IllegalArgumentException
argument_list|(
literal|"this accumulator only supports depth=1; got "
operator|+
name|fr
operator|.
name|getDepth
...
block|}
block|}
DECL|class|SortedSetAggregator
specifier|static
class|class
name|SortedSetAggregator
block|{
DECL|field|state
specifier|private
specifier|final
...
name|dv
decl_stmt|;
DECL|method|SortedSetAggregator
specifier|public
name|SortedSetAggregator
parameter_list|(
name|String
