...
expr_stmt|;
block|}
comment|/**    * Creates a new {@link DrillDownQuery} without a base query, which means that    * you intend to perfor a pure browsing query (equivalent to using    * {@link MatchAllDocsQuery} as base.    */
DECL|method|DrillDownQuery
specifier|public
name|DrillDownQuery
parameter_list|(
