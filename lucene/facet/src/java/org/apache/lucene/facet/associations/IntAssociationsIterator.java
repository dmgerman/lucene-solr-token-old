...
argument_list|()
decl_stmt|;
comment|/**    * Constructs a new {@link IntAssociationsIterator} which uses an    * in-memory {@link DocValues#getSource() DocValues source}.    */
...
expr_stmt|;
block|}
comment|/**    * Constructs a new {@link IntAssociationsIterator} which uses a    * {@link DocValues} {@link Source} per {@code useDirectSource}.    */
DECL|method|IntAssociationsIterator
specifier|public
name|IntAssociationsIterator
parameter_list|(
