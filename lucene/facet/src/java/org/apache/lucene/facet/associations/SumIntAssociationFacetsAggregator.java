...
end_comment
begin_comment
comment|/**  * A {@link FacetsAggregator} which computes the weight of a category as the sum  * of the integer values associated with it in the result documents. Assumes  * that the association encoded for each ordinal is  * {@link CategoryIntAssociation}.  *<p>  *<b>NOTE:</b> this aggregator does not support  * {@link #rollupValues(FacetRequest, int, int[], int[], FacetArrays)}. It only  * aggregates the categories for which you added a {@link CategoryAssociation}.  */
end_comment
begin_class
