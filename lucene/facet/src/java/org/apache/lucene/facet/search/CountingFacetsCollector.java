...
block|}
block|}
comment|/**    * Computes the counts of ordinals under the given ordinal's tree, by    * recursively going down to leaf nodes and rollin up their counts (called    * only with categories are indexing with OrdinalPolicy.NO_PARENTS).    */
