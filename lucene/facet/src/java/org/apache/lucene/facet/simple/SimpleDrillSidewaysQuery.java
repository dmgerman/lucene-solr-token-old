...
end_import
begin_comment
comment|/** Only purpose is to punch through and return a  *  SimpleDrillSidewaysScorer */
end_comment
begin_class
DECL|class|SimpleDrillSidewaysQuery
class|class
name|SimpleDrillSidewaysQuery
extends|extends
name|Query
block|{
...
name|drillDownTerms
decl_stmt|;
DECL|method|SimpleDrillSidewaysQuery
name|SimpleDrillSidewaysQuery
parameter_list|(
name|Query
name|baseQuery
...
name|IOException
block|{
name|SimpleDrillSidewaysScorer
operator|.
