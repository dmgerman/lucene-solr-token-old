...
name|Exception
block|{
comment|// test the collector's handling of residue
name|DirectoryReader
name|indexReader
init|=
name|DirectoryReader
...
argument_list|)
decl_stmt|;
comment|// asking for top 1 is the only way to guarantee there will be a residue
comment|// provided that enough children were indexed (see below)
name|FacetSearchParams
name|fsp
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// make sure randomness didn't pick only one child of root (otherwise there's no residue)
name|int
name|numChildrenIndexed
init|=
name|res
operator|.
