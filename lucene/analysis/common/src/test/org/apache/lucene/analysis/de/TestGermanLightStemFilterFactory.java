...
end_import
begin_comment
comment|/**  * Simple tests to ensure the German light stem factory is working.  */
end_comment
begin_class
DECL|class|TestGermanLightStemFilterFactory
specifier|public
class|class
name|TestGermanLightStemFilterFactory
extends|extends
name|BaseTokenStreamFactoryTestCase
block|{
