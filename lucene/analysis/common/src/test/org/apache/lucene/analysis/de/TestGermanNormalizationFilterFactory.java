...
end_import
begin_comment
comment|/**  * Simple tests to ensure the German normalization factory is working.  */
end_comment
begin_class
DECL|class|TestGermanNormalizationFilterFactory
specifier|public
class|class
name|TestGermanNormalizationFilterFactory
extends|extends
name|BaseTokenStreamFactoryTestCase
block|{
