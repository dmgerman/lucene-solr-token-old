...
end_import
begin_comment
comment|/**  * Simple tests to ensure the Russian light stem factory is working.  */
end_comment
begin_class
DECL|class|TestRussianLightStemFilterFactory
specifier|public
class|class
name|TestRussianLightStemFilterFactory
extends|extends
name|BaseTokenStreamFactoryTestCase
block|{
