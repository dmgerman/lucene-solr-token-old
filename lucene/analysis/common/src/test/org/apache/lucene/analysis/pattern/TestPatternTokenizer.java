...
block|}
comment|// LUCENE-6814
DECL|method|testHeapFreedAfterClose
specifier|public
name|void
name|testHeapFreedAfterClose
parameter_list|()
throws|throws
name|Exception
block|{
comment|// TODO: can we move this to BaseTSTC to catch other "hangs onto heap"ers?
comment|// Build a 1MB string:
name|StringBuilder
name|b
init|=
operator|new
