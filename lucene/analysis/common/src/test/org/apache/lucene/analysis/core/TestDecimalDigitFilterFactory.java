...
end_import
begin_comment
comment|/**  * Simple tests to ensure the digit normalization factory is working.  */
end_comment
begin_class
DECL|class|TestDecimalDigitFilterFactory
specifier|public
class|class
name|TestDecimalDigitFilterFactory
extends|extends
name|BaseTokenStreamFactoryTestCase
block|{
comment|/**    * Ensure the filter actually normalizes digits.    */
