...
end_import
begin_comment
comment|/**  * Simple tests to ensure the Serbian normalization factory is working.  */
end_comment
begin_class
DECL|class|TestSerbianNormalizationFilterFactory
specifier|public
class|class
name|TestSerbianNormalizationFilterFactory
extends|extends
name|BaseTokenStreamFactoryTestCase
block|{
...
expr_stmt|;
block|}
DECL|method|testRegularStemming
specifier|public
name|void
name|testRegularStemming
parameter_list|()
throws|throws
name|Exception
block|{
