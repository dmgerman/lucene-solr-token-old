...
end_import
begin_comment
comment|/**  * Simple tests to ensure the apostrophe filter factory is working.  */
end_comment
begin_class
DECL|class|TestApostropheFilterFactory
specifier|public
class|class
name|TestApostropheFilterFactory
extends|extends
name|BaseTokenStreamFactoryTestCase
block|{
comment|/**    * Ensure the filter actually removes characters after an apostrophe.    */
