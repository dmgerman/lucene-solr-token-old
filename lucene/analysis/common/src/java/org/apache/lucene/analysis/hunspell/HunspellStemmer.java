...
argument_list|)
decl_stmt|;
comment|/**    * Constructs a new HunspellStemmer which will use the provided HunspellDictionary to create its stems. Uses the     * default recursion cap of<code>2</code> (based on Hunspell documentation).     *    * @param dictionary HunspellDictionary that will be used to create the stems    */
...
expr_stmt|;
block|}
comment|/**    * Constructs a new HunspellStemmer which will use the provided HunspellDictionary to create its stems    *    * @param dictionary HunspellDictionary that will be used to create the stems    * @param recursionCap maximum level of recursion stemmer can go into    */
DECL|method|HunspellStemmer
specifier|public
name|HunspellStemmer
parameter_list|(
