...
end_import
begin_comment
comment|/**  * Base class for decomposition token filters using pre-4.4 behavior.  *<p>  * @deprecated Use {@link CompoundWordTokenFilterBase}  */
end_comment
begin_class
annotation|@
name|Deprecated
DECL|class|Lucene43CompoundWordTokenFilterBase
specifier|public
specifier|abstract
class|class
...
name|current
decl_stmt|;
DECL|method|Lucene43CompoundWordTokenFilterBase
specifier|protected
name|Lucene43CompoundWordTokenFilterBase
parameter_list|(
name|TokenStream
...
name|endOffset
decl_stmt|;
comment|/** Construct the compound token based on a slice of the current {@link Lucene43CompoundWordTokenFilterBase#termAtt}. */
