...
expr_stmt|;
block|}
comment|/**    * Creates a new {@link CharTokenizer} instance    *     * @param matchVersion    *          Lucene version to match    * @param source    *          the attribute source to use for this {@link Tokenizer}    * @param input    *          the input to split up into tokens    */
DECL|method|CharTokenizer
specifier|public
name|CharTokenizer
parameter_list|(
