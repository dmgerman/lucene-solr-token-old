...
end_comment
begin_class
DECL|class|Hunspell2StemFilter
specifier|public
specifier|final
class|class
...
name|dedup
decl_stmt|;
comment|/** Create a {@link Hunspell2StemFilter} which deduplicates stems and has a maximum    *  recursion level of 2.     *  @see #Hunspell2StemFilter(TokenStream, Dictionary, int) */
DECL|method|Hunspell2StemFilter
specifier|public
name|Hunspell2StemFilter
parameter_list|(
name|TokenStream
...
expr_stmt|;
block|}
comment|/** Create a {@link Hunspell2StemFilter} which has a maximum recursion level of 2.     *  @see #Hunspell2StemFilter(TokenStream, Dictionary, boolean, int) */
DECL|method|Hunspell2StemFilter
specifier|public
name|Hunspell2StemFilter
parameter_list|(
