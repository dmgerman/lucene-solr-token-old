...
expr_stmt|;
block|}
comment|// test using a sparse index (with deleted docs). The DocIdSet should be not cacheable, as it uses TermDocs if the range contains 0
...
name|assertFalse
argument_list|(
literal|"DocIdSet must be not cacheable"
argument_list|,
name|fcrf
operator|.
name|getDocIdSet
...
name|assertTrue
argument_list|(
literal|"DocIdSet must be cacheable"
argument_list|,
name|fcrf
operator|.
name|getDocIdSet
