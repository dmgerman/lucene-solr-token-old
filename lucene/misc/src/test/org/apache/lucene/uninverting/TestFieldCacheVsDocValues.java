...
comment|// nocommit hmmm what to do
comment|/*     int numDeletions = random().nextInt(numDocs/10);     for (int i = 0; i< numDeletions; i++) {       int id = random().nextInt(numDocs);       writer.deleteDocuments(new Term("id", Integer.toString(id)));     }     */
name|writer
operator|.
name|shutdown
argument_list|()
