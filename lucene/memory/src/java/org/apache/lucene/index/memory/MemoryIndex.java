...
expr_stmt|;
block|}
comment|/**    * Adds a lucene {@link IndexableField} to the MemoryIndex using the provided analyzer    * @param field the field to add    * @param analyzer the analyzer to use for term analysis    * @throws IllegalArgumentException if the field is a DocValues or Point field, as these    *                                  structures are not supported by MemoryIndex    */
DECL|method|addField
specifier|public
name|void
name|addField
...
expr_stmt|;
block|}
comment|/**    * Adds a lucene {@link IndexableField} to the MemoryIndex using the provided analyzer    * @param field the field to add    * @param analyzer the analyzer to use for term analysis    * @param boost a field boost    * @throws IllegalArgumentException if the field is a DocValues or Point field, as these    *                                  structures are not supported by MemoryIndex    */
DECL|method|addField
specifier|public
name|void
name|addField
...
name|IllegalArgumentException
argument_list|(
literal|"MemoryIndex does not support DocValues fields"
argument_list|)
throw|;
if|if
condition|(
...
name|IllegalArgumentException
argument_list|(
literal|"MemoryIndex does not support Points"
argument_list|)
throw|;
if|if
condition|(
