...
expr_stmt|;
block|}
DECL|method|testNonExistentField
specifier|public
name|void
name|testNonExistentField
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testDocValuesMemoryIndexVsNormalIndex
specifier|public
name|void
name|testDocValuesMemoryIndexVsNormalIndex
parameter_list|()
throws|throws
name|Exception
block|{
...
condition|)
block|{
comment|// randomly duplicate field/value
name|doc
operator|.
name|add
argument_list|(
...
condition|)
block|{
comment|// randomily just add a normal string field
name|doc
operator|.
name|add
argument_list|(
...
expr_stmt|;
name|SortedNumericDocValues
name|controlSortedNumericDocValues
init|=
name|controlLeafReader
operator|.
name|getSortedNumericDocValues
...
expr_stmt|;
name|SortedSetDocValues
name|controlSortedSetDocValues
init|=
name|controlLeafReader
operator|.
name|getSortedSetDocValues
...
expr_stmt|;
block|}
DECL|method|testNormsWithDocValues
specifier|public
name|void
name|testNormsWithDocValues
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testPointValuesMemoryIndexVsNormalIndex
specifier|public
name|void
name|testPointValuesMemoryIndexVsNormalIndex
parameter_list|()
throws|throws
name|Exception
block|{
