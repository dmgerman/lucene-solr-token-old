...
block|}
block|}
comment|/** hack to load this test a second time in a different classLoader */
DECL|class|Loader
specifier|static
class|class
name|Loader
...
expr_stmt|;
block|}
DECL|method|loadFromParentResource
specifier|public
name|Class
argument_list|<
name|?
argument_list|>
name|loadFromParentResource
parameter_list|(
name|String
name|className
parameter_list|)
