...
expr_stmt|;
block|}
DECL|method|testStaticExtendedVariableExample
specifier|public
name|void
name|testStaticExtendedVariableExample
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testDynamicExtendedVariableExample
specifier|public
name|void
name|testDynamicExtendedVariableExample
parameter_list|()
throws|throws
name|Exception
block|{
...
name|compile
argument_list|(
literal|"doc['popularity'].value + magicarray[0] + fourtytwo"
argument_list|)
decl_stmt|;
comment|// The following is an example of how to write bindings which parse the variable name into pieces.
comment|// Note, however, that this requires a lot of error checking.  Each "error case" below should be
comment|// filled in with proper error messages for a real use case.
name|Bindings
name|bindings
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// error case, non/missing "value" member access
block|}
block|}
else|else
block|{
...
argument_list|()
expr_stmt|;
comment|// error case, doc should be a str indexed array
block|}
block|}
elseif|else
if|if
...
argument_list|()
expr_stmt|;
comment|// error case, magic array isn't an array
block|}
block|}
elseif|else
if|if
...
argument_list|()
expr_stmt|;
comment|// error case (variable doesn't exist)
block|}
throw|throw
operator|new
name|IllegalArgumentException
argument_list|(
literal|"Illegal reference '"
operator|+
name|name
operator|+
literal|"'"
