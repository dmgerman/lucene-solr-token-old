...
annotation|@
name|Test
DECL|method|testWithOptionalPayload
specifier|public
name|void
name|testWithOptionalPayload
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// Create a document that is missing the payload field
name|Document
name|doc
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// do not store the payload or the contexts
name|Field
name|weight
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// Even though the payload field is missing, the dictionary iterator should not skip the document
comment|// because the payload field is optional.
name|Dictionary
name|dictionaryOptionalPayload
init|=
operator|new
name|DocumentDictionary
argument_list|(
