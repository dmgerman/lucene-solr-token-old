...
name|contexts
decl_stmt|;
DECL|field|matchAllContexts
specifier|private
name|boolean
name|matchAllContexts
init|=
literal|false
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**    * Add all contexts with a boost of 1f    */
DECL|method|addAllContexts
specifier|public
name|void
name|addAllContexts
parameter_list|()
...
return|;
block|}
DECL|method|toContextAutomaton
specifier|private
specifier|static
name|Automaton
name|toContextAutomaton
...
block|}
block|}
comment|/**    * Holder for context value meta data    */
...
name|ContextMetaData
block|{
comment|/**      * Boost associated with a      * context value      */
DECL|field|boost
specifier|private
specifier|final
name|float
name|boost
decl_stmt|;
comment|/**      * flag to indicate whether the context      * value should be treated as an exact      * value or a context prefix      */
DECL|field|exact
specifier|private
specifier|final
name|boolean
