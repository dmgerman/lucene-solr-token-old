...
block|}
block|}
comment|/**    * Indexes the data from the given {@link Dictionary}.    * @param dict the dictionary to index    * @param mergeFactor mergeFactor to use when indexing    * @param ramMB the max amount or memory in MB to use    * @throws IOException    */
DECL|method|indexDictionary
specifier|public
specifier|final
name|void
