...
argument_list|)
decl_stmt|;
comment|//System.err.println("boxCorners: ur " + ur.getLat() + ',' + ur.getLng());
comment|//System.err.println("boxCorners: cnt " + center.getLat() + ',' + center.getLng());
comment|//System.err.println("boxCorners: ll " + ll.getLat() + ',' + ll.getLng());
return|return
operator|new
name|LLRect
argument_list|(
