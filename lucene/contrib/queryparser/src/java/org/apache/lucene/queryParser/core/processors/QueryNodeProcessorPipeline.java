...
return|;
block|}
comment|/**    * Adds a processor to the pipeline, it's always added to the end of the    * pipeline.    *     * @deprecated this class now conforms to {@link List} interface, so use    *             {@link #add(QueryNodeProcessor)} instead    *     * @param processor the processor to be added    */
annotation|@
name|Deprecated
