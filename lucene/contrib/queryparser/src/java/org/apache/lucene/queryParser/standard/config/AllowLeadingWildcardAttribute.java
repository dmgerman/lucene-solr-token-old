...
end_import
begin_comment
comment|/**  * This attribute is used by {@link AllowLeadingWildcardProcessor} processor and  * must be defined in the {@link QueryConfigHandler}. It basically tells the  * processor if it should allow leading wildcard.<br/>  *   */
end_comment
begin_interface
DECL|interface|AllowLeadingWildcardAttribute
specifier|public
interface|interface
