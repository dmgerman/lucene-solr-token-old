...
literal|false
assert|;
comment|// TODO: this comment is wrong!  we have fixed the quantization error (we now pre-quantize all randomly generated test points) yet the test
comment|// still fails if we remove this evil "return null":
