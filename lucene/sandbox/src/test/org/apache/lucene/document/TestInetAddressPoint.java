...
name|assertEquals
argument_list|(
literal|"Overflow: there is no greater InetAddress than ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"Underflow: there is no smaller InetAddress than 0:0:0:0:0:0:0:0"
argument_list|,
name|e
operator|.
name|getMessage
