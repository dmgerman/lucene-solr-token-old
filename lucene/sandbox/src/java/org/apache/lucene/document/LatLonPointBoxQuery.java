...
end_import
begin_comment
comment|/**   * Fast version of {@link PointRangeQuery}. It is fast for actual range queries!  * @lucene.experimental  */
end_comment
begin_class
DECL|class|LatLonPointBoxQuery
specifier|abstract
class|class
...
DECL|method|LatLonPointBoxQuery
specifier|protected
name|LatLonPointBoxQuery
parameter_list|(
name|String
