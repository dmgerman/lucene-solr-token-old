...
end_import
begin_comment
comment|/** Finds all previously indexed points that fall within the specified boundings box.  *  *<p>The field must be indexed with using {@link DimensionalLatLonField} added per document.  *  *  @lucene.experimental */
end_comment
begin_class
DECL|class|DimensionalPointInRectQuery
specifier|public
class|class
...
DECL|method|DimensionalPointInRectQuery
specifier|public
name|DimensionalPointInRectQuery
parameter_list|(
name|String
