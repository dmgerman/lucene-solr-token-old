...
return|;
block|}
comment|/**      * The two-phase query approach. The parent      * {@link org.apache.lucene.search.GeoPointTermsEnum#accept} method is called to match      * encoded terms that fall within the bounding box of the polygon. Those documents that pass the initial      * bounding box filter are then compared to the provided distance using the      * {@link org.apache.lucene.util.SloppyMath#haversin} method.      *      * @param term term for candidate document      * @return match status      */
annotation|@
name|Override
...
argument_list|)
decl_stmt|;
comment|// post-filter by distance
if|if
condition|(
name|SloppyMath
operator|.
