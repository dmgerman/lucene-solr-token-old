...
expr_stmt|;
block|}
comment|/**    * Sets field configuration for legacy numeric fields    * @deprecated Index with points instead and use {@link #setPointsConfigMap(Map)}    */
annotation|@
name|Deprecated
DECL|method|setLegacyNumericConfigMap
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**    * Gets field configuration for legacy numeric fields    * @deprecated Index with points instead and use {@link #getPointsConfigMap()}    */
annotation|@
name|Deprecated
DECL|method|getLegacyNumericConfigMap
specifier|public
name|Map
argument_list|<
name|String
...
name|LegacyNumericConfig
argument_list|>
name|getLegacyNumericConfigMap
parameter_list|()
block|{
return|return
name|getQueryConfigHandler
...
return|;
block|}
DECL|method|setPointsConfigMap
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|getPointsConfigMap
specifier|public
name|Map
argument_list|<
name|String
