...
end_import
begin_comment
comment|/**  * This query node represents a field query that holds a point value. It is  * similar to {@link FieldQueryNode}, however the {@link #getValue()} returns a  * {@link Number}.  *   * @see PointsConfig  */
end_comment
begin_class
DECL|class|PointQueryNode
specifier|public
class|class
name|PointQueryNode
extends|extends
...
name|value
decl_stmt|;
comment|/**    * Creates a {@link PointQueryNode} object using the given field,    * {@link Number} value and {@link NumberFormat} used to convert the value to    * {@link String}.    *     * @param field the field associated with this query node    * @param value the value hold by this node    * @param numberFormat the {@link NumberFormat} used to convert the value to {@link String}    */
DECL|method|PointQueryNode
specifier|public
name|PointQueryNode
parameter_list|(
name|CharSequence
