...
name|assertEquals
argument_list|(
literal|"Hello<B>this</B> is a piece of text that is<B>very</B><B>long</B> and contains too much preamble and the meat is really here which says kennedy has been shot"
argument_list|,
name|fragment
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"<B>This</B> piece of text refers to Kennedy at the beginning then has a longer piece of text that is<B>very</B>"
argument_list|,
name|fragment
argument_list|)
expr_stmt|;
