...
name|tree
decl_stmt|;
DECL|method|DateRangePrefixTreeTest
specifier|public
name|DateRangePrefixTreeTest
parameter_list|(
name|String
...
expr_stmt|;
block|}
DECL|method|testToStringISO8601
specifier|public
name|void
name|testToStringISO8601
parameter_list|()
block|{
name|Calendar
name|cal
...
argument_list|)
expr_stmt|;
comment|//  create ZonedDateTime from the calendar, then get toInstant.toString which is the ISO8601 we emulate
comment|//   note: we don't simply init off of millisEpoch because of possible GregorianChangeDate discrepancy.
name|int
name|year
init|=
name|cal
...
argument_list|)
expr_stmt|;
comment|//ensure toString doesn't modify cal state
block|}
