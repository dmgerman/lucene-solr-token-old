...
expr_stmt|;
block|}
comment|// randomly test legacy (numeric) and point based bbox strategy
if|if
condition|(
name|random
argument_list|()
...
return|;
block|}
DECL|method|setupNeedsDocValuesOnly
specifier|private
name|BBoxStrategy
name|setupNeedsDocValuesOnly
parameter_list|()
throws|throws
name|IOException
block|{
...
name|fieldType
decl_stmt|;
comment|// random  legacy or not legacy
name|String
name|FIELD_PREFIX
init|=
literal|"bbox"
