...
argument_list|)
expr_stmt|;
comment|//  Can't test this without un-inverting since PVS legacy config didn't have docValues.
comment|//    However, note that Solr's tests use UninvertingReader and thus test this.
comment|//    strategy = PointVectorStrategy.newLegacyInstance(ctx, "pointvector_legacy");
comment|//    ctorArgs.add(new Object[]{strategy.getFieldName(), strategy});
name|strategy
operator|=
name|BBoxStrategy
operator|.
