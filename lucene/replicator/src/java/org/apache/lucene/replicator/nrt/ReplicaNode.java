...
argument_list|)
expr_stmt|;
comment|// nocommit make test where index has all docs deleted (all segments dropped, so 0 segments) and is then replicated
name|String
name|s
init|=
name|infos
...
condition|)
block|{
comment|// nocommit can't we .transferAndCancel?
name|message
argument_list|(
