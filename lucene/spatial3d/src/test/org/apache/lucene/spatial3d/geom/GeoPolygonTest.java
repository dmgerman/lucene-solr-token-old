...
name|WGS84
argument_list|,
literal|0.8894380320379947
argument_list|,
operator|-
literal|2.8993466885897496
argument_list|)
decl_stmt|;
specifier|final
name|GeoPoint
...
argument_list|,
operator|-
literal|0.8298163536994994
argument_list|,
operator|-
literal|0.1462586594666574
argument_list|)
decl_stmt|;
specifier|final
name|GeoPoint
...
argument_list|)
decl_stmt|;
comment|//final List<GeoPoint> p1List = new ArrayList<>();
comment|//p1List.add(p1);
comment|//p1List.add(p2);
comment|//p1List.add(p3);
comment|//p1List.add(p4);
comment|//final BitSet p1Internal = new BitSet();
comment|//final GeoConvexPolygon poly1 = new GeoConvexPolygon(PlanetModel.WGS84, p1List, p1Internal, false);
comment|/*     final List<GeoPoint> p2List = new ArrayList<>();     p2List.add(p1);     p2List.add(p4);     p2List.add(p5);     final BitSet p2Internal = new BitSet();     final GeoConvexPolygon poly2 = new GeoConvexPolygon(PlanetModel.WGS84, p2List, p2Internal, false);     */
comment|//XYZBounds bounds1 = new XYZBounds();
comment|//poly1.getBounds(bounds1);
comment|//XYZSolid solid1 = XYZSolidFactory.makeXYZSolid(PlanetModel.WGS84, bounds1.getMinimumX(), bounds1.getMaximumX(),
comment|//  bounds1.getMinimumY(), bounds1.getMaximumY(),
comment|//  bounds1.getMinimumZ(), bounds1.getMaximumZ());
comment|/*     XYZBounds bounds2 = new XYZBounds();     poly2.getBounds(bounds2);     XYZSolid solid2 = XYZSolidFactory.makeXYZSolid(PlanetModel.WGS84, bounds2.getMinimumX(), bounds2.getMaximumX(),       bounds2.getMinimumY(), bounds2.getMaximumY(),       bounds2.getMinimumZ(), bounds2.getMaximumZ());     */
specifier|final
name|GeoPoint
name|point
init|=
...
argument_list|(
operator|-
literal|0.9155623168963972
argument_list|,
literal|2.3309121299774915E
operator|-
literal|10
argument_list|,
operator|-
literal|0.40359240449795253
argument_list|)
decl_stmt|;
name|System
operator|.
...
name|WGS84
argument_list|,
literal|1.3005550159098878
argument_list|,
operator|-
literal|2.4043250791032897
argument_list|)
decl_stmt|;
specifier|final
name|boolean
...
name|WGS84
argument_list|,
literal|0.972005250702484
argument_list|,
operator|-
literal|1.9776473855435277
argument_list|)
argument_list|)
expr_stmt|;
name|pointList
...
name|WGS84
argument_list|,
literal|0.5530477484903267
argument_list|,
literal|2.5300578442038137
argument_list|)
argument_list|)
expr_stmt|;
name|pointList
...
name|WGS84
argument_list|,
literal|1.5185372097372358
argument_list|,
operator|-
literal|0.33848566616392867
argument_list|)
argument_list|)
expr_stmt|;
specifier|final
...
name|GeoPoint
argument_list|(
literal|0.26643017529034996
argument_list|,
literal|0.0
argument_list|,
literal|0.9617794725902564
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|WGS84
argument_list|,
literal|1.166339260547107
argument_list|,
literal|0.5797066870374205
argument_list|)
decl_stmt|;
comment|// Given the choice of test point, does this all make sense?
name|assertTrue
argument_list|(
name|pSanity
operator|.
...
name|WGS84
argument_list|,
literal|0.03170690566178683
argument_list|,
literal|1.0862414976732029
argument_list|)
decl_stmt|;
specifier|final
name|boolean
...
argument_list|()
decl_stmt|;
comment|// If the 1.07748... line is at the top, the bounds are correct and the test succeeds.
comment|// If this line is at the bottom, though, the bounds are wrong and the test fails.
comment|//pointList.add(new GeoPoint(PlanetModel.WGS84, 1.0774842300167298, -0.11534121538553185));
name|pointList
operator|.
name|add
argument_list|(
...
name|WGS84
argument_list|,
literal|0.05101544777239065
argument_list|,
literal|1.031558236908661
argument_list|)
argument_list|)
expr_stmt|;
name|pointList
...
argument_list|,
operator|-
literal|0.011222928649880962
argument_list|,
literal|1.5851249038356199
argument_list|)
argument_list|)
expr_stmt|;
name|pointList
...
argument_list|,
operator|-
literal|0.02571365137215876
argument_list|,
literal|0.5627875521419741
argument_list|)
argument_list|)
expr_stmt|;
name|pointList
...
name|WGS84
argument_list|,
literal|0.03833766792865358
argument_list|,
literal|1.0082901344798614
argument_list|)
argument_list|)
expr_stmt|;
name|pointList
...
name|WGS84
argument_list|,
literal|0.1719054969347345
argument_list|,
literal|0.9024290407832926
argument_list|)
argument_list|)
expr_stmt|;
name|pointList
...
name|WGS84
argument_list|,
literal|0.08180947807010808
argument_list|,
literal|1.0107147265848113
argument_list|)
argument_list|)
expr_stmt|;
name|pointList
...
name|WGS84
argument_list|,
literal|1.0774842300167298
argument_list|,
operator|-
literal|0.11534121538553185
argument_list|)
argument_list|)
expr_stmt|;
specifier|final
...
argument_list|,
operator|-
literal|0.7073124559987376
argument_list|,
literal|2.2509085326629887
argument_list|)
decl_stmt|;
comment|// Given the choice of test point, does this all make sense?
name|assertTrue
