...
return|;
block|}
comment|/**    * Class for tracking the best shape for finding a pole, and whether or not the pole    * must be inside or outside of the shape.    */
DECL|class|BestShape
specifier|private
specifier|static
class|class
name|BestShape
...
name|points
decl_stmt|;
DECL|field|poleMustBeInside
specifier|public
name|boolean
name|poleMustBeInside
decl_stmt|;
DECL|method|BestShape
specifier|public
name|BestShape
parameter_list|(
specifier|final
