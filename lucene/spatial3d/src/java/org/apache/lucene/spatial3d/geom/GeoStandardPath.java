...
end_import
begin_comment
comment|/**  * GeoShape representing a path across the surface of the globe,  * with a specified half-width.  Path is described by a series of points.  * Distances are measured from the starting point along the path, and then at right  * angles to the path.  *  * @lucene.internal  */
end_comment
begin_class
DECL|class|GeoStandardPath
class|class
...
parameter_list|)
block|{
comment|// TBD: Compute actual bounds based on distance
name|getBounds
argument_list|(
name|bounds
argument_list|)
...
block|{
return|return
literal|"GeoStandardPath: {planetmodel="
operator|+
name|planetModel
operator|+
literal|", width="
...
index|]
decl_stmt|;
comment|/** Null membership */
DECL|field|NO_MEMBERSHIP
specifier|public
specifier|final
specifier|static
name|Membership
