...
name|rightLon
decl_stmt|;
comment|/** The cosine of the middle latitude */
...
name|centerPoint
decl_stmt|;
comment|/** Composite left/right bounds */
...
DECL|method|GeoWideNorthRectangle
specifier|public
name|GeoWideNorthRectangle
parameter_list|(
specifier|final
...
block|{
return|return
literal|"GeoWideNorthRectangle: {planetmodel="
operator|+
name|planetModel
operator|+
literal|", bottomlat="
...
return|;
block|}
comment|/** Membership implementation representing a wide (more than 180 degree) bound.    */
