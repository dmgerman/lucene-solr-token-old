...
comment|'# methods etc'
nl|'\n'
comment|'# TODO: this is actually the link anchor for the method, which we must'
nl|'\n'
comment|'# somehow defer and only later check if the list at that anchor does not contain'
nl|'\n'
comment|"# the text 'specified by' (in which case its an overridden method from an external library)"
nl|'\n'
indent|'        '
name|'lastItem'
op|'='
