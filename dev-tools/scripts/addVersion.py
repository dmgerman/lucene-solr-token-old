...
number|'1'
op|']'
comment|'# Remove comment closer line'
newline|'\n'
name|'if'
op|'('
name|'len'
...
op|':'
op|']'
comment|"# drop the trailing lines '<p> / Use this to get the latest ... / ... for Lucene.'"
newline|'\n'
dedent|''
name|'buffer'
op|'.'
...
op|'('
op|'('
string|"'{0} * @deprecated ({1}) Use latest\\n'"
nl|'\n'
op|'+'
string|"'{0} */\\n'"
nl|'\n'
...
nl|'\n'
op|'+'
string|"'{0} * Match settings and bugs in Lucene\\'s {1} release.\\n'"
op|')'
nl|'\n'
op|'.'
name|'format'
...
name|'append'
op|'('
string|"'%s * @deprecated Use latest\\n'"
op|'%'
name|'spaces'
op|')'
newline|'\n'
...
nl|'\n'
op|'+'
string|"'{0} * Use this to get the latest &amp; greatest settings, bug\\n'"
nl|'\n'
op|'+'
string|"'{0} * fixes, etc, for Lucene.\\n'"
op|')'
op|'.'
name|'format'
op|'('
...
name|'append'
op|'('
string|"'{0}public static final Version {1} = new Version({2}, {3}, {4});\\n'"
op|'.'
name|'format'
nl|'\n'
op|'('
...
newline|'\n'
comment|'# outer match is just to find lines declaring version constants'
nl|'\n'
dedent|''
name|'match'
op|'='
