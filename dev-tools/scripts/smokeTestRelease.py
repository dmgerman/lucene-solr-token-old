...
op|','
nl|'\n'
comment|'# Make sure 1.6 compiler was used to build release bits:'
nl|'\n'
string|"'X-Compile-Source-JDK: 1.6'"
op|','
nl|'\n'
comment|'# Make sure .class files are 1.6 format:'
nl|'\n'
string|"'X-Compile-Target-JDK: 1.6'"
op|','
nl|'\n'
...
name|'print'
op|'('
string|"'    copying unpacked distribution for Java 6 ...'"
op|')'
newline|'\n'
name|'java6UnpackPath'
op|'='
string|"'%s-java6'"
op|'%'
name|'unpackPath'
