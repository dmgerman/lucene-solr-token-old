...
name|'RuntimeError'
op|'('
string|'\'%s is missing "%s" inside its META-INF/MANIFES.MF\''
op|'%'
op|'('
name|'desc'
op|','
...
name|'print'
op|'('
string|"'  example: python3.2 -u dev-tools/scripts/smokeTestRelease.py http://people.apache.org/~whoever/staging_area/lucene-solr-4.3.0-RC1-rev1469340 4.3.0 /path/to/a/tmp/dir'"
op|')'
newline|'\n'
name|'print'
op|'('
