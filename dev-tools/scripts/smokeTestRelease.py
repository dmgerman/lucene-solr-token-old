...
name|'run'
op|'('
string|"'export JAVA_HOME=/usr/local/src/jdk1.5.0_22; ant test'"
op|','
string|"'%s/test.log'"
op|'%'
name|'unpackPath'
...
name|'run'
op|'('
string|"'export JAVA_HOME=/usr/local/src/jdk1.5.0_22; ant jar'"
op|','
...
name|'run'
op|'('
string|"'export JAVA_HOME=/usr/local/src/jdk1.6.0_21; ant test'"
op|','
string|"'%s/test.log'"
op|'%'
name|'unpackPath'
...
name|'cp'
op|'='
string|"'build/lucene-core-3.2-SNAPSHOT.jar:build/contrib/demo/lucene-demo-3.2-SNAPSHOT.jar'"
newline|'\n'
name|'docsDir'
op|'='
string|"'src'"
...
name|'cp'
op|'='
string|"'lucene-core-3.2.0.jar:contrib/demo/lucene-demo-3.2.0.jar'"
newline|'\n'
name|'docsDir'
op|'='
string|"'docs'"
...
name|'run'
op|'('
string|"'export JAVA_HOME=/usr/local/src/jdk1.5.0_22; java -cp %s org.apache.lucene.demo.IndexFiles -index index -docs %s'"
op|'%'
op|'('
name|'cp'
op|','
...
name|'run'
op|'('
string|"'export JAVA_HOME=/usr/local/src/jdk1.5.0_22; java -cp %s org.apache.lucene.demo.SearchFiles -index index -query lucene'"
op|'%'
name|'cp'
op|','
string|"'search.log'"
