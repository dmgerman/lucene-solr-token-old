...
name|'print'
op|'('
string|"'    verify JAR/WAR metadata...'"
op|')'
newline|'\n'
name|'for'
name|'root'
...
name|'print'
op|'('
string|"'    make sure WAR file has no javax.* or java.* classes...'"
op|')'
newline|'\n'
nl|'\n'
name|'checkJARMetaData'
...
name|'RuntimeError'
op|'('
string|"'Maven artifact %s has different contents than binary distribution\\n  maven:\\n%s\\n  binary:\\n%s\\n'"
op|'%'
op|'('
name|'artifactFilename'
op|','
