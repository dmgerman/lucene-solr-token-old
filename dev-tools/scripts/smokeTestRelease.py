...
newline|'\n'
nl|'\n'
DECL|variable|reAllowedVersion
dedent|''
dedent|''
dedent|''
dedent|''
name|'reAllowedVersion'
op|'='
name|'re'
op|'.'
name|'compile'
...
name|'print'
op|'('
string|'\'Usage python -u %s BaseURL SvnRevision version tmpDir [ isSigned(True|False) ] [ -testArgs "-Dwhat=ever [ ... ]" ]\''
nl|'\n'
op|'%'
name|'sys'
op|'.'
...
name|'print'
op|'('
string|"'  example: python3.2 -u dev-tools/scripts/smokeTestRelease.py http://people.apache.org/~whoever/staging_area/lucene-solr-4.3.0-RC1-rev1469340 1469340 4.3.0 /path/to/a/tmp/dir'"
op|')'
newline|'\n'
name|'print'
op|'('
...
newline|'\n'
nl|'\n'
comment|'# TODO: yuck: positional-only args with more than one optional arg totally sucks'
nl|'\n'
comment|'# TODO: consider naming all args'
nl|'\n'
name|'isSigned'
op|'='
name|'True'
...
name|'RuntimeError'
op|'('
string|"'missing expected argument to -testArgs'"
op|')'
newline|'\n'
dedent|''
name|'else'
op|':'
newline|'\n'
comment|"# TODO: should there be arg validation here?  E.g. starts with '-D'?"
nl|'\n'
indent|'        '
name|'testArgs'
op|'='
