...
newline|'\n'
nl|'\n'
DECL|function|checkAllLuceneJARs
dedent|''
dedent|''
dedent|''
dedent|''
name|'def'
name|'checkAllLuceneJARs'
op|'('
name|'root'
op|')'
op|':'
...
name|'print'
op|'('
string|"'    make sure Lucene JARs don\\'t have javax.* or java.* classes...'"
op|')'
newline|'\n'
name|'for'
name|'root'
...
op|':'
newline|'\n'
comment|'# Lucene demo intentionally ships servlet-api JAR:'
nl|'\n'
indent|'      '
name|'continue'
newline|'\n'
