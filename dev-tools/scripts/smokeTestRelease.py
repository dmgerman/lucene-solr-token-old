...
name|'cp'
op|'='
string|"'build/core/lucene-core-{0}-SNAPSHOT.jar{1}build/demo/classes/java'"
op|'.'
name|'format'
op|'('
name|'version'
...
name|'cp'
op|'+='
string|"'{1}build/core/lucene-core-{0}-SNAPSHOT.jar{1}build/demo/classes/java'"
op|'.'
name|'format'
op|'('
name|'version'
