...
indent|'    '
name|'print'
string|"'  downloading Apache RAT...'"
newline|'\n'
name|'download'
op|'('
string|"'apache-rat-incubating-0.8-bin.tar.bz2'"
op|','
nl|'\n'
string|"'http://archive.apache.org/dist/incubator/rat/binaries/apache-rat-incubating-0.8-bin.tar.bz2'"
op|','
nl|'\n'
name|'tmpDir'
op|')'
...
name|'open'
op|'('
string|"'%s/apache-rat-incubating-0.8-bin.tar.bz2'"
op|'%'
name|'tmpDir'
op|')'
newline|'\n'
...
name|'extract'
op|'('
string|"'apache-rat-0.8/apache-rat-0.8.jar'"
op|','
string|"'%s/apache-rat-0.8.jar'"
op|'%'
name|'tmpDir'
...
indent|'    '
name|'print'
string|"'  apache RAT already downloaded...'"
newline|'\n'
nl|'\n'
dedent|''
name|'print'
...
nl|'\n'
name|'print'
string|'\'    run "ant rat-sources"\''
newline|'\n'
name|'run'
op|'('
string|'\'%s; ant -lib "%s/apache-rat-0.8.jar/apache-rat-0.8" rat-sources\''
op|'%'
op|'('
name|'javaExe'
op|'('
...
newline|'\n'
name|'unpackJavadocsJar'
op|'('
string|"'%s/lucene-core-%s-javadoc.jar'"
op|'%'
op|'('
name|'unpackPath'
op|','
...
name|'find'
op|'('
string|"'Started SocketConnector@0.0.0.0:8983'"
op|')'
op|'!='
op|'-'
number|'1'
...
newline|'\n'
nl|'\n'
DECL|function|unpackJavadocsJar
dedent|''
name|'def'
name|'unpackJavadocsJar'
op|'('
...
name|'cp'
op|'='
string|"'build/core/lucene-core-{0}-SNAPSHOT.jar{1}build/contrib/demo/classes/java'"
op|'.'
name|'format'
op|'('
name|'version'
...
name|'cp'
op|'+='
string|"'{1}build/core/lucene-core-{0}-SNAPSHOT.jar{1}build/contrib/demo/classes/java'"
op|'.'
name|'format'
op|'('
name|'version'
...
name|'cp'
op|'='
string|"'lucene-core-{0}.jar{1}contrib/demo/lucene-demo-{0}.jar'"
op|'.'
name|'format'
op|'('
name|'version'
