...
newline|'\n'
nl|'\n'
DECL|variable|svnWorkingCopiesPath
name|'svnWorkingCopiesPath'
op|'='
name|'os'
op|'.'
name|'path'
...
op|']'
op|'+'
string|'" cannot run from svn working copy or git working tree, copy to another place and run from there."'
op|')'
newline|'\n'
nl|'\n'
