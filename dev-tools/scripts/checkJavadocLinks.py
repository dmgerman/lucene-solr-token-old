...
op|':'
newline|'\n'
comment|"# TODO: Python's html.parser is now always lenient, which is no good for us: we want correct HTML in our javadocs"
nl|'\n'
indent|'    '
name|'parser'
op|'.'
...
name|'link'
op|'=='
string|"'http://lucene.apache.org/solr/resources.html'"
op|':'
newline|'\n'
comment|'# OK'
nl|'\n'
...
name|'find'
op|'('
string|"'lucene.apache.org/solr/quickstart.html'"
op|')'
op|'!='
op|'-'
number|'1'
