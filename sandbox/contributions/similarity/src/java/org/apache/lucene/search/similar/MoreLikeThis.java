...
literal|5000
decl_stmt|;
comment|/**      * Default analyzer to parse source doc with. 	 * @see #getAnalyzer      */
...
name|DEFAULT_ANALYZER
decl_stmt|;
comment|/**      * Ignore words less freqent that this.      */
...
expr_stmt|;
block|}
comment|/**      * Returns an analyzer that will be used to parse source doc with. The default analyzer      * is the {@link #DEFAULT_ANALYZER}.      *      * @return the analyzer that will be used to parse source doc with. 	 * @see #DEFAULT_ANALYZER      */
...
return|;
block|}
comment|/**      * Find words for a more-like-this query former.      *      * @param r the reader that has the content of the document      */
DECL|method|retrieveTerms
specifier|public
name|PriorityQueue
name|retrieveTerms
