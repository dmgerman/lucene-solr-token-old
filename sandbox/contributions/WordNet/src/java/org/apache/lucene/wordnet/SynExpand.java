...
end_import
begin_comment
comment|/**  * Expand a query by looking up synonyms for every term.  * You need to invoke {@see Syns2Index} first to build the synonym index.  *  * @see Syns2Index  */
end_comment
begin_class
